...
locals {
  civil_secrets = ["citizen-ui-idam-secret", "ordnance-survey-api-key", "civil-citizen-ui-token-key", "launch-darkly-sdk-key", "launch-darkly-sdk-key-non-prod", "civil-ci-alert-slack-group-webhook"]
}
