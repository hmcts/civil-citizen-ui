...
assert_status 201 POST '/service-request/2026-THIN-CLIENT-SERVICE-REQUEST/card-payments' '{"amount":455,"currency":"GBP","return_url":"https://example.test/claim-issued-payment-confirmation/1234"}'
...
assert_status 404 POST '/service-request/2026-THIN-CLIENT-SERVICE-REQUEST/card-payments' '{"amount":115,"currency":"USD","return_url":"https://example.test/payment"}'
