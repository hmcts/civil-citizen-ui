...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-civil-citizen-ui-pr-${pr}.service.preview.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=https://camunda-civil-citizen-ui-pr-${pr}.service.preview.platform.hmcts.net"
