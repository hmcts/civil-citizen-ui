...
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=https://civil-citizen-ui-pr-${pr}-civil-service.preview.platform.hmcts.net"
echo "export CCD_DEF_GEN_APP_SERVICE_BASE_URL=https://civil-citizen-ui-pr-${pr}-civil-service.preview.platform.hmcts.net"
