...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=http://ccd-definition-store-api-aat.service.aat.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=http://camunda-api-aat.service.aat.platform.hmcts.net"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-service-aat.service.aat.platform.hmcts.net"
