...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=http://civil-cui-definition-store-staging.aat.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=http://civil-cui-camunda-staging.aat.platform.hmcts.net"

# definition placeholders
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://civil-cui-definition-store-staging.aat.platform.hmcts.net"
