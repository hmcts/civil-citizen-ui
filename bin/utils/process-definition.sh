...
docker run --rm --name json2xlsx --user=$UID  \
  ...
  -e CCD_DEF_CASE_SERVICE_BASE_URL=${CCD_DEF_CASE_SERVICE_BASE_URL:-http://192.168.0.11:4000} \
  -e CCD_DEF_GEN_APP_SERVICE_BASE_URL=${CCD_DEF_GEN_APP_SERVICE_BASE_URL:-http://192.168.0.11:4550} \
