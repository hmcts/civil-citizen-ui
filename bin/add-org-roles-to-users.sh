...
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "legal-operations" '{"jurisdiction":"CIVIL","primaryLocation":"283922","workTypes":"routine_work,access_requests,hearing_work"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg4@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "legal-operations" '{"jurisdiction":"CIVIL","primaryLocation":"283922","workTypes":"routine_work,access_requests,hearing_work}' "LEGAL_OPERATIONS"
