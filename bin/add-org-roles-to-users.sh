...
./bin/utils/organisational-role-assignment.sh "DDJ.Boyd.Kuhic@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "hmcts-judiciary" '{"jurisdiction":"CIVIL","primaryLocation":"739514"}' "JUDICIAL"
./bin/utils/organisational-role-assignment.sh "DDJ.Boyd.Kuhic@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "judge" '{"jurisdiction":"CIVIL","primaryLocation":"739514","workTypes":"multi_track_decision_making_work,intermediate_track_decision_making_work,decision_making_work,applications"}' "JUDICIAL" '["294"]'
./bin/utils/organisational-role-assignment.sh "DDJ.Boyd.Kuhic@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "deputy-district-judge" '{"jurisdiction":"CIVIL","primaryLocation":"739514","workTypes":"multi_track_decision_making_work,intermediate_track_decision_making_work,decision_making_work,applications"}' "JUDICIAL" '["294"]'
./bin/utils/organisational-role-assignment.sh "DDJ.Boyd.Kuhic@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"CIVIL","primaryLocation":"739514"}' "JUDICIAL"
./bin/utils/organisational-role-assignment.sh "DDJ.Boyd.Kuhic@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"739514"}' "JUDICIAL"
