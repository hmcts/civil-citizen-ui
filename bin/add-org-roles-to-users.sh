...
./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "${WLU_DEFAULT_PASSWORD}" "PUBLIC" "wlu-team-leader" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "${WLU_DEFAULT_PASSWORD}" "PUBLIC" "wlu-admin" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "${WLU_DEFAULT_PASSWORD}" "PUBLIC" "task-supervisor" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work"}' "ADMIN"
