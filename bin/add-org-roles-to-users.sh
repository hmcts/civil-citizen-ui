...
./bin/utils/organisational-role-assignment.sh "casewrokerWLU@justice.gov.uk" "Password123" "PUBLIC" "wlu-admin" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work,query_work,routine_work"}' "ADMIN"

./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "Password123" "PUBLIC" "wlu-admin" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work,query_work,routine_work"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "Password123" "PUBLIC" "wlu-team-leader" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work,query_work,routine_work"}' "ADMIN"
./bin/utils/organisational-role-assignment.sh "caseworkerwlutl@justice.gov.uk" "Password123" "PUBLIC" "task-supervisor" '{"jurisdiction":"CIVIL","primaryLocation":"420219","workTypes":"welsh_translation_work,query_work,routine_work"}' "ADMIN"
