...
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hmcts-legal-operations" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "hearing-manager" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "LEGAL_OPERATIONS"
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "tribunal-caseworker" '{"jurisdiction":"CIVIL","primaryLocation":"366774","workTypes":"decision_making_work"}' "LEGAL_OPERATIONS"
