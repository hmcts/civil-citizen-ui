...
./bin/utils/organisational-role-assignment.sh "jason.bourbon@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "judge" '{"jurisdiction":"CIVIL","primaryLocation":"739514","workTypes":"hearing_work,decision_making_work,applications"}' "JUDICIAL" '["294"]'
./bin/utils/organisational-role-assignment.sh "jason.bourbon@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "deputy-district-judge" '{"jurisdiction":"CIVIL","primaryLocation":"739514","workTypes":"hearing_work,decision_making_work,applications"}' "JUDICIAL" '["294"]'
