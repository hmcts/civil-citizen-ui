...
./bin/utils/organisational-role-assignment.sh "ctsc_admin@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "CTSC"
...
./bin/utils/organisational-role-assignment.sh "hearing_center_admin_reg2@justice.gov.uk" "${DEFAULT_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"20262"}' "ADMIN"
...
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg4@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "LEGAL_OPERATIONS"
...
./bin/utils/organisational-role-assignment.sh "tribunal_legal_caseworker_reg2@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"366774"}' "LEGAL_OPERATIONS"
...
./bin/utils/organisational-role-assignment.sh "4924221EMP-@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"455174"}' "JUDICIAL"
...
./bin/utils/organisational-role-assignment.sh "DJ.Angel.Morgan@ejudiciary.net" "${JUDGE_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"CIVIL","primaryLocation":"177463"}' "JUDICIAL"
...
./bin/utils/organisational-role-assignment.sh "ga_nbc_admin_national@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "case-allocatorr" '{"jurisdiction":"CIVIL","primaryLocation":"283922","workTypes":"routine_work,access_requests"}' "ADMIN"
...
./bin/utils/organisational-role-assignment.sh "ga_tribunal_legal_caseworker_national@justice.gov.uk" "${CITIZEN_PASSWORD}" "PUBLIC" "case-allocatorr" '{"jurisdiction":"CIVIL","primaryLocation":"283922","workTypes":"routine_work,access_requests"}' "ADMIN"
