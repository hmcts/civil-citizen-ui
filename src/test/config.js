...
const testUrl = process.env.TEST_URL || 'https://civil-citizen-ui-pr-2812.preview.platform.hmcts.net';
...
module.exports = {
  ...
  url: {
    ...
    manageCase: 'https://xui-civil-citizen-ui-pr-2812.preview.platform.hmcts.net',
    authProviderApi:'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal',
    ccdDataStore: 'https://ccd-data-store-api-civil-citizen-ui-pr-2812.preview.platform.hmcts.net',
    dmStore: 'http://dm-store-aat.service.core-compute-aat.internal',
    idamApi: 'https://idam-api.aat.platform.hmcts.net',
    civilService: 'https://civil-citizen-ui-pr-2812-civil-service.preview.platform.hmcts.net',
  },
  s2s: {
