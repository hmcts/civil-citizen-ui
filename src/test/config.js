...
const defaultPasswordSystemUser =
  process.env.SYSTEM_USER_PASSWORD || "Password12";
...
module.exports = {
  ...
  claimantCitizenUser: {
    password: defaultPassword,
    //email:'civilmoneyclaimsdemo@gmail.com',
    email: `claimantcitizen-${Math.random()
      .toString(36)
      .slice(2, 9)
  ...
  defendantCitizenUser: {
    password: defaultPassword,
    email: `defendantcitizen-${Math.random()
      .toString(36)
      .slice(2, 9)
      .toLowerCase()}@gmail.com`,
  ...
  claimantSolicitorOrgId:
    process.env.ENVIRONMENT == "demo" ? "B04IXE4" : "Q1KOKP2",
  defendant1SolicitorOrgId:
    process.env.ENVIRONMENT == "demo" ? "DAWY9LJ" : "79ZRSOU",
  defendant2SolicitorOrgId:
    process.env.ENVIRONMENT == "demo" ? "LCVTI1I" : "H2156A0",
  defendantSelectedCourt:
    "Leeds Combined Court Centre - The Court House, 1 Oxford Row - LS1 3BG",
  claimantLRSelectedCourt:
    "Leeds Combined Court Centre - The Court House, 1 Oxford Row - LS1 3BG",
  eaCourt:
  ...
  gaCourtToBeSelected:
    "Birmingham Civil and Family Justice Centre - Priory Courts, 33 Bull Street - B4 6DS",
  ...
  defenceType: {
    ...
    partAdmitHaventPaidPartiallyWantsToPayImmediately:
      "PART_ADMIT_PAY_IMMEDIATELY",
    partAdmitWithPartPaymentOnSpecificDate: "PART_ADMIT_PAY_BY_SET_DATE",
    partAdmitWithPartPaymentAsPerInstallmentPlan:
      "PART_ADMIT_PAY_BY_INSTALLMENTS",
    ...
    rejectAllAlreadyPaidNotFullWithIndividual:
      "REJECT_ALL_ALREADY_PAID_NOT_FULL_INDIVIDUAL",
    rejectAllAlreadyPaidInFullWithIndividual:
      "REJECT_ALL_ALREADY_PAID_IN_FULL_INDIVIDUAL",
    ...
    admitAllPayByInstallmentWithIndividual:
      "FULLADMIT_PAY_BY_INSTALMENTS_INDIVIDUAL",
    ...
    partAdmitHaventPaidPartiallyWantsToPayImmediatelyWithIndividual:
      "PART_ADMIT_PAY_IMMEDIATELY_INDIVIDUAL",
    partAdmitWithPartPaymentOnSpecificDateWithIndividual:
      "PART_ADMIT_PAY_BY_SET_DATE_INDIVIDUAL",
    partAdmitWithPartPaymentAsPerInstallmentPlanWithIndividual:
      "PART_ADMIT_PAY_BY_INSTALLMENTS_INDIVIDUAL",
  ...
  sdoSelectionType: {
    judgementSumSelectedYesAssignToSmallClaimsYes:
      "JUDGEMENT_SUM_YES_SMALL_CLAIMS_YES",
    judgementSumSelectedYesAssignToSmallClaimsNoDisposalHearing:
      "JUDGEMENT_SUM_YES_SMALL_CLAIMS_NO_DISPOSAL_HEARING",
    judgementSumSelectedYesAssignToSmallClaimsNoTrialHearing:
      "JUDGEMENT_SUM_YES_SMALL_CLAIMS_NO_TRIAL_HEARING",
    judgementSumSelectedNoAssignToSmallClaimsYes:
      "JUDGEMENT_SUM_NO_SMALL_CLAIMS_YES",
    judgementSumSelectedNoAssignToFastTrackYes:
      "JUDGEMENT_SUM_NO_FAST_TRACK_YES",
  },
  claimState: {
