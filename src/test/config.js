...
module.exports = {
  ...
  url: {
    /*
    manageCase: process.env.URL || 'https://xui-civil-citizen-ui-pr-3342.preview.platform.hmcts.net',
...
    ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-citizen-ui-pr-3342.preview.platform.hmcts.net',
    dmStore: process.env.DM_STORE_URL || 'http://dm-store-aat.service.core-compute-aat.internal',
    idamApi:  'https://idam-api.aat.platform.hmcts.net',
    civilService: process.env.CIVIL_SERVICE_URL || 'https://civil-citizen-ui-pr-3342-civil-service.preview.platform.hmcts.net',*/
