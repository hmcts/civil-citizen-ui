...
// const testUrl = process.env.TEST_URL || 'https://civil-citizen-ui-pr-4377.preview.platform.hmcts.net';
...
module.exports = {
  ...
  url: {
    ...
    // manageCase: process.env.URL || 'https://xui-civil-citizen-ui-pr-4377.preview.platform.hmcts.net',
    // authProviderApi: process.env.SERVICE_AUTH_PROVIDER_API_BASE_URL || 'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal',
    // ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-citizen-ui-pr-4377.preview.platform.hmcts.net',
    // dmStore:process.env.DM_STORE_URL || 'http://dm-store-aat.service.core-compute-aat.internal',
