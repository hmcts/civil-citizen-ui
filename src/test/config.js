...
module.exports = {
  ...
  url: {
    manageCase: process.env.URL || 'https://xui-civil-citizen-ui-pr-4006.preview.platform.hmcts.net',
    ...
    ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-citizen-ui-pr-4006.preview.platform.hmcts.net',
    ...
    civilService: process.env.CIVIL_SERVICE_URL || 'https://civil-citizen-ui-pr-4006-civil-service.preview.platform.hmcts.net',
  ...
  claimantCitizenUser: {
    ...
    email:'civilmoneyclaimsdemo@gmail.com',
    //email: 'johnnyclaimant1@mailinator.com',
    type: 'claimant',
  },
  defendantCitizenUser: {
    ...
    email: 'johnnydefendant1@mailinator.com',
    type: 'defendant',
  },
