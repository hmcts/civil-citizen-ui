...
module.exports = {
  ...
  url: {
    manageCase: process.env.URL || 'https://xui-civil-citizen-ui-mike-pr-1.preview.platform.hmcts.net',
    ...
    ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-citizen-ui-mike-pr-1.preview.platform.hmcts.net',
    dmStore:process.env.DM_STORE_URL || 'http://dm-store-aat.service.core-compute-aat.internal',
    idamApi:  'https://idam-api.aat.platform.hmcts.net',
    idamWeb: 'https://idam-web-public.aat.platform.hmcts.net',
    civilService: process.env.CIVIL_SERVICE_URL || 'https://civil-citizen-ui-mike-pr-1-civil-service.preview.platform.hmcts.net',
...
//    civilService: process.env.CIVIL_SERVICE_URL || 'http://civil-service-demo.service.core-compute-demo.internal',
    ...
    generalApplication: process.env.CIVIL_GENERAL_APPLICATIONS_URL || 'https://civil-citizen-ui-mike-general-applications.preview.platform.hmcts.net',
    caseAssignmentService: process.env.AAC_API_URL || 'https://manage-case-assignment-civil-citizen-ui-mike.preview.platform.hmcts.net',
