...
const testUrl = process.env.TEST_URL || 'https://civil-citizen-ui-pr-1851.preview.platform.hmcts.net';
...
module.exports = {
  ...
  url: {
    manageCase: process.env.URL || 'https://xui-civil-citizen-ui-pr-1851.preview.platform.hmcts.net',
    ...
    ccdDataStore: process.env.CCD_DATA_STORE_URL || 'https://ccd-data-store-api-civil-citizen-ui-pr-1851.preview.platform.hmcts.net',
    ...
    civilService: process.env.CIVIL_SERVICE_URL || 'https://civil-citizen-ui-pr-1851-civil-service.preview.platform.hmcts.net',
  },
  s2s: {
