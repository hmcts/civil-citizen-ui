export const enum TestMessages {
  ...
  AT_LEAST_ONE_ROW = 'Enter date and what happened for at least one event',
  ...
  RESPONSE_TYPE_REQUIRED = 'Select how you respond to the claim',
  ...
  ENTER_PAYMENT_EXPLANATION = 'Enter how you paid this amount',
  ...
  MEDIATION_CONTACT_PERSON_CONFIRMATION = 'Who will be attending the mediation appointment?',
  ...
  REJECT_ALL_REASON_REQUIRED = 'Select why you don\'t believe you owe [CLAIMANT] any money',
  EXPERT_REPORT_DETAILS_REQUIRED = 'Select if you\'ve already got an expert report or not',
  ...
  SELECT_YES_IF_SUPPORT = 'Select if you, your experts or witnesses need support to attend a hearing or not',
  ...
  VALID_DEFENDANT_AGE_ELIGIBILITY = 'Select if you believe the person you\'re claiming against is over 18 or not, or if they are a company/organisation',
  ...
  VALID_INTEREST_TYPE_OPTION = 'Select how you want to claim interest',
  ...
  VALID_INTEREST_AMOUNT = 'Enter a positive interest amount',
  VALID_INTEREST_RATE = 'Enter a positive interest rate',
  ...
  CCJ_CONFIRMATION_JUDGMENT_REQUESTED = 'A CCJ has been requested. You will be notified when this is confirmed',
