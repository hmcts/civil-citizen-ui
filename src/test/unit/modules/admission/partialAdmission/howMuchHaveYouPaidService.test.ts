import howMuchHaveYouPaidService
  from '../../../../../main/modules/admission/partialAdmission/howMuchHaveYouPaidService';
...
describe('HowMuchHaveYouPaid service', () => {
  ...
  describe('Validation', () => {
    test('should raise an error if nothing specified for date', async () => {
      ...
      expect(form.getErrors()[0].constraints).toEqual({isDefined: VALID_AMOUNT, isNumber: VALID_TWO_DECIMAL_NUMBER, min: VALID_AMOUNT});
