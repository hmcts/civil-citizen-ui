...
import {CLAIM_CLAIMANT_SOLE_TRADER_DETAILS_URL} from '../../../../../main/routes/urls';
...
describe('Claimant Sole Trader Details View', () => {
  ...
  describe('on GET', () => {
    ...
    beforeEach(async () => {
      const response = await request(app).get(CLAIM_CLAIMANT_SOLE_TRADER_DETAILS_URL);
