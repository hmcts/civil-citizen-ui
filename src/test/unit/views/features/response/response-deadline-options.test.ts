...
describe('Response Deadline Options View', () => {
  ...
  describe('on POST', () => {
    ...
    it('should display error summary', () => {
      const expectedError = 'Select if you want to request more time, have already agreed more time, have had your request for more time refused, or you do not want more time';
      ...
      expect(errorSummaryMessage.innerHTML).toContain(expectedError);
