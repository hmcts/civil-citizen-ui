...
// TODO: remove this once paths become publicly available as mocking the response token will not be needed
  ...
  it('should display claim number', () => {
    const claimNumber = mainWrapper.getElementsByClassName('govuk-body')[0];
  ...
  it('should display claim amount', () => {
    const claimAmount = mainWrapper.getElementsByClassName('govuk-body')[1];
  ...
  it('should display how we use and store personal information component', () => {
    const details = mainWrapper.getElementsByClassName('govuk-details__summary-text')[2];
    const detailsTextWrapper = mainWrapper.getElementsByClassName('govuk-details')[2].getElementsByClassName('govuk-details__text')[0];
