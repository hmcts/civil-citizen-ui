...
const AMOUNT_ALREADY_PAID = '200.00';
const AMOUNT_TO_BE_PAID = '800.00';
...
describe('Payment Section', () => {
  ...
  it('should return your Payment summary sections for pay by set date', async () => {
    ...
    expect(summarySections.sections[1].summaryList.rows[0].value.html).toBe('COMMON.VARIATION_5.YES');
