...
describe('buildEvidenceUploadedSummaryRows', () => {
  ...
  describe('getWitnessSummary', () => {
    ...
    test('should log error when document link is undefined', () => {
      ...
      const witnessSummarySection = {} as SummarySection;
      witnessSummarySection.summaryList = {} as SummaryList;
      const witnessStatement1 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.STATEMENT' + ' ' + 1, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_STATEMENT', '1234');
      const witnessStatement2 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.STATEMENT' + ' ' + 2, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_STATEMENT', '1234');
      const witnessSummary1 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.SUMMARY' + ' ' + 1, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_SUMMARY', '1234');
      const witnessSummary2 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.SUMMARY' + ' ' + 2, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_SUMMARY', '1234');
      const witnessNotice1 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.NOTICE' + ' ' + 1, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_STATEMENT', '1234');
      const witnessNotice2 = getWitnessEvidenceSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.NOTICE' + ' ' + 2, 'PAGES.UPLOAD_DOCUMENTS.WITNESS.DATE_STATEMENT', '1234');
      const documentReferred1 = getDocumentReferredToSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.DOCUMENT' + ' ' + 1, '1234');
      const documentReferred2 = getDocumentReferredToSummaryRow('PAGES.UPLOAD_DOCUMENTS.WITNESS.DOCUMENT' + ' ' + 2, '1234');

      documentReferred1.value.html = documentReferred1.value.html.replace('/view-documents/test', '/view-documents/undefined');
      documentReferred2.value.html = documentReferred2.value.html.replace('/view-documents/test', '/view-documents/undefined');
      ...
      expectedWitnessEvidenceSection.sections.push(witnessSummarySection);
      expect(actualSummaryRows.sections[0]).toEqual(expectedWitnessEvidenceSection.sections[0]);
      expect(loggerSpy).toHaveBeenCalledWith( expect.stringContaining('Document binary URL is missing'));
    });
