...
describe('Your Statement content builder service For Mediation', () => {
  ...
  it('should create ClaimSummarySection without remove button', async () => {
    ...
    const uploadDocumentsSectionBuilderExpected = new UploadDocumentsSectionBuilder()
      ...
      .addDateArray('PAGES.MEDIATION.UPLOAD_DOCUMENTS.DATE_INPUT.YOUR_STATEMENT', invalidDateErrors, 'PAGES.UPLOAD_DOCUMENTS.DATE_EXAMPLE', 'documentsForYourStatement','dateInputFields', 'date', undefined, undefined, undefined, 0)
