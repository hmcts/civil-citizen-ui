...
describe('View Application service', () => {
  describe('Build view application content for general application', () => {
    ...
    it('view application content test for respondent', async () => {
      ...
      expect(result[0].value.html).toEqual('PAGES.GENERAL_APPLICATION.SELECTED_APPLICATION_TYPE.CHANGE_HEARING'+'. '+'PAGES.GENERAL_APPLICATION.SELECT_TYPE.ASK_CHANGE_HEARING_DESCRIPTION');
