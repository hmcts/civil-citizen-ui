...
describe('breathing space guidance page content builder', () => {
  ...
  it('should get the content for the page with query management contact information', () => {
    ...
    expect(pageContent).toMatchObject([
      ...
      },
      {
        type: 'fullStopLink',
        data: {
          text: 'COMMON.QM_INFORMATION_LINK',
          href: 'qmLink',
          textBefore: 'COMMON.QM_INFORMATION_MESSAGES_DOCUMENTS',
        },
      },
      {
        type: 'p',
