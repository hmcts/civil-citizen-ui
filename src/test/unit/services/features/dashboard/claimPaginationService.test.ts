...
describe('buildPaginationData', () => {
  ...
  // totalpage is undefined
  // totalPages is 1
  // totalPages is more than 1

  // it('should return an object with pagination one ClaimSummaryContent object with one content section containing the download claim section', async () => {
  //   // Given
  //   // const claimId = '123';
  //   const lang = 'en';
  //   // When
