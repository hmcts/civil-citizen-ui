...
import {
  displaySpecificCourtLocation, displayUnavailabilityForHearing,
...
describe('Common Hearing Requirements Section', () => {
  ...
  describe('speakingLanguagePreference', () => {
    ...
    it('should return summaryRow if language preference is not provided', () => {
      ...
      claimCopy.claimantResponse=new ClaimantResponse();
      claimCopy.claimantResponse.directionQuestionnaire = new DirectionQuestionnaire();
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements = new WelshLanguageRequirements();
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements.language=new Language();
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements.language.speakLanguage = undefined;
      const mockSummarySection = summaryRow(
        'PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_SPEAK',
        '',
      );
  ...
  describe('documentsLanguagePreference', () => {
    ...
    it('should return summaryRow if document language preference is not provided', () => {
      ...
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements = new WelshLanguageRequirements();
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements.language=new Language();
      claimCopy.claimantResponse.directionQuestionnaire.welshLanguageRequirements.language.documentsLanguage = undefined;
      const mockSummarySection = summaryRow(
        'PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_DOCUMENTS',
        '',
      );
  ...
  describe('giveEvidenceYourself', () => {
    it('should return summaryRow if give evidence yourself option is no', () => {
      ...
      claim.claimantResponse=new ClaimantResponse();
      claim.claimantResponse.directionQuestionnaire = new DirectionQuestionnaire();
      claim.claimantResponse.directionQuestionnaire.defendantYourselfEvidence = {
        option: YesNo.NO,
      };
      const mockSummarySection = summaryRow(
  ...
  describe('vulnerabilityQuestion', () => {
    it('should return summaryRow if vulnerability question option is no', () => {
      ...
      claim.claimantResponse.directionQuestionnaire.vulnerabilityQuestions.vulnerability = {
        option: YesNo.NO,
      };
      const mockSummarySection = summaryRow(
  ...
  describe('vulnerabilityInfo', () => {
    it('should return summaryRow if vulnerability details is set', () => {
      ...
      claim.claimantResponse.directionQuestionnaire = new DirectionQuestionnaire();
      claim.claimantResponse.directionQuestionnaire.vulnerabilityQuestions = new VulnerabilityQuestions();
      claim.claimantResponse.directionQuestionnaire.vulnerabilityQuestions.vulnerability = {vulnerabilityDetails};
      const mockSummarySection = summaryRow(
  ...
  describe('addSupportRequiredList', () => {
    it('should return summaryRow if supportRequiredList option is no', () => {
      ...
      claim.claimantResponse.directionQuestionnaire.hearing.supportRequiredList = {
        option: YesNo.NO,
      };
  ...
  describe('test getWithnesses', () => {
    it('should display \'no\' when there are no witnesses', () => {
      ...
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses = new OtherWitnesses();
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses.witnessItems = [];
    ...
    it('should display \'yes\' and 1 witness details', () => {
      ...
      claim.claimantResponse.directionQuestionnaire.witnesses = new Witnesses();
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses = new OtherWitnesses();
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses.option = YesNo.YES;
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses.witnessItems = [witness1];
    ...
    it('should display \'yes\' and have 2 witnesses', () => {
      ...
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses = new OtherWitnesses();
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses.option = YesNo.YES;
      claim.claimantResponse.directionQuestionnaire.witnesses.otherWitnesses.witnessItems = [witness1, witness2];
  ...
  describe('phone or Video hearing question', () => {
    it('should return summaryRow if phone or video hearing question option is no', () => {
      ...
      claim.claimantResponse.directionQuestionnaire = new DirectionQuestionnaire();
      claim.claimantResponse.directionQuestionnaire.hearing = new Hearing();
      claim.claimantResponse.directionQuestionnaire.hearing.phoneOrVideoHearing = {
        option: YesNo.NO,
      };
      const mockSummarySection = summaryRow(
  ...
  describe('should return summary rows relative to unavailable date for hearing', () => {
    ...
    it('should display NO if defendant select NO on question expert or witnesses cannot go to hearing ', () => {
      //WHEN
      claim.claimantResponse.directionQuestionnaire.hearing.cantAttendHearingInNext12Months = new GenericYesNo(YesNo.NO);
      const mockSummarySection = summaryRow(
      ...
      //GIVEN
      const defendantUnavailableDate = displayUnavailabilityForHearing(claim, claimId, lng);
      // THEN
    ...
    it('should display YES if defendant select YES on question expert or witnesses cannot go to hearing ', () => {
      //WHEN
      claim.claimantResponse.directionQuestionnaire.hearing.cantAttendHearingInNext12Months = {option: YesNo.YES};
      const mockSummarySection = summaryRow(
        'PAGES.CANT_ATTEND_HEARING_IN_NEXT_12MONTHS.PAGE_TITLE',
        'COMMON.YES',
        '/case/validClaimId/directions-questionnaire/cant-attend-hearing-in-next-12-months',
    ...
    it('should  display unavailable single date if defendant YES ', () => {
      //WHEN
      claim.claimantResponse.directionQuestionnaire.hearing.cantAttendHearingInNext12Months = <GenericYesNo>{option: YesNo.YES};
      ...
      claim.claimantResponse.directionQuestionnaire.hearing.unavailableDatesForHearing = {
      ...
      //GIVEN
      const defendantUnavailableDate = getUnavailableDatesList(claim, claimId, lng);
      //THEN
      expect(defendantUnavailableDate).toStrictEqual(mockSummarySection);
    });
    ...
    it('should  display unavailable range of date if defendant YES ', () => {
      ...
      //GIVEN
      const defendantUnavailableDates = getUnavailableDatesList(claim, claimId, lng);
      //THEN
    ...
    describe('Should display if the number of dates unavailable was greater than 30 ', () => {
      ...
      it('should display Why are you unavailable with the number of days ', () => {
        ...
        claim.claimantResponse.directionQuestionnaire.hearing.whyUnavailableForHearing = {reason: 'I will be out the country'};
        const mockSummarySection = summaryRow(
        ...
        // GIVEN
        const unavailableHearingDays = getUnavailabilityReason(claim, claimId, 10, lng);
        //THEN
      ...
      it('should display the reason if the number of dates unavailable was greater than 30 ', () => {
        ...
        // GIVEN
        const unavailableHearingDays = getUnavailabilityReason(claim, claimId, 20, lng);
        //THEN
        expect(unavailableHearingDays).toStrictEqual(mockSummarySection);
      });
    });
  ...
  describe('should return summary rows relative to court location defendant choice on the day of hearing', () => {
    ...
    it('should display NO if the defendant does not have a preference for hearing court location', function () {
      //GIVEN
      claim.claimantResponse.directionQuestionnaire.hearing.specificCourtLocation = new SpecificCourtLocation(YesNo.NO, courtLocations[0].label, 'reason');
    ...
    it('should display YES if the defendant does have a preference for hearing court location', function () {
      //GIVEN
      claim.claimantResponse.directionQuestionnaire.hearing.specificCourtLocation = new SpecificCourtLocation(YesNo.YES, courtLocations[0].label, 'reason');
      //WHEN
      const specificCourtLocation: SummaryRow = getSpecificCourtLocation(claim, claimId, lng);
      const mockSummarySection: SummaryRow = summaryRow(
        'PAGES.SPECIFIC_COURT.TITLE',
    ...
    it('should display selection as empty if there is no hearing object', function () {
      ...
      claimWithNoHearing.claimantResponse=new ClaimantResponse();
      //WHEN
