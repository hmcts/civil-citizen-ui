...
describe('Hearing Requirements Section', () => {
  ...
  describe('Intermediate track Claim ', () => {
    it('should build hearing requirement with frc, disclosure and consider documents for Intermediate Track Claim When all questions answer set to yes.', () => {
      ...
      //Then
      expect(summaryRows.title).toEqual('PAGES.CHECK_YOUR_ANSWER.HEARING_REQUIREMENTS_TITLE');
      expect(summaryRows.summaryList.rows.length).toEqual(27);
      expect(summaryRows.summaryList.rows[0].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.TRIED_TO_SETTLE');
      expect(summaryRows.summaryList.rows[0].value.html).toEqual('COMMON.VARIATION_2.YES');
      expect(summaryRows.summaryList.rows[1].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.REQUEST_EXTRA_4WEEKS');
      expect(summaryRows.summaryList.rows[1].value.html).toEqual('COMMON.YES');
      ...
      expect(summaryRows.summaryList.rows[19].value.html).toEqual('COMMON.VARIATION_2.YES');
      ...
      expect(summaryRows.summaryList.rows[21].key.text).toEqual('PAGES.SPECIFIC_COURT.TITLE');
      expect(summaryRows.summaryList.rows[21].value.html).toEqual('COMMON.VARIATION_2.YES');
      expect(summaryRows.summaryList.rows[22].key.text).toEqual('PAGES.SPECIFIC_COURT.SELECTED_COURT');
      expect(summaryRows.summaryList.rows[22].value.html).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[23].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[23].value.html).toEqual('test');
      expect(summaryRows.summaryList.rows[24].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.WELSH_LANGUAGE');
      expect(summaryRows.summaryList.rows[25].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_SPEAK');
      expect(summaryRows.summaryList.rows[25].value.html).toEqual('PAGES.WELSH_LANGUAGE.ENGLISH');
      expect(summaryRows.summaryList.rows[26].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_DOCUMENTS');
      expect(summaryRows.summaryList.rows[26].value.html).toEqual('PAGES.WELSH_LANGUAGE.WELSH_AND_ENGLISH');
    });
    it('should build hearing requirement frc, disclosure and consider documents for Intermediate Claim When all questions answer set to no.', () => {
      ...
      //Then
      expect(summaryRows.summaryList.rows.length).toEqual(15);
      expect(summaryRows.title).toEqual('PAGES.CHECK_YOUR_ANSWER.HEARING_REQUIREMENTS_TITLE');
      expect(summaryRows.summaryList.rows[0].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.TRIED_TO_SETTLE');
      expect(summaryRows.summaryList.rows[0].value.html).toEqual('COMMON.VARIATION_2.NO');
      expect(summaryRows.summaryList.rows[1].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.REQUEST_EXTRA_4WEEKS');
      ...
      expect(summaryRows.summaryList.rows[10].value.html).toEqual('COMMON.VARIATION_2.NO');
      expect(summaryRows.summaryList.rows[11].key.text).toEqual('PAGES.SPECIFIC_COURT.TITLE');
      expect(summaryRows.summaryList.rows[11].value.html).toEqual('COMMON.VARIATION_2.NO');
      expect(summaryRows.summaryList.rows[12].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.WELSH_LANGUAGE');
      expect(summaryRows.summaryList.rows[12].value.html).toEqual(null);
      expect(summaryRows.summaryList.rows[13].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_SPEAK');
      expect(summaryRows.summaryList.rows[13].value.html).toEqual('PAGES.WELSH_LANGUAGE.ENGLISH');
      expect(summaryRows.summaryList.rows[14].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_DOCUMENTS');
      expect(summaryRows.summaryList.rows[14].value.html).toEqual('PAGES.WELSH_LANGUAGE.WELSH_AND_ENGLISH');
    });
  ...
  describe('Multi track Claim ', () => {
    it('should build hearing requirement with disclosure and consider documents for Multi Track Claim When all questions answer set to yes.', () => {
      ...
      //Then
      expect(summaryRows.title).toEqual('PAGES.CHECK_YOUR_ANSWER.HEARING_REQUIREMENTS_TITLE');
      expect(summaryRows.summaryList.rows.length).toEqual(23);
      expect(summaryRows.summaryList.rows[0].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.TRIED_TO_SETTLE');
      expect(summaryRows.summaryList.rows[0].value.html).toEqual('COMMON.VARIATION_2.YES');
      expect(summaryRows.summaryList.rows[1].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.REQUEST_EXTRA_4WEEKS');
      expect(summaryRows.summaryList.rows[1].value.html).toEqual('COMMON.YES');
      ...
      expect(summaryRows.summaryList.rows[15].value.html).toEqual('COMMON.VARIATION_2.YES');
      ...
      expect(summaryRows.summaryList.rows[17].key.text).toEqual('PAGES.SPECIFIC_COURT.TITLE');
      expect(summaryRows.summaryList.rows[17].value.html).toEqual('COMMON.VARIATION_2.YES');
      expect(summaryRows.summaryList.rows[18].key.text).toEqual('PAGES.SPECIFIC_COURT.SELECTED_COURT');
      expect(summaryRows.summaryList.rows[18].value.html).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[19].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[19].value.html).toEqual('test');
      expect(summaryRows.summaryList.rows[20].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.WELSH_LANGUAGE');
      expect(summaryRows.summaryList.rows[21].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_SPEAK');
      expect(summaryRows.summaryList.rows[21].value.html).toEqual('PAGES.WELSH_LANGUAGE.ENGLISH');
      expect(summaryRows.summaryList.rows[22].key.text).toEqual('PAGES.WELSH_LANGUAGE.WHAT_LANGUAGE_DOCUMENTS');
      expect(summaryRows.summaryList.rows[22].value.html).toEqual('PAGES.WELSH_LANGUAGE.WELSH_AND_ENGLISH');
    });
