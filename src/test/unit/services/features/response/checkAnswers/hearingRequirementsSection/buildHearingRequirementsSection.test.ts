...
describe('Hearing Requirements Section', () => {
  ...
  describe('Intermediate track Claim ', () => {
    it('should build hearing requirement with frc, disclosure and consider documents for Intermediate Track Claim When all questions answer set to yes.', () => {
      ...
      expect(summaryRows.summaryList.rows[5].value.text).toEqual('reasons');
      ...
      expect(summaryRows.summaryList.rows[8].value.text).toEqual('electronic');
      expect(summaryRows.summaryList.rows[9].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.NON_ELEC_DOCS_DISCLOSURE');
      expect(summaryRows.summaryList.rows[9].value.text).toEqual('non-electronic');
      ...
      expect(summaryRows.summaryList.rows[11].value.text).toEqual('considered');
      ...
      expect(summaryRows.summaryList.rows[21].value.text).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[22].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[22].value.text).toEqual('test');
    ...
    it('should build hearing requirement frc, disclosure and consider documents for Intermediate Claim When all questions answer set to no.', () => {
      ...
      expect(summaryRows.summaryList.rows[3].value.text).toEqual('reasons');
  ...
  describe('Multi track Claim ', () => {
    it('should build hearing requirement with disclosure and consider documents for Multi Track Claim When all questions answer set to yes.', () => {
      ...
      expect(summaryRows.summaryList.rows[4].value.text).toEqual('electronic');
      expect(summaryRows.summaryList.rows[5].key.text).toEqual('PAGES.CHECK_YOUR_ANSWER.NON_ELEC_DOCS_DISCLOSURE');
      expect(summaryRows.summaryList.rows[5].value.text).toEqual('non-electronic');
      ...
      expect(summaryRows.summaryList.rows[7].value.text).toEqual('considered');
      ...
      expect(summaryRows.summaryList.rows[17].value.text).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[18].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[18].value.text).toEqual('test');
    ...
    it('should build hearing requirement disclosure and consider documents for Multi Claim When all questions answer set to no.', () => {
      ...
      expect(summaryRows.summaryList.rows[9].value.text).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[10].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[10].value.text).toEqual('test');
  ...
  describe('Small Claim', () => {
    ...
    it('should build hearing requirement for Small Claim.', () => {
      ...
      expect(summaryRows.summaryList.rows[12].value.text).toEqual('High Wycombe Law Courts - THE LAW COURTS, EASTON STREET - HP11 1LR');
      expect(summaryRows.summaryList.rows[13].key.text).toEqual('PAGES.SPECIFIC_COURT.REASON');
      expect(summaryRows.summaryList.rows[13].value.text).toEqual('test');
