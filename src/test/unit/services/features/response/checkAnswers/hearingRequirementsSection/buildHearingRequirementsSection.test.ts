...
describe('Hearing Requirements Section', () => {
  describe('buildHearingRequirementSection for FastTrack Claim ', () => {
  ...
  describe('buildHearingRequirementSection for Small Claim ', () => {
    it('build hearing requirement for Small Claim when there are no witnesses', () => {
      const claim = new Claim();
