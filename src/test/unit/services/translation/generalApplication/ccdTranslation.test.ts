...
import {toCcdGeneralApplicationRespondentResponse, translateDraftApplicationToCCD} from 'services/translation/generalApplication/ccdTranslation';
...
describe('translate draft application to ccd', () => {
  ...
  describe('toCcdGeneralApplicationRespondentResponse', () => {
    it('should transform respondent response', () => {
      ...
      generalApplication.response = gaResponse;

      //Then
      expect(toCcdGeneralApplicationRespondentResponse(generalApplication, '1a2b-3c4d'))
        .toStrictEqual({value: {
          gaHearingDetails: {
            HearingDetailsEmailID: 'email',
            HearingDetailsTelephoneNumber: '123',
          ...
          gaRespondentDetails: '1a2b-3c4d',
          gaRespondentResponseReason: 'reason for disagreement',
          generalAppRespondent1Representative: YesNoUpperCamelCase.NO,
        }} satisfies CcdGeneralApplicationRespondentResponse);
    });
  });
});
