...
describe('translate draft application to ccd', () => {
  ...
  describe('toCcdGeneralApplicationRespondentResponse', () => {
    ...
    it('should transform respondent response', () => {
      ...
      //Then
      expect(toCcdGeneralApplicationWithResponse(ccdGeneralApplication as CCDApplication, generalApplication))
        .toStrictEqual({
    ...
    it('should convert monthly instalments to pence', () => {
      const generalApplication: Partial<GeneralApplication> = {
        response: {
      ...
      expect(toCcdGeneralApplicationWithResponse(ccdGeneralApplication as CCDApplication, generalApplication as GeneralApplication))
        .toMatchObject({
          gaRespondentDebtorOffer: {
