...
describe('Money Conversion', () => {
  ...
  it.each([[3162.5, 3162.50],[50.50, 50.50],[100.05, 100.05],[50.59, 50.59],[100, 100.00], [1, 1.00], [123, 123.00], [8330.380, 8330.38], [312.9, 312.90], [270.725, 270.73], [270000.7250000, 270000.73]])('should format amount value with two decimal places', (amountInPounds, expectedAmount)=>{
    //Given
    //When
