...
describe('Translate claimant response to ccd version', () => {
  ...
  it('should translate applicant1 suggested repaymentPlan INSTALMENTS with MONTH frequency for defendantSpec to ccd', () => {
    ...
    //Then
    expect(ccdClaim.applicant1SuggestInstalmentsPaymentAmountForDefendantSpec).toBe(10000);
  ...
  it('should translate applicant1 suggested repaymentPlan INSTALMENTS with WEEK frequency for defendantSpec to ccd', () => {
    ...
    //Then
    expect(ccdClaim.applicant1SuggestInstalmentsPaymentAmountForDefendantSpec).toBe(20000);
...
describe('Translate claimant response to ccd version', () => {
  ...
  it('should not translate applicant1SuggestPayImmediatelyPaymentDateForDefendantSpec to ccd when not exist', () => {
    ...
    //Then
    expect(ccdClaim.applicant1SuggestPayImmediatelyPaymentDateForDefendantSpec).toBe(undefined);
  });
});
