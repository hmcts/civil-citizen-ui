...
import { BREATHING_SPACE_CHECK_ANSWERS_URL, BREATHING_SPACE_RESPITE_LIFTED_URL, DASHBOARD_URL } from 'routes/urls';
...
describe('breathingSpaceGuard', () => {
  ...
  let next: jest.Mock;
  beforeEach(() => {
    req = { params: { id: '123' }, url: BREATHING_SPACE_CHECK_ANSWERS_URL, originalUrl: BREATHING_SPACE_CHECK_ANSWERS_URL };
