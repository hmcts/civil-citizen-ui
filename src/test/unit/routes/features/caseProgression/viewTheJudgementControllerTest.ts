...
jest.mock('services/features/caseProgression/judgement/judgementService', () => ({
  getJudgementContent: jest.fn(),
}));

describe('View the judgement Controller', () => {
  ...
  describe('on GET', () => {
    ...
    it('Should return claimant elements of View the judgement page', async () => {
      //given
    ...
    it('Should return defendant elements of View the judgement page', async () => {
      //given
