...
describe('Regular Expenses Controller', () => {
  ...
  describe('on POST', () => {
    it('it should show errors when mortgage is selected but no amount or schedule selected', async () => {
      await request(app)
    ...
    it('it should show errors when mortgage and rent are selected but no amount or schedule selected', async () => {
      await request(app)
        .post(CITIZEN_MONTHLY_EXPENSES_URL)
        .send({
    ...
    it('it should show errors when mortgage is selected but no schedule selected', async () => {
      await request(app)
        .post(CITIZEN_MONTHLY_EXPENSES_URL)
        .send({
          declared: 'mortgage', model: {
    ...
    it('it should show errors when mortgage is selected and amount is negative', async () => {
      await request(app)
        .post(CITIZEN_MONTHLY_EXPENSES_URL)
        .send({
          declared: 'mortgage', model: {
    ...
    it('it should show errors when mortgage is selected and amount has three decimal places', async () => {
      await request(app)
        .post(CITIZEN_MONTHLY_EXPENSES_URL)
        .send({
          declared: 'mortgage', model: {
    ...
    it('it should redirect when correct data for other expenses', async () => {
      app.locals.draftStoreClient = mockCivilClaim;
      await request(app)
        .post(CITIZEN_MONTHLY_EXPENSES_URL)
        .send({
