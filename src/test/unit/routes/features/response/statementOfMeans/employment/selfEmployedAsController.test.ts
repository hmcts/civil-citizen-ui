...
import {SELF_EMPLOYED_AS_URL,ON_TAX_PAYMENTS_URL} from '../../../../../../../main/routes/urls';
...
describe('on Get', () => {
  test('should return on self employed page successfully', async () => {
    ...
    await request(app).get(SELF_EMPLOYED_AS_URL)
      .expect((res) => {
