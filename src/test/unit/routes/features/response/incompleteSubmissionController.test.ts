...
import incompleteSubmissionController from '../../../../../main/routes/features/response/incompleteSubmissionController';
...
jest.mock('services/features/common/taskListService');
...
describe('Response - Incomplete submission', () => {
  const getHandler = getRouteHandler(incompleteSubmissionController, 'get');
  ...
  it('should render incomplete submission with outstanding tasks', async () => {
    ...
    expect(res.render).toHaveBeenCalledWith(viewPath, expect.objectContaining({
      ...
      taskListUri: constructResponseUrlWithIdParams(CLAIM_ID, RESPONSE_TASK_LIST_URL),
