  ...
  describe('getDashboard', () => {
    const mockNotificationInfo = [
      ...
      },
      {
        ...
        'titleEn': 'title_en',
        'titleCy': 'title_cy',
        'descriptionEn': 'new_description_en',
        'descriptionCy': 'new_description_cy',
        'timeToLive': 'Click',
        'clickedBy': 'Test User',
        'clickedAt': '1970-01-01T00:01:40.000Z',
        'createdAt': 'createdAt',
        'deadline': 'deadline',
      },
      {
        ...
        'titleEn': 'title_en_2',
        'titleCy': 'title_cy_2',
        'descriptionEn': 'new_description_en_2',
        'descriptionCy': 'new_description_cy_2',
        'timeToLive': 'Session',
        'clickedBy': 'Test User',
        'clickedAt': '1970-01-01T00:03:20.000Z',
        'createdAt': 'createdAt',
        'deadline': 'deadline',
      },
    ];
