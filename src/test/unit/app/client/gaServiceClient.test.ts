...
describe('GA Service Client', () => {
  ...
  describe('getGaFeePaymentRedirectInformation', () => {
    ...
    it('should get payment redirect information', async () => {
      ...
      //When
      const paymentInformationResponse: PaymentInformation = await gaServiceClient.getGaFeePaymentRedirectInformation(claimId, appReq, 'en');
    ...
    it('should throw error on get hearing fee redirect information', async () => {
      ...
      //Then
      await expect(gaServiceClient.getGaFeePaymentRedirectInformation(claimId, appReq, 'en')).rejects.toThrow('error');
    });
  });
