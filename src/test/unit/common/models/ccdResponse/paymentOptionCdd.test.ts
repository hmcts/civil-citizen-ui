...
import {PaymentOptionCCD, toCCDPaymentOption} from '../../../../../main/common/models/ccdResponse/paymentOptionCCD';
...
describe('translate payment option to ccd version', ()=> {
  it('should translate pay immediately to ccd version', ()=> {
    ...
    //Then
    expect(result).toBe(PaymentOptionCCD.IMMEDIATELY);
  });
  it('should translate pay by set date option', ()=> {
    ...
    //Then
    expect(result).toBe(PaymentOptionCCD.SET_DATE);
  });
  it('should translate pay by instalments', ()=> {
    ...
    //Then
    expect(result).toBe(PaymentOptionCCD.REPAYMENT_PLAN);
  });
});
