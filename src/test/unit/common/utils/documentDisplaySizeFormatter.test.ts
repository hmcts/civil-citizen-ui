...
describe('display document in KB', ()=>{
  it.concurrent('should display document size in KB successfully when size is greater than 0 and maximum decimal is specified ', ()=>{
    //Given
  ...
  it.concurrent('should display document in KB successfully when size is greater than 0 and no decimal is specified', ()=>{
    //Given
  ...
  it.concurrent('should display 0 KB when size is 0', ()=>{
    //Given
