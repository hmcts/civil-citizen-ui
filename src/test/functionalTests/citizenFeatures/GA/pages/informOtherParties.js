...
class InformOtherParties {
  ...
  async verifyPageText() {
    ...
    I.see('If you do not want the court to inform the other parties about this application', 'h2');
  ...
  async verifyOptions() {
    I.see('Should the court inform the other parties about this application?');
