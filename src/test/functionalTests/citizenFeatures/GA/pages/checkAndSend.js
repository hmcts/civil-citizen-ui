...
class CheckAndSend {
  ...
  async informOtherParties() {
    ...
    I.see('Why do you not want the court to inform the other parties?', '(//div[@class=\'govuk-summary-list__row\'])[4]');
    I.see('Do not need to inform', '(//div[@class=\'govuk-summary-list__row\'])[4]');
