...
class CommentsForReconsideration {
  ...
  async verifyPageText(partyName) {
    await I.see('A review of an order has been requested by the other parties.');
    await I.see('You can add your own comments below as part of the review.');
    await I.see(partyName + ' will be able to see your comments.');
