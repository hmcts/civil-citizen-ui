...
Feature('Response with PartAdmit and Date to PayOn - Small Claims').tag('@citizenUI @partAdmit @nightly');
...
Scenario('Response with PartAdmit and Date to PayOn', async ({api}) => {
