...
Feature('Create Lip v Lip claim - Individual vs Individual Feature 1').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Individual vs Individual - Feature 2').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Individual vs Individual - Feature 3').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Individual vs Individual - Feature 4').tag('@regression-1-r2').tag('@claimCreation');
