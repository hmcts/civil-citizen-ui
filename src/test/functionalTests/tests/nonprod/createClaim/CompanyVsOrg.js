...
Feature('Create Lip v Lip claim - Company vs Org - Feature 1').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Company vs Org - Feature 2').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Company vs Org - Feature 3').tag('@regression-1-r2').tag('@claimCreation');
...
Feature('Create Lip v Lip claim - Company vs Org - Feature 4').tag('@regression-1-r2').tag('@claimCreation');
