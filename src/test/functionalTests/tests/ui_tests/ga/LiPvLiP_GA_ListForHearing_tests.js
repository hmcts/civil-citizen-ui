...
Feature('LipvLip Applicant GA creation e2e tests - List for hearing').tag('@civil-citizen-nightly @ui-ga');
...
Scenario.skip('LipvLip Applicant GA creation e2e tests - List for hearing', async ({
  I,
  api,
}) => {
