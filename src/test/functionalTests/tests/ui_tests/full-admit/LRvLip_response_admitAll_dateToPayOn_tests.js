...
Feature('Response with AdmitAll and Date to PayOn').tag('@civil-citizen-nightly @ui-full-admit');
...
Scenario.skip('Response with AdmitAll and Date to PayOn', async ({api}) => {
