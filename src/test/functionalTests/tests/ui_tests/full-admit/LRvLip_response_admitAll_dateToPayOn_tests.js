...
Feature('Response with AdmitAll and Date to PayOn @debug').tag('@civil-citizen-nightly @ui-full-admit');
...
Scenario('Response with AdmitAll and Date to PayOn', async ({api}) => {
