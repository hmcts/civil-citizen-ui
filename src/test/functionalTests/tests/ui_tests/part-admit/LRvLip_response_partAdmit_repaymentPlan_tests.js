...
Feature('Response with PartAdmit and Repayment plan - Small Claims').tag('@civil-citizen-nightly');
...
Scenario.skip('Response with PartAdmit and Repayment plan', async () => {
