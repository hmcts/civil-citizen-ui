...
Feature('Case progression journey - Verify latest Update page For an Order being Created - Fast Track').tag('@civil-citizen-nightly @ui-orders');
...
Scenario('Case progression journey - Fast Track - Verify latest Update page for an Order being Created', async ({ I }) => {
  ...
  await I.dontSee(orderMadeNotif.title);
});