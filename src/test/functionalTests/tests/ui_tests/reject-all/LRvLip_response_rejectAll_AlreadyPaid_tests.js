...
Feature('Response with RejectAll and AlreadyPaid').tag('@civil-citizen-nightly @ui-reject-all');
...
Scenario.skip('Response with RejectAll and AlreadyPaid', async ({api}) => {
