...
Feature('Dashboard notification delete - regression sentinel for OptimisticLockException fix - DTSCCI-5163')
  .tag('@civil-citizen-nightly @ui-notifications @DTSCCI-5163');
