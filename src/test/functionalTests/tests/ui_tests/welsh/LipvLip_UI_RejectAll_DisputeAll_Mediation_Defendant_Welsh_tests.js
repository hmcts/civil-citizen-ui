...
Feature('Create Lip v Lip claim - Rejected All By Defendant welsh').tag('@civil-citizen-nightly @ui-welsh');

Scenario.skip('Create Lip v Lip claim - Rejected All By Defendant welsh', async ({api}) => {
