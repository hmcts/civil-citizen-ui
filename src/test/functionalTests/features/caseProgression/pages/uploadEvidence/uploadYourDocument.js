...
class UploadYourDocument {
  ...
  inputDataForFastTrackSections() {
    ...
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']/div[1]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    ...
    I.attachFile('//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestDOC.doc');

    //Disclosure list - Subsection
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']/div[2]//input[@name=\'file\']', 'features/caseProgression/data/TestDOCX.docx');
    I.click('[method=\'post\'] > .govuk-grid-column-two-thirds > div:nth-of-type(2) #add-another-disclosure-list');
    I.attachFile('//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestPDF.pdf');
    ...
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']/div[3]//input[@name=\'file\']', 'features/caseProgression/data/TestXLS.xls');
    ...
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']//fieldset[2]//div[3]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestXLSX.xlsx');
    ...
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']/div[4]//input[@name=\'file\']', 'features/caseProgression/data/TestPPT.ppt');
    ...
    I.attachFile('//div[@class=\'govuk-grid-column-two-thirds govuk-!-margin-top-0\']/div[4]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestPNG.png');
    ...
    I.attachFile('//div[5]//input[@name=\'file\']', 'features/caseProgression/data/TestRTF.rtf');
    ...
    I.attachFile('//div[5]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTIF.tif');
    ...
    I.attachFile('//div[6]//input[@name=\'file\']', 'features/caseProgression/data/TestTIFF.tiff');
    ...
    I.attachFile('//div[6]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestDOCX.docx');
    ...
    I.attachFile('//div[7]//input[@name=\'file\']', 'features/caseProgression/data/TestCSV.csv');
    ...
    I.attachFile('//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestBMP.bmp');
    ...
    I.attachFile('//div[8]//input[@name=\'file\']', 'features/caseProgression/data/TestPNG.png');
    ...
    I.attachFile('//div[8]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestJPG.jpg');
    ...
    I.attachFile('//div[9]//input[@name=\'file\']', 'features/caseProgression/data/TestJPEG.jpeg');
    ...
    I.attachFile('//div[9]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');
    ...
    I.attachFile('//div[10]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    ...
    I.attachFile('//div[10]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');

    //Trial Docuents - Section
    //Case Suary
    I.attachFile('//div[11]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    I.click('div:nth-of-type(11) #add-another-trial-list');
    I.attachFile('//div[11]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');

    //Skeleton
    I.attachFile('//div[12]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    I.click('div:nth-of-type(12) #add-another-trial-list');
    I.attachFile('//div[12]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');

    //Trial Authorities
    I.attachFile('//div[13]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    I.click('div:nth-of-type(13) #add-another-trial-list');
    I.attachFile('//div[13]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');

    //Costs
    I.attachFile('//div[14]//input[@name=\'file\']', 'features/caseProgression/data/TestTXT.txt');
    I.click('div:nth-of-type(14) #add-another-trial-list');
    I.attachFile('//div[14]//fieldset[2]//input[@class=\'govuk-file-upload uploadFile govuk-!-width-three-half undefined\']', 'features/caseProgression/data/TestTXT.txt');
    ...
    I.attachFile('//div[15]//input[@name=\'file\']','features/caseProgression/data/TestTXT.txt');
    ...
    I.attachFile('//div[15]//button[@id=\'add-another-trial-list\']','features/caseProgression/data/TestTXT.txt');
  }
