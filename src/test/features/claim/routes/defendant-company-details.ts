  ...
  describe('on POST', () => {
    ...
    describe('for authorized user', () => {
      ...
      describe('should render page with error when address is invalid', () => {
        ...
        it('city is missing', async () => {
          ...
          await request(app)
            ...
            .set('Cookie', `${cookieName}=ABC`)
            .send(invalidAddressInput)
            .expect(res => expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter a valid town/city'));
        });
      ...
      describe('should render page with error when selected Correspondence address option and Correspondence entered is invalid', () => {
        ...
        it('line 1 is missing', async () => {
          const invalidCorrespondenceAddressInput = {
            ...input, ...{
              hasCorrespondenceAddress: 'true',
              correspondenceAddress: { line1: '', line2: '', line3: '', city: 'London', postcode: 'SE28 0JE' },
            },
          };
          await request(app)
            .post(ClaimPaths.defendantCompanyDetailsPage.uri)
        ...
        it('city is missing', async () => {
          const invalidCorrespondenceAddressInput = {
            ...input, ...{
              hasCorrespondenceAddress: 'true',
              correspondenceAddress: { line1: 'Apartment 99', line2: '', line3: '', city: '', postcode: 'SE28 0JE' },
            },
          };
          await request(app)
            .post(ClaimPaths.defendantCompanyDetailsPage.uri)
            .set('Cookie', `${cookieName}=ABC`)
            .send(invalidCorrespondenceAddressInput)
            .expect(res => expect(res).to.be.successful.withText('Company details', 'div class="error-summary"', 'Enter correspondence town/city'));
        });
        it('postcode is missing', async () => {
          const invalidCorrespondenceAddressInput = {
            ...input, ...{
              hasCorrespondenceAddress: 'true',
              correspondenceAddress: { line1: 'Apartment 99', line2: '', line3: '', city: 'London', postcode: '' },
            },
          };
          await request(app)
            .post(ClaimPaths.defendantCompanyDetailsPage.uri)
