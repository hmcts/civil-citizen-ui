    ...
    describe('for authorized user', () => {
      ...
      it('Should validate check-and-send Page hyperlink with correct location and span', async () => {
        ...
        await request(app)
          ...
          .set('Cookie', `${cookieName}=ABC`)
          .expect(res => expect(res).to.be.successful.withText('Check your answers'))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-individual-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-dob',
            text: 'Change',
            hiddenText: 'date of birth',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-phone',
            text: 'Change',
            hiddenText: 'contact number (optional)',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/defendant-individual-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/defendant-email',
            text: 'Change',
            hiddenText: 'email',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/amount',
            text: 'Change',
            hiddenText: 'claim amount breakdown',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/interest',
            text: 'Change',
            hiddenText: 'claim interest',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/interest-rate',
            text: 'Change',
            hiddenText: 'how do you want to claim interest?',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/interest-date',
            text: 'Change',
            hiddenText: 'when are you claiming interest from?',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/reason',
            text: 'Change',
            hiddenText: 'why you believe you’re owed the money:',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/timeline',
            text: 'Change',
            hiddenText: 'timeline of what happened',
          })))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/evidence',
            text: 'Change',
            hiddenText: 'your evidence (optional)',
          })))
      ...
      it('Should validate that a claim made by individual against soleTrader and their details', async () => {
        ...
        await request(app)
          ...
          .expect(res => expect(res).to.be.successful.withText('<input id="signedtrue" type="checkbox" name="signed" value="true"'))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/defendant-sole-trader-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
      ...
      it('Should validate that a claim made by individual against company and their details.', async () => {
        ...
        await request(app)
          ...
          .expect(res => expect(res).to.be.successful.withText('<input id="signedtrue" type="checkbox" name="signed" value="true"'))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/defendant-company-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
      ...
      it('Should validate that a claim made by individual against organisation and their details', async () => {
        ...
        await request(app)
          ...
          .expect(res => expect(res).to.be.successful.withText('<input id="signedtrue" type="checkbox" name="signed" value="true"'))
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/defendant-organisation-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
      ...
      it('Should validate that a claim made by soleTrader against soleTrader and their details', async () => {
        ...
        await request(app)
          ...
          .set('Cookie', `${cookieName}=ABC`)
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-sole-trader-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
      ...
      it('Should validate that a claim made by company against company and their details', async () => {
        ...
        await request(app)
          ...
          .set('Cookie', `${cookieName}=ABC`)
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-company-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
          .expect(res => expect(res).to.be.successful.withText('Company Ltd.'))
      ...
      it('Should validate that a claim made by organisation against organisation and their details', async () => {
        ...
        await request(app)
          ...
          .set('Cookie', `${cookieName}=ABC`)
          .expect(res => expect(res).to.be.successful.withText(expectedLink({
            href: '/claim/claimant-organisation-details',
            text: 'Change',
            hiddenText: hiddenTextFullName,
          })))
          .expect(res => expect(res).to.be.successful.withText('Organisation.'))
