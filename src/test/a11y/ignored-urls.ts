...
export const IGNORED_URLS = [
  ...
  urls.BREATHING_SPACE_ENTER_URL,
  urls.BREATHING_SPACE_START_DATE_URL,
  urls.BREATHING_SPACE_CANCEL_URL,
  urls.BREATHING_SPACE_CYA_URL,
  urls.BREATHING_SPACE_CONFIRMATION_URL,
  urls.BREATHING_SPACE_LIFT_URL,
