...
const IGNORED_URLS = [urls.SIGN_IN_URL, urls.SIGN_OUT_URL, urls.CASES_URL, urls.CALLBACK_URL, urls.DASHBOARD_URL, urls.UNAUTHORISED_URL, urls.CITIZEN_PHONE_NUMBER_URL, urls.UNAUTHORISED_URL,urls.CITIZEN_DETAILS_URL, urls.CLAIM_DETAILS_URL, urls.DOB_URL,  urls.AGE_ELIGIBILITY_URL, urls.CITIZEN_RESPONSE_TYPE,urls.POSTCODE_LOOKUP_URL,urls.ROOT_URL, urls.HOME_URL, urls.DUMMY_URL,urls.CITIZEN_PARTNER_URL,urls.CITIZEN_PARTENER_PENSION_URL,urls.CITIZEN_DEPENDANTS_URL];
