...
const IGNORED_URLS = [urls.SIGN_IN_URL, urls.SIGN_OUT_URL, urls.CASES_URL, urls.CALLBACK_URL, urls.DASHBOARD_URL,
  ...
  urls.CITIZEN_DETAILS_URL, urls.CLAIM_DETAILS_URL, urls.DOB_URL, urls.AGE_ELIGIBILITY_URL, urls.CITIZEN_RESPONSE_TYPE_URL,
  urls.ROOT_URL, urls.HOME_URL, urls.CITIZEN_DISABILITY_URL, urls.CITIZEN_SEVERELY_DISABLED_URL, urls.CITIZEN_RESIDENCE_URL,
  urls.CITIZEN_RESIDENCE_URL, urls.CITIZEN_BANK_ACCOUNT_URL, urls.PARTNER_URL, urls.PARTNER_AGE_URL, urls.PARTNER_DEPENDANTS_URL];
  urls.CITIZEN_BANK_ACCOUNT_URL, urls.CITIZEN_RESIDENCE_URL, urls.CITIZEN_PARTNER_URL, urls.CITIZEN_PARTENER_PENSION_URL, urls.CITIZEN_DEPENDANTS_URL, 
