...
const IGNORED_URLS = [urls.SIGN_IN_URL, urls.SIGN_OUT_URL, urls.CASES_URL, urls.CALLBACK_URL, urls.DASHBOARD_URL,
  ...
  urls.CITIZEN_BANK_ACCOUNT_URL, urls.CITIZEN_RESIDENCE_URL, urls.CITIZEN_PARTNER_AGE_URL, urls.CITIZEN_PARTENER_PENSION_URL, urls.CITIZEN_DEPENDANTS_URL,
  urls.CITIZEN_PARTNER_DISABILITY_URL, urls.CITIZEN_PARTNER_URL];
