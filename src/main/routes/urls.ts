...
export const GA_UPLOAD_DOCUMENT_FOR_REQUEST_MORE_INFO_URL = `${BASE_GENERAL_APPLICATION_URL}/:appId/upload-additional-documents`;
export const GA_UPLOAD_DOCUMENT_FOR_REQUEST_MORE_INFO_CYA_URL = `${BASE_GENERAL_APPLICATION_URL}/:appId/upload-additional-documents/check-and-send`;
export const GA_UPLOAD_DOCUMENT_FOR_REQUEST_MORE_INFO_CONFIRMATION_URL = `${BASE_GENERAL_APPLICATION_URL}/:appId/upload-additional-documents/confirmation`;
