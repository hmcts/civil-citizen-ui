...
export const BREATHING_SPACE_CONFIRMATION_URL = `${DASHBOARD_URL}/:id/breathing-space/confirmation`;
export const BREATHING_SPACE_LIFT_URL = `${DASHBOARD_URL}/:id/breathing-space/lift`;
export const CYA_LIFT_BREATHING_SPACE_URL = `${BREATHING_SPACE_LIFT_URL}/check-your-answers`;
