...
export const CLAIM_DEFENDANT_COMPANY_DETAILS = `${BASE_CLAIM_URL}/defendant-company-details`;
...
export const DEFENDANT_EMAIL_URL = `${BASE_CLAIM_URL}/defendant-email`;
export const DEFENDANT_PHONE_NUMBER_URL = `${BASE_CLAIM_URL}/defendant-phone-number`;
