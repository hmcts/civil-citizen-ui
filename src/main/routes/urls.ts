...
export const CLAIMANT_RESPONSE_WHEN_DEBT_START =  `${BASE_CLAIMANT_RESPONSE_URL}/when-debt-start`;
export const CLAIMANT_RESPONSE_TASK_LIST_URL = `${BASE_CLAIMANT_RESPONSE_URL}/what-type-is-it`;
