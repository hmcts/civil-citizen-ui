...
export const CITIZEN_OTHER_DEPENDANTS_URL: Urls = `${STATEMENT_OF_MEANS_URL}/other-dependants`;
export const CITIZEN_EMPLOYMENT_URL: Urls = `${STATEMENT_OF_MEANS_URL}/employment`;
