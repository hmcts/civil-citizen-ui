...
export const GA_RESPONDENT_HEARING_PREFERENCE = `${BASE_GENERAL_APPLICATION_RESPONSE_URL}/hearing-preference`;
export const GA_RESPONDENT_WANT_TO_UPLOAD_DOCUMENT = `${BASE_GENERAL_APPLICATION_RESPONSE_URL}/want-to-upload-document`;
export const GA_RESPONDENT_UPLOAD_DOCUMENT = `${BASE_GENERAL_APPLICATION_RESPONSE_URL}/upload-documents`;
