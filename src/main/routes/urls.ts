...
const CLAIMANT_RESPONSE_URL = `${BASE_CASE_URL}/claimant-response`;
...
export const CLAIMANT_RESPONSE_REVIEW_DEFENDANTS_RESPONSE_URL = `${CLAIMANT_RESPONSE_URL}/defendants-response`;
export const CLAIMANT_RESPONSE_TASK_LIST_URL = `${CLAIMANT_RESPONSE_URL}/task-list`;
...
export const CLAIM_CONFIRMATION_URL = `${BASE_CLAIM_URL}/confirmation`;
