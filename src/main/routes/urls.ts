...
export const CLAIMANT_TELEPHONE_MEDIATION = `${BASE_CLAIMANT_RESPONSE_URL}/mediation/telephone-mediation`;
export const CLAIMANT_MEDIATION_AVAILABILITY = `${BASE_CLAIMANT_RESPONSE_URL}/mediation/availability`;
