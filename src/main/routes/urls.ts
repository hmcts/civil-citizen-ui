...
export const BASE_GENERAL_APPLICATION_RESPONSE_URL = `${BASE_CASE_RESPONSE_URL}/general-application`;
...
export const INFORM_OTHER_PARTIES = `${BASE_GENERAL_APPLICATION_URL}/inform-other-parties`;
...
export const GA_PAYMENT_UNSUCCESSFUL_URL = `${BASE_GENERAL_APPLICATION_URL}/payment-unsuccessful`;
...
export const REQUEST_FOR_RECONSIDERATION = `${BASE_CASE_PROGRESSION_URL}/request-for-reconsideration`; //TODO remove from src/test/a11y/ignored-urls.ts once implemented
export const REQUEST_FOR_RECONSIDERATION_CYA = `${REQUEST_FOR_RECONSIDERATION}/check-your-answers`; //TODO remove from src/test/a11y/ignored-urls.ts once implemented
export const REQUEST_FOR_RECONSIDERATION_CONFIRMATION = `${REQUEST_FOR_RECONSIDERATION}/confirmation`; //TODO remove from src/test/a11y/ignored-urls.ts once implemented
