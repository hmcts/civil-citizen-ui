...
export const CLAIMANT_RESPONSE_WHEN_DEBT_START_URL =  `${BASE_CLAIMANT_RESPONSE_URL}/debt-when-start`;
export const CLAIMANT_RESPONSE_WHAT_TYPE_URL = `${BASE_CLAIMANT_RESPONSE_URL}/what-type-is-it`;
