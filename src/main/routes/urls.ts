...
export const EXIT_BREATHING_SPACE_URL = `${BASE_BREATHING_SPACE_URL}/exit`;
export const EXIT_BREATHING_SPACE_CHECK_ANSWERS_URL = `${BASE_BREATHING_SPACE_URL}/exit-check-answers`;
export const EXIT_BREATHING_SPACE_CONFIRMATION_URL = `${BASE_BREATHING_SPACE_URL}/exit-confirmation`;
