...
export const DASHBOARD_CLAIMANT_URL = `${DASHBOARD_URL}/:id/claimant`;
...
export const CLAIM_FEE_URL = `${BASE_CLAIM_URL}/:id/fee`;
export const CLAIM_FEE_BREAKUP = `${BASE_CLAIM_URL}/fee`;
...
export const CP_PAY_HEARING_FEE_URL = `${BASE_CASE_PROGRESSION_URL}/pay-hearing-fee`;
export const CP_PAY_HEARING_FEE_START_URL = `${CP_PAY_HEARING_FEE_URL}/start`;
