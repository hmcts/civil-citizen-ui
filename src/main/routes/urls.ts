...
export const CITIZEN_PHONE_NUMBER_URL: Urls = `${BASE_CASE_RESPONSE_URL}/citizen-phone`;
...
export const CITIZEN_DETAILS_URL: Urls = `${BASE_CASE_RESPONSE_URL}/claim-details`;
