...
export const CLAIMANT_RESPONSE_SETTLE_ADMITTED_URL = `${BASE_CLAIMANT_RESPONSE_URL}/settle-admitted`;
export const CLAIMANT_RESPONSE_CHECK_AND_SEND_URL = `${BASE_CLAIMANT_RESPONSE_URL}/check-and-send`;
