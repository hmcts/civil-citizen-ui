...
export const CITIZEN_PA_PAYMENT_DATE_URL = `${BASE_CASE_RESPONSE_URL}/partial-admission/payment-date`;
...
export const CITIZEN_PARTIAL_ADMISSION_PAYMENT_OPTION_URL = `${BASE_CASE_RESPONSE_URL}/partial-admission/payment-option`;
export const CITIZEN_PARTIAL_ADMISSION_PAYMENT_DATE_URL = `${BASE_CASE_RESPONSE_URL}/partial-admission/payment-date`;
