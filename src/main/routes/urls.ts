...
export const CHECK_YOUR_ANSWERS_COSC_URL = `${BASE_COSC_URL}/check-your-answers`;
export const UPLOAD_DOCUMENT_COSC_URL = `${BASE_COSC_URL}/upload-documents`;
...
export const GA_DEBT_PAYMENT_EVIDENCE_URL = `${BASE_COSC_URL}/debt-payment-evidence`;
