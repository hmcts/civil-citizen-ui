...
export const EXPERT_DETAILS_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/expert-details`;
export const EXPERT_EVIDENCE_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/expert-evidence`;
...
export const DQ_EXPERT_REPORT_DETAILS_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/expert-reports-details`;
