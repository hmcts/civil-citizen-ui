...
export const DQ_WANT_USE_EXPERT_EVIDENCE_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/want-use-expert-evidence`;
export const DQ_HAVE_EXPERT_REPORTS_BEEN_SENT_TO_OTHER_PARTIES_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/have-expert-report-sent-other-parties`;
export const DQ_WANT_SHARE_EXPERT_WITH_CLAIMANT_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/want-share-expert-with-claimant`;
export const DQ_WANT_GIVE_YOURSELF_EVIDENCE_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/want-give-yourself-evidence`;
