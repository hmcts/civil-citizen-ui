...
export const GA_UPLOAD_DOCUMENTS_AJAX_UPLOAD_URL = `${GA_UPLOAD_DOCUMENTS_URL}/ajax-upload`;
export const GA_UPLOAD_DOCUMENTS_AJAX_DELETE_URL = `${GA_UPLOAD_DOCUMENTS_URL}/ajax-delete`;
