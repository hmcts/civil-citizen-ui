...
export const REQUEST_FOR_RECONSIDERATION = `${BASE_CASE_PROGRESSION_URL}/request-for-reconsideration`;
export const REQUEST_FOR_RECONSIDERATION_CYA = `${REQUEST_FOR_RECONSIDERATION}/check-your-answers`;
export const REQUEST_FOR_RECONSIDERATION_CONFIRMATION = `${REQUEST_FOR_RECONSIDERATION}/confirmation`;
export const REQUEST_FOR_RECONSIDERATION_CANCEL = `${REQUEST_FOR_RECONSIDERATION}/:propertyName/cancel`;
