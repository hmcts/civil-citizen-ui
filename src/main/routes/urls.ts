...
export const BASE_GENERAL_APPLICATION_URL = '/general-application';
export const SELECT_APPLICATION_TYPE_URL = `${BASE_GENERAL_APPLICATION_URL}/select-application-type`;
