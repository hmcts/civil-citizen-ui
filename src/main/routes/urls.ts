...
export const ELIGIBILITY_HELP_WITH_FEES = `${BASE_ELIGIBILITY_URL}/apply-for-help-with-fees`;
...
export const FIRST_CONTACT_ACCESS_DENIED = `${BASE_FIRST_CONTACT_URL}/access-denied`;
export const FIRST_CONTACT_CLAIM_REFERENCE = `${BASE_FIRST_CONTACT_URL}/claim-reference`;
