...
export const REQUEST_FOR_CONSIDERATION = `${BASE_CASE_URL}/request-for-reconsideration`; //TODO remove from src/test/a11y/ignored-urls.ts once implemented
...
export const DQ_MULTITRACK_CLAIMANT_DOCUMENTS_TO_BE_CONSIDERED_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/claimant-documents-to-be-considered`;
export const DQ_MULTITRACK_CLAIMANT_DOCUMENTS_TO_BE_CONSIDERED_DETAILS_URL = `${DIRECTIONS_QUESTIONNAIRE_URL}/claimant-documents-to-be-considered-details`;
