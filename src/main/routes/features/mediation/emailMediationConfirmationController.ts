...
const renderView = (form: GenericForm<GenericYesNoCarmEmailConfirmation>, res: Response, req: Request, defendantEmail: string): void => {
  ...
  const variation = {
    yes: 'COMMON.VARIATION_2.YES',
    no: 'COMMON.VARIATION_2.NO',
  };
