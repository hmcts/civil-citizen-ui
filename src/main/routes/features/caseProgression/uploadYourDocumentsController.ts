  ...
  try {
    ...
    if (claim && !claim.isEmpty()) {
      const latestUpdateSection = new LatestUpdateSectionBuilder()
        .addParagraph('PAGES.UPLOAD_YOUR_DOCUMENTS.SECTION_TITLE')
        .addTitle('PAGES.UPLOAD_YOUR_DOCUMENTS.TITLE')
        .addParagraph('PAGES.UPLOAD_YOUR_DOCUMENTS.CASE_REFERENCE' , {claimId: claimId})
        .addParagraph('PAGES.UPLOAD_YOUR_DOCUMENTS.PARTIES',{claimantName: claim.getClaimantFullName(),
