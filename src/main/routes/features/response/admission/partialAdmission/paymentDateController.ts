...
paymentDateController
  .get(
    CITIZEN_PA_PAYMENT_DATE_URL, async (req: express.Request, res: express.Response, next: express.NextFunction) => {
      try {
  ...
  .post(
    CITIZEN_PA_PAYMENT_DATE_URL, async (req, res,next: express.NextFunction) => {
