...
const componentDetailItemsList: ComponentDetailItems[] = [new ComponentDetailItems('Admit all of the claim', null, ['You have until 4pm on ' + DEADLINE + ' to admit the claim.']),
  ...
  new ComponentDetailItems(null, 'If you can\'t pay immediately', ['If the claimant accepts your part-admission and you can’t pay immediately, you can offer to pay in instalments.', 'If the claimant agrees, they can ask court to enter a CCJ against you and you\'ll be sent an order to pay.', 'If they reject your offer, the court will decide a repayment plan.']),
