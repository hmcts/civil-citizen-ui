  ...
  try {
    ...
    for (const application of applications) {
      ...
      applicationsRows.push({
        ...
        types: getApplicationTypeOptionByTypeAndDescription(application.case_data?.generalAppType.types[0], ApplicationTypeOptionSelection.BY_APPLICATION_DISPLAY_FROM_CCD),
        id: application.id,
