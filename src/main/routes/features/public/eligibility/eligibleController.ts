...
eligibleController.get([ELIGIBILITY_HWF_ELIGIBLE,ELIGIBILITY_HWF_ELIGIBLE_REFERENCE,ELIGIBLE_FOR_THIS_SERVICE_URL], (req: express.Request, res: express.Response) => {
