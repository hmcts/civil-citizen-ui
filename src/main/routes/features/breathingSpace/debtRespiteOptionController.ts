...
debtRespiteOptionController.get(BREATHING_SPACE_RESPITE_TYPE_URL, breathingSpacGuard, async (req, res, next: NextFunction) => {
...
debtRespiteOptionController.post(BREATHING_SPACE_RESPITE_TYPE_URL, breathingSpacGuard, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const claimId = req.params.id;
