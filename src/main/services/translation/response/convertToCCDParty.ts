...
export const toCCDParty = (party: Party): CCDParty => {
  return {
    ...
    individualDateOfBirth: party?.type === PartyType.INDIVIDUAL ? party?.dateOfBirth?.date.toLocaleDateString() : undefined,
    ...
    soleTraderDateOfBirth: party?.type === PartyType.SOLE_TRADER ? party?.dateOfBirth?.date.toLocaleDateString() : undefined,
