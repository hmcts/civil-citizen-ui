...
export const translateDraftResponseToCCD = (claim: Claim, addressHasChange: boolean): CCDResponse => {
  return {
    ...
    disabilityPremiumPayments: claim.statementOfMeans?.disability?.option === YesNo.YES ? YesNoUpperCamelCase.YES : YesNoUpperCamelCase.NO,
    severeDisabilityPremiumPayments: claim.statementOfMeans?.severeDisability?.option === YesNo.YES ? YesNoUpperCamelCase.YES : YesNoUpperCamelCase.NO,
    ...
    // respondent1LoanCreditOption: claim.statementOfMeans?.debts?.option === YesNo.YES  ? YesNoUpperCamelCase.YES : YesNoUpperCamelCase.NO,
