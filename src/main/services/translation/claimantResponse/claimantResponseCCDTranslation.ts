...
export const translateClaimantResponseToCCD = (claim: Claim): CCDClaimantResponse => {
  return {
    ...
    applicant1SuggestInstalmentsPaymentAmountForDefendantSpec: formatAmountTwoDecimalPlaces(+claim.claimantResponse?.suggestedPaymentIntention?.repaymentPlan?.paymentAmount),
