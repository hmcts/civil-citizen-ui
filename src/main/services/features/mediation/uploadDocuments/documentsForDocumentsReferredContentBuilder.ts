...
export const buildYourStatementSection = (section: TypeOfDocumentSection = null, index = 0, form: GenericForm<UploadDocumentsForm> = null): ClaimSummarySection[] => {
  ...
  return new UploadDocumentsSectionBuilder()
    ...
    .addInputArray(`${MEDIATION_UPLOAD_DOCUMENTS_PAGE}YOUR_NAME.${TypeOfMediationDocuments.DOCUMENTS_REFERRED_TO_IN_STATEMENT}`, '', '', documentsForYourStatement, 'typeOfDocument', section?.typeOfDocument, index, form?.errorFor(`${errorFieldNamePrefix}[typeOfDocument]`, documentsForYourStatement))
