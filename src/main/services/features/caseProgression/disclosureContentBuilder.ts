...
export const buildDisclosureDocumentSection = (): ClaimSummarySection[] => {
  return new UploadDocumentsSectionBuilder()
    ...
    .addInputArray('PAGES.UPLOAD_DOCUMENTS.TYPE_OF_DOCUMENT','govuk-!-width-three-half','PAGES.UPLOAD_DOCUMENTS.TYPE_OF_DOCUMENT_EXAMPLE',disclosureDocumentsType,'type')
    .addDateArray('PAGES.UPLOAD_DOCUMENTS.DOCUMENT_ISSUE_DATE', 'PAGES.UPLOAD_DOCUMENTS.DATE_EXAMPLE', disclosureDocumentsType)
