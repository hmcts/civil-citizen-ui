...
export const buildTrialCaseSummarySection = (claim: Claim, claimId: string): ClaimSummarySection[] => {
  return new UploadDocumentsSectionBuilder()
    ...
    .addUploadArray('PAGES.UPLOAD_DOCUMENTS.UPLOAD','PAGES.UPLOAD_DOCUMENTS.NO_UPLOAD', trialDocumentsType,
      fileUpload, 'PAGES.UPLOAD_DOCUMENTS.UPLOAD_BUTTON')
    .build();
};
...
export const buildTrialDocumentarySection = (claim: Claim, claimId: string): ClaimSummarySection[] => {
  return new UploadDocumentsSectionBuilder()
    ...
    .addCustomDateInput('PAGES.UPLOAD_DOCUMENTS.DOCUMENT_ISSUE_DATE', 'PAGES.UPLOAD_DOCUMENTS.DATE_EXAMPLE', trialDocumentsType)
    .addUploadArray('PAGES.UPLOAD_DOCUMENTS.UPLOAD','PAGES.UPLOAD_DOCUMENTS.NO_UPLOAD', trialDocumentsType,
      fileUpload, 'PAGES.UPLOAD_DOCUMENTS.UPLOAD_BUTTON')
    .build();
};
