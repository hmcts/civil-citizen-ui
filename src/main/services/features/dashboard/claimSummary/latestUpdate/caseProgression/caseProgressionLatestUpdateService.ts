...
export const getCaseProgressionLatestUpdates = (claim: Claim, lang: string) : ClaimSummaryContent[] => {
  const areTrialArrangementsFinalised = claim.caseProgression.trialReadyRespondent1 === YesNoUpperCamelCase.YES; //TODO: get the correct value once the logged in user is known
  const areOtherPartyTrialArrangementsFinalised = claim.caseProgression.trialReadyApplicant === YesNoUpperCamelCase.YES; //TODO: get the correct value once the logged in user is known
