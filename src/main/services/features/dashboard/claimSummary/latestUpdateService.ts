...
export const getLatestUpdateContent = (claimId: string, claim: Claim, lng: string, respondentPaymentDeadline?: Date, judgmentBufferEnabled = false): ClaimSummaryContent[] => {
  const responseToClaimSection = buildResponseToClaimSection(claim, claimId, lng, respondentPaymentDeadline, judgmentBufferEnabled);
