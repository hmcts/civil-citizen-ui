...
import {
  ...
  GA_UNAVAILABLE_HEARING_DATES_URL, GA_UPLOAD_ADDITIONAL_DOCUMENTS_CYA_URL, GA_UPLOAD_ADDITIONAL_DOCUMENTS_URL,
  GA_UPLOAD_DOCUMENT_FOR_ADDITIONAL_INFO_CYA_URL,
  GA_UPLOAD_DOCUMENT_FOR_ADDITIONAL_INFO_URL,
  GA_UPLOAD_DOCUMENTS_URL,
  GA_UPLOAD_N245_FORM_URL, GA_VIEW_APPLICATION_URL,
...
app.use([
  //GA upload additional info/documents
  GA_RESPOND_ADDITIONAL_INFO_URL,
  GA_UPLOAD_DOCUMENT_FOR_ADDITIONAL_INFO_URL,
  GA_UPLOAD_DOCUMENT_FOR_ADDITIONAL_INFO_CYA_URL,
