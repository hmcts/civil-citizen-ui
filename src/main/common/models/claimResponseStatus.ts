export enum ClaimResponseStatus {
  ...
  PA_PAID_PAY_IMMEDIATELY = 'PART_ADMISSION_PAID_PAY_IMMEDIATELY',
  PA_PAID_PAY_INSTALLMENTS = 'PART_ADMISSION_PAID_PAY_INSTALLMENTS',
  PA_PAID_PAY_BY_DATE = 'PART_ADMISSION_PAID_PAY_BY_DATE',
}
