...
export class Claim {
  ...
  getDocumentDetails(documentType: DocumentType, claimantOrDefendant?: DirectionQuestionnaireType): CaseDocument {
    if (documentType === DocumentType.HEARING_FORM && this.hasCaseProgressionHearingDocuments()) {
      ...
      return undefined;
    } else if (this.hasDefaultJudgmentDocuments() && (this.this.documentType === DocumentType.DEFAULT_JUDGMENT_CLAIMANT1 || documentType === DocumentType.DEFAULT_JUDGMENT_DEFENDANT1)) {
