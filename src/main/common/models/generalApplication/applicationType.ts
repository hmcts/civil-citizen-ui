...
export const selectedApplicationTypeDescription: Partial<{ [key in ApplicationTypeOption]: string; }> = {
  ...
  [ApplicationTypeOption.EXTEND_TIME]: 'PAGES.GENERAL_APPLICATION.SELECT_TYPE.ASK_MORE_TIME_DESCRIPTION_1'+' PAGES.GENERAL_APPLICATION.SELECT_TYPE.ASK_MORE_TIME_DESCRIPTION_2',
