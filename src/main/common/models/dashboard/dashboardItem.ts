...
export class DashboardClaimantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string ): DashboardStatus {
    ...
    const dashboardStatus: DashboardStatus = {
        ...
        SDO_DOCUMENTS_BEING_TRANSLATED: {translationKey: 'PAGES.DASHBOARD.STATUS_DEFENDANT.DOCUMENTS_BEING_TRANSLATED'},
        DECISION_MADE_DOCUMENTS_BEING_TRANSLATED: {translationKey: 'PAGES.DASHBOARD.STATUS_DEFENDANT.DOCUMENTS_BEING_TRANSLATED'},
        ...
        AWAITING_HEARING_NOTICE_TRANSLATION: {translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.DOCUMENTS_BEING_TRANSLATED'},
      };
  
      logger.info(`DashboardClaimantItem getDashboardStatus claimId: ${this.claimId} claimNumber: ${this.claimNumber} statusKey: ${this.status} translationKey: ${dashboardStatus[this.status]?.translationKey ?? 'UNKNOWN_STATUS'}`);
...
export class DashboardDefendantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string ): DashboardStatus {
    ...
    return {
      ...
      CASE_DISCONTINUED: {translationKey: 'PAGES.DASHBOARD.STATUS_DEFENDANT.CASE_DISCONTINUED'},
      AWAITING_HEARING_NOTICE_TRANSLATION: {translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.DOCUMENTS_BEING_TRANSLATED'},
    };
  }
}
