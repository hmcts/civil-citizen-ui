...
export class DashboardClaimantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string ): DashboardStatus {
    ...
    return {
      ...
      DECISION_ON_RECONSIDERATION_REQUEST: { translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.DECISION_ON_RECONSIDERATION' },
    };
  }
...
export class DashboardDefendantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string ): DashboardStatus {
    ...
    return {
      ...
      DECISION_ON_RECONSIDERATION_REQUEST: { translationKey: 'PAGES.DASHBOARD.STATUS_DEFENDANT.DECISION_ON_RECONSIDERATION' },
    };
  }
}
