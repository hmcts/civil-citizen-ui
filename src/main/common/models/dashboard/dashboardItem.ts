...
export class DashboardClaimantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string | unknown): DashboardStatus {
    ...
    return {
      ...
      CLAIMANT_SEND_SETTLEMENT_AGREEMENT: {translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.CLAIMANT_SIGNED_SETTLEMENT_AGREEMENT'},
      CLAIMANT_SEND_SETTLEMENT_AGREEMENT_DEADLINE_EXPIRED: {translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.CLAIMANT_SIGNED_SETTLEMENT_AGREEMENT_DEADLINE_EXPIRED'},
...
export class DashboardDefendantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string | unknown): DashboardStatus {
    ...
    return {
      ...
      CLAIMANT_SEND_SETTLEMENT_AGREEMENT: {translationKey: 'PAGES.DASHBOARD.STATUS_DEFENDANT.CLAIMANT_SIGNED_SETTLEMENT_AGREEMENT', parameter: [paramClaimantName] },
