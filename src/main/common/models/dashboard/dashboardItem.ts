...
export class DashboardClaimantItem extends DashboardItem {
  ...
  getDashboardStatus(lang: string ): DashboardStatus {
    ...
    return {
      ...
      HEARING_FORM_GENERATED: {translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.TRIAL_OR_HEARING_SCHEDULED'},
      MORE_DETAILS_REQUIRED: { translationKey: 'PAGES.DASHBOARD.STATUS_CLAIMANT.MORE_DETAILS_REQUIRED' },
