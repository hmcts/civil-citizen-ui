...
export const VALID_CORRESPONDENCE_ADDRESS_LINE_1 = 'Enter first address line';
export const VALID_CORRESPONDENCE_CITY = 'Enter a valid town/city';
export const VALID_CORRESPONDENCE_POSTCODE = 'Enter address postcode';
