import {IsNotEmpty, IsIn, Validate, ValidateIf, NotContains} from 'class-validator';
...
export class BankAccount {
  ...
  @NotContains(BankAccountTypeValues.CHOOSE, {message: 'ERRORS.TYPE_OF_ACCOUNT_REQUIRED'})
