...
import {
  ...
  VALID_REASON_REQUIRED, VALID_TEXT_LENGTH,
...
import {FREE_TEXT_MAX_LENGTH, MAX_AMOUNT_VALUE} from 'common/form/validators/validationConstraints';

export class OnTaxPayments extends Form {
  @IsDefined({message: YES_NO_REQUIRED})
    option: YesNo;

  @ValidateIf(o => o.optionYesIsSelected)
  @Min(0, {message: VALID_OWED_AMOUNT_REQUIRED})
