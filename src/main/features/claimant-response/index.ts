...
export class ClaimantResponseFeature {
  enableFor(app: express.Express) {
    ...
    app.all(/^\/case\/.+\/claimant-response\/task-list|intention-to-proceed|check-and-send|incomplete-submission.*$/,//NOSONAR
    ...
    app.all(/^\/case\/.+\/claimant-response\/task-list|check-and-send|incomplete-submission.*$/,//NOSONAR
