...
import {
  AlternativeCourtOption,
  HearingLocation,
  ValidationErrors,
} from 'directions-questionnaire/forms/models/hearingLocation';
...
import {
  getNearestCourtDetails,
  handleLocationSearchError,
  handlePostCodeSearchError,
  locationSearch,
  postCodeSearch,
  searchByPostCodeForEdgecase,
} from 'directions-questionnaire/helpers/hearingLocationsHelper';
