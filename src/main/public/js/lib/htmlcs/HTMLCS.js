...
(function(root, factory) {
  ...
  _global.translation.cn = {
    ...
    register: function() {
      ...
      if (e === t) this.addNullAltTextResults(t), this.addMediaAlternativesResults(t); else {
        var n = e.nodeName.toLowerCase();
        'object' !== n && 'bgsound' !== n && 'audio' !== n || HTMLCS.addMessage(HTMLCS.NOTICE, e, 'For multimedia containing audio only, ensure an alternative is available, such as a full text transcript.', 'Audio');
      }
    }, testNullAltText: function(e) {
      var t = {
        img: { generalAlt: [], missingAlt: [], ignored: [], nullAltWithTitle: [], emptyAltInLink: [] },
      ...
      for (var n = 0; n < elements.length; n++) {
        var i = elements[n], a = i.nodeName.toLowerCase(), o = !1, r = !1, s = !1;
        if ('a' === i.parentNode.nodeName.toLowerCase()) {
          var l = HTMLCS.util.getPreviousSiblingElement(i, null), d = HTMLCS.util.getNextSiblingElement(i, null);
          if (null === l && null === d) {
            var u = i.parentNode.textContent;
            if (void 0 !== i.parentNode.textContent) u = i.parentNode.textContent; else u = i.parentNode.innerText;
            !0 === HTMLCS.util.isStringEmpty(u) && (o = !0);
          }
        }
        switch (!1 === i.hasAttribute('alt') ? r = !0 : i.getAttribute('alt') && !0 !== HTMLCS.util.isStringEmpty(i.getAttribute('alt')) || (s = !0), a) {
          case'img':
            !0 !== o || !0 !== r && !0 !== s ? !0 === r ? t.img.missingAlt.push(i) : !0 === s ? !0 === i.hasAttribute('title') && !1 === HTMLCS.util.isStringEmpty(i.getAttribute('title')) ? t.img.nullAltWithTitle.push(i) : t.img.ignored.push(i) : t.img.generalAlt.push(i) : t.img.emptyAltInLink.push(i.parentNode);
            break;
          case'input':
            !0 === r || !0 === s ? t.inputImage.missingAlt.push(i) : t.inputImage.generalAlt.push(i);
            break;
          case'area':
      ...
      for (var t = this.testNullAltText(e), n = 0; n < t.img.emptyAltInLink.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.emptyAltInLink[n], 'Img element is the only content of the link, but is missing alt text. The alt text should describe the purpose of the link.', 'Img.EmptyAltInLink');
      for (n = 0; n < t.img.nullAltWithTitle.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.nullAltWithTitle[n], 'Img element with empty alt text must have absent or empty title attribute.', 'Img.NullAltWithTitle');
      for (n = 0; n < t.img.ignored.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.img.ignored[n], 'Img element is marked so that it is ignored by Assistive Technology.', 'Img.Ignored');
      for (n = 0; n < t.img.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.missingAlt[n], 'Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.', 'Img.MissingAlt');
      for (n = 0; n < t.img.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.img.generalAlt[n], 'Ensure that the img element\'s alt text serves the same purpose and presents the same information as the image.', 'Img.GeneralAlt');
      for (n = 0; n < t.inputImage.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.inputImage.missingAlt[n], 'Image submit button missing an alt attribute. Specify a text alternative that describes the button\'s function, using the alt attribute.', 'InputImage.MissingAlt');
      for (n = 0; n < t.inputImage.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.inputImage.generalAlt[n], 'Ensure that the image submit button\'s alt text identifies the purpose of the button.', 'InputImage.GeneralAlt');
      for (n = 0; n < t.area.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.area.missingAlt[n], 'Area element in an image map missing an alt attribute. Each area element must have a text alternative that describes the function of the image map area.', 'Area.MissingAlt');
      for (n = 0; n < t.area.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.area.generalAlt[n], 'Ensure that the area element\'s text alternative serves the same purpose as the part of image map image it references.', 'Area.GeneralAlt');
    }, testMediaTextAlternatives: function(e) {
      for (var t = {
        object: { missingBody: [], generalAlt: [] },
        applet: { missingBody: [], missingAlt: [], generalAlt: [] },
      }, n = HTMLCS.util.getAllElements(e, 'object'), i = 0; i < n.length; i++) {
        var a = n[i];
        if (null === a.querySelector('object')) '' === (r = HTMLCS.util.getElementTextContent(a, !0)) ? t.object.missingBody.push(a) : t.object.generalAlt.push(a);
      }
      for (n = HTMLCS.util.getAllElements(e, 'applet'), i = 0; i < n.length; i++) {
        ...
        !0 === HTMLCS.util.isStringEmpty(s) && (t.applet.missingAlt.push(a), o = !0), !1 === o && t.applet.generalAlt.push(a);
      }
      return t;
    }, addMediaAlternativesResults: function(e) {
      for (var t = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_1_1_1_1.testMediaTextAlternatives(e), n = 0; n < t.object.missingBody.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.object.missingBody[n], 'Object elements must contain a text alternative after all other alternatives are exhausted.', 'Object.MissingBody');
      for (n = 0; n < t.object.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.object.generalAlt[n], 'Check that short (and if appropriate, long) text alternatives are available for non-text content that serve the same purpose and present the same information.', 'Object.GeneralAlt');
      for (n = 0; n < t.applet.missingBody.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.applet.missingBody[n], 'Applet elements must contain a text alternative in the element\'s body, for browsers without support for the applet element.', 'Applet.MissingBody');
      for (n = 0; n < t.applet.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.applet.missingAlt[n], 'Applet elements must contain an alt attribute, to provide a text alternative to browsers supporting the element but are unable to load the applet.', 'Applet.MissingAlt');
      for (n = 0; n < t.applet.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.applet.generalAlt[n], 'Check that short (and if appropriate, long) text alternatives are available for non-text content that serve the same purpose and present the same information.', 'Applet.GeneralAlt');
    },
    ...
    register: function() {
      ...
      for (var t = 0, n = HTMLCS.util.getAllElements(e, 'h1, h2, h3, h4, h5, h6'), i = 0; i < n.length; i++) {
        var a = parseInt(n[i].nodeName.substr(1, 1));
        if (1 < a - t) {
          var o = 'should be an h' + (t + 1) + ' to be properly nested';
          0 === t && (o = 'appears to be the primary document heading, so should be an h1 element'), HTMLCS.addMessage(HTMLCS.ERROR, n[i], 'The heading structure is not logically nested. This h' + a + ' element ' + o + '.', 'HeadingOrder');
        }
        t = a;
      }
    },
    ...
    register: function() {
      ...
      !0 === HTMLCS.util.isLayoutTable(e) && HTMLCS.addMessage(HTMLCS.NOTICE, e, 'This table has no headers. If this is a data table, ensure row and column headers are identified using th elements.', 'TableHeaders');
    },
  }, _global.HTMLCS_Section508_Sniffs_H = {
    register: function() {
      return ['table'];
    }, process: function(e, t) {
      for (var n = HTMLCS.util.testTableHeaders(e), i = 0; i < n.wrongHeaders.length; i++) HTMLCS.addMessage(HTMLCS.ERROR, n.wrongHeaders[i].element, 'Incorrect headers attribute on this td element. Expected "' + n.wrongHeaders[i].expected + '" but found "' + n.wrongHeaders[i].actual + '"', 'IncorrectHeadersAttr');
    ...
    register: function() {
      ...
      var n = e.nodeName.toLowerCase(), i = !0;
      !0 === e.hasAttribute('title') && (i = HTMLCS.util.isStringEmpty(e.getAttribute('title'))), !0 === i && HTMLCS.addMessage(HTMLCS.ERROR, t, 'This ' + n + ' element is missing title text. Frames should be titled with text that facilitates frame identification and navigation.', 'Frames');
    },
  }, _global.HTMLCS_Section508_Sniffs_J = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, 'Check that no component of the content flickers at a rate of greater than 2 and less than 55 times per second.', 'Flicker');
    },
  }, _global.HTMLCS_Section508_Sniffs_K = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, 'If this page cannot be made compliant, a text-only page with equivalent information or functionality should be provided. The alternative page needs to be updated in line with this page\'s content.', 'AltVersion');
    },
    ...
    register: function() {
      ...
      for (var t = this.processLinks(e), n = 0; n < t.emptyNoId.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.emptyNoId[n], 'Anchor element found with no link content and no name and/or ID attribute.', 'EmptyAnchorNoId');
      for (n = 0; n < t.placeholder.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.placeholder[n], 'Anchor element found with link content, but no href, ID, or name attribute has been supplied.', 'PlaceholderAnchor');
      for (n = 0; n < t.noContent.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.noContent[n], 'Anchor element found with a valid href attribute, but no link content has been supplied.', 'NoContentAnchor');
      ...
      for (var t = {
        ...
        placeholder: [],
        noContent: [],
      }, n = HTMLCS.util.getAllElements(e, 'a'), i = 0; i < n.length; i++) {
        var a = n[i], o = !1, r = HTMLCS.util.getElementTextContent(a);
        !0 === a.hasAttribute('href') && !1 === /^\s*$/.test(a.getAttribute('href')) && (o = !0), !1 === o ? !0 === /^\s*$/.test(r) ? !0 === a.hasAttribute('id') ? t.empty.push(a) : !0 === a.hasAttribute('name') ? t.emptyWithName.push(a) : t.emptyNoId.push(a) : !0 === a.hasAttribute('id') || !0 === a.hasAttribute('name') ? t.noHref.push(a) : t.placeholder.push(a) : !0 === /^\s*$/.test(r) && 0 === a.querySelectorAll('img').length && t.noContent.push(a);
      }
      return t;
    }, testKeyboard: function(e) {
      for (var t = HTMLCS.util.getAllElements(e, '*[ondblclick]'), n = 0; n < t.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t[n], 'Ensure the functionality provided by double-clicking on this element is available through the keyboard.', 'DblClick');
      var i = HTMLCS.util.getAllElements(e, '*[onmouseover]');
      for (n = 0; n < i.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, i[n], 'Ensure the functionality provided by mousing over this element is available through the keyboard; for instance, using the focus event.', 'MouseOver');
      var a = HTMLCS.util.getAllElements(e, '*[onmouseout]');
      for (n = 0; n < a.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, a[n], 'Ensure the functionality provided by mousing out of this element is available through the keyboard; for instance, using the blur event.', 'MouseOut');
      var o = HTMLCS.util.getAllElements(e, '*[onmousemove]');
      for (n = 0; n < o.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, o[n], 'Ensure the functionality provided by moving the mouse on this element is available through the keyboard.', 'MouseMove');
      var r = HTMLCS.util.getAllElements(e, '*[onmousedown]');
      for (n = 0; n < r.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, r[n], 'Ensure the functionality provided by mousing down on this element is available through the keyboard; for instance, using the keydown event.', 'MouseDown');
      var s = HTMLCS.util.getAllElements(e, '*[onmouseup]');
      for (n = 0; n < s.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, s[n], 'Ensure the functionality provided by mousing up on this element is available through the keyboard; for instance, using the keyup event.', 'MouseUp');
    },
  }, _global.HTMLCS_Section508_Sniffs_M = {
    register: function() {
      return ['object', 'applet', 'bgsound', 'embed', 'audio', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, 'If external media requires a plugin or application to view, ensure a link is provided to a plugin or application that complies with Section 508 accessibility requirements for applications.', 'PluginLink');
    },
  }, _global.HTMLCS_Section508_Sniffs_N = {
    register: function() {
      return ['form'];
    }, process: function(e, t) {
      'form' === e.nodeName.toLowerCase() && (HTMLCS.addMessage(HTMLCS.NOTICE, e, 'If an input error is automatically detected in this form, check that the item(s) in error are identified and the error(s) are described to the user in text.', 'Errors'), HTMLCS.addMessage(HTMLCS.NOTICE, e, 'Check that descriptive labels or instructions (including for required fields) are provided for user input in this form.', 'Labels'), HTMLCS.addMessage(HTMLCS.NOTICE, e, 'Ensure that this form can be navigated using the keyboard and other accessibility tools.', 'KeyboardNav'));
    },
  }, _global.HTMLCS_Section508_Sniffs_O = {
    register: function() {
      return ['_top', 'a', 'area'];
    }, process: function(e, t) {
      if (e === t) HTMLCS.addMessage(HTMLCS.NOTICE, t, 'Ensure that any common navigation elements can be bypassed; for instance, by use of skip links, header elements, or ARIA landmark roles.', 'SkipLinks'); else if (!0 === e.hasAttribute('href')) {
        ...
        if (1 < (n = HTMLCS.util.trim(n)).length && '#' === n.charAt(0)) {
          ...
          try {
            ...
            null === o && (o = a.querySelector('a[name="' + i + '"]')), null !== o && !1 !== HTMLCS.util.contains(t, o) || (!0 === HTMLCS.isFullDoc(t) || 'body' === t.nodeName.toLowerCase() ? HTMLCS.addMessage(HTMLCS.ERROR, e, 'This link points to a named anchor "' + i + '" within the document, but no anchor exists with that name.', 'NoSuchID') : HTMLCS.addMessage(HTMLCS.WARNING, e, 'This link points to a named anchor "' + i + '" within the document, but no anchor exists with that name in the fragment tested.', 'NoSuchIDFragment'));
          } catch (e) {
          }
        }
      }
    ...
    register: function() {
      ...
      e === t ? HTMLCS.addMessage(HTMLCS.NOTICE, t, 'If a timed response is required on this page, alert the user and provide sufficient time to allow them to indicate that more time is required.', 'TimeLimit') : !0 === e.hasAttribute('http-equiv') && 'refresh' === String(e.getAttribute('http-equiv')).toLowerCase() && !0 === /^[1-9]\d*/.test(e.getAttribute('content').toLowerCase()) && (!0 === /url=/.test(e.getAttribute('content').toLowerCase()) ? HTMLCS.addMessage(HTMLCS.ERROR, e, 'Meta refresh tag used to redirect to another page, with a time limit that is not zero. Users cannot control this time limit.', 'MetaRedirect') : HTMLCS.addMessage(HTMLCS.ERROR, e, 'Meta refresh tag used to refresh the current page. Users cannot control the time limit for this refresh.', 'MetaRefresh'));
    },
  }, _global.HTMLCS_WCAG2A = {
    name: 'WCAG2A', description: 'Web Content Accessibility Guidelines (WCAG) 2.1 A', sniffs: [{
      standard: 'WCAG2AAA',
    ...
    name: 'WCAG2AA', description: 'Web Content Accessibility Guidelines (WCAG) 2.1 AA', sniffs: [{
      standard: 'WCAG2AAA',
    ...
    getMsgInfo: function(e) {
      var t = {
        ...
        Principle3: { name: 'Understandable', link: 'http://www.w3.org/TR/WCAG21/#understandable' },
        ...
        CR4: { name: 'Only Accessibility-Supported Ways of Using Technologies', landmark: 'cc4', priority: 0 },
        ...
        '1.2.2': { name: 'Captions (Prerecorded)', landmark: 'captions-prerecorded', priority: 1 },
        '1.2.3': {
        ...
        '1.2.5': { name: 'Audio Description (Prerecorded)', landmark: 'audio-description-prerecorded', priority: 2 },
        '1.2.6': { name: 'Sign Language (Prerecorded)', landmark: 'sign-language-prerecorded', priority: 3 },
        '1.2.7': {
          name: 'Extended Audio Description (Prerecorded)',
          landmark: 'extended-audio-description-prerecorded',
          priority: 3,
        },
        '1.2.8': { name: 'Media Alternative (Prerecorded)', landmark: 'media-alternative-prerecorded', priority: 3 },
        '1.2.9': { name: 'Audio-only (Live)', landmark: 'audio-only-live', priority: 3 },
        '1.3.1': { name: 'Info and Relationships', landmark: 'info-and-relationships', priority: 1 },
        '1.3.2': { name: 'Meaningful Sequence', landmark: 'meaningful-sequence', priority: 1 },
        '1.3.3': { name: 'Sensory Characteristics', landmark: 'sensory-characteristics', priority: 1 },
        '1.3.4': { name: 'Orientation', landmark: 'orientation', priority: 2 },
        '1.3.5': { name: 'Identify Input Purpose', landmark: 'identify-input-purpose', priority: 2 },
        ...
        '1.4.7': { name: 'Low or No Background Audio', landmark: 'low-or-no-background-audio', priority: 3 },
        '1.4.8': { name: 'Visual Presentation', landmark: 'visual--presentation', priority: 3 },
        '1.4.9': { name: 'Images of Text (No Exception)', landmark: 'images-of-text-no-exception', priority: 3 },
        ...
        '1.4.13': { name: 'Content on Hover or Focus', landmark: 'content-on-hover-or-focus', priority: 2 },
        '2.1.1': { name: 'Keyboard', landmark: 'keyboard', priority: 1 },
        '2.1.2': { name: 'No Keyboard Trap', landmark: 'no-keyboard-trap', priority: 1 },
        '2.1.3': { name: 'Keyboard (No Exception)', landmark: 'keyboard-no-exception', priority: 3 },
        '2.1.4': { name: 'Character Key Shortcuts', landmark: 'character-key-shortcuts', priority: 1 },
        ...
        '2.3.3': { name: 'Animation from Interactions', landmark: 'animation-from-interactions', priority: 3 },
        ...
        '2.4.4': { name: 'Link Purpose (In Context)', landmark: 'link-purpose-in-context', priority: 1 },
        ...
        '2.4.9': { name: 'Link Purpose (Link Only)', landmark: 'link-purpose-link-only', priority: 3 },
        ...
        '2.5.2': { name: 'Pointer Cancellation', landmark: 'pointer-cancellation', priority: 1 },
        ...
        '2.5.6': { name: 'Concurrent Input Mechanisms', landmark: 'concurrent-input-mechanisms', priority: 3 },
        ...
        '3.2.3': { name: 'Consistent Navigation', landmark: 'consistent-navigation', priority: 2 },
        '3.2.4': { name: 'Consistent Identification', landmark: 'consistent-identification', priority: 2 },
        '3.2.5': { name: 'Change on Request', landmark: 'change-on-request', priority: 3 },
        '3.3.1': { name: 'Error Identification', landmark: 'error-identification', priority: 1 },
        '3.3.2': { name: 'Labels or Instructions', landmark: 'labels-or-instructions', priority: 1 },
        ...
        '3.3.6': { name: 'Error Prevention (All)', landmark: 'error-prevention-all', priority: 3 },
      ...
      }, i = e.split('.', 5), a = i[1], o = i[3].split('_').slice(0, 3).join('.'), r = i[4].split(','), s = [];
      ...
      function l(e) {
        ...
        return t(e, 'ARIA') ? 'aria/' : t(e, 'SCR') ? 'client-side-script/' : t(e, 'C') ? 'css/' : t(e, 'FLASH') ? 'flash/' : t(e, 'F') ? 'failures/' : t(e, 'G') ? 'general/' : t(e, 'H') ? 'html/' : t(e, 'PDF') ? 'pdf/' : t(e, 'SVR') ? 'server-side-script/' : t(e, 'SL') ? 'silverlight/' : t(e, 'SM') ? 'smil/' : t(e, 'T') ? 'text/' : '';
      }

      for (var d = 0; d < r.length; d++) r[d] = r[d].split('.'), '' !== r[d][0] && s.push('<a href="https://www.w3.org/WAI/WCAG21/Techniques/' + l(r[d][0]) + r[d][0] + '" target="_blank">' + r[d][0] + '</a>');
      var u = ['<a href="http://www.w3.org/TR/WCAG21/#' + n[o].landmark, '" target="_blank">', o, ': ', n[o].name, '</a>'].join(''),
        _ = (['<a href="', t[a].link, '" target="_blank">', t[a].name, '</a>'].join(''), [[_global.HTMLCS.getTranslation('auditor_success_criterion'), u]]);
      return 0 < s.length && _.push([_global.HTMLCS.getTranslation('auditor_suggested_techniques'), s.join(' ')]), _;
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_1_1_1_1 = {
    register: function() {
      return ['_top', 'img'];
    }, process: function(e, t) {
      if (e === t) this.addNullAltTextResults(t), this.addMediaAlternativesResults(t); else switch (e.nodeName.toLowerCase()) {
        case'img':
          this.testLinkStutter(e), this.testLongdesc(e);
      }
    }, addNullAltTextResults: function(e) {
      for (var t = this.testNullAltText(e), n = 0; n < t.img.emptyAltInLink.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.emptyAltInLink[n], _global.HTMLCS.getTranslation('1_1_1_H30.2'), 'H30.2');
      for (n = 0; n < t.img.nullAltWithTitle.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.nullAltWithTitle[n], _global.HTMLCS.getTranslation('1_1_1_H67.1'), 'H67.1');
      for (n = 0; n < t.img.ignored.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.img.ignored[n], _global.HTMLCS.getTranslation('1_1_1_H67.2'), 'H67.2');
      for (n = 0; n < t.img.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.img.missingAlt[n], _global.HTMLCS.getTranslation('1_1_1_H37'), 'H37');
      for (n = 0; n < t.img.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.img.generalAlt[n], _global.HTMLCS.getTranslation('1_1_1_G94.Image'), 'G94.Image');
      for (n = 0; n < t.inputImage.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.inputImage.missingAlt[n], _global.HTMLCS.getTranslation('1_1_1_H36'), 'H36');
      for (n = 0; n < t.inputImage.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.inputImage.generalAlt[n], _global.HTMLCS.getTranslation('1_1_1_G94.Button'), 'G94.Button');
      for (n = 0; n < t.area.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.area.missingAlt[n], _global.HTMLCS.getTranslation('1_1_1_H24'), 'H24');
      for (n = 0; n < t.area.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.area.generalAlt[n], _global.HTMLCS.getTranslation('1_1_1_H24.2'), 'H24.2');
    }, testNullAltText: function(e) {
      var t = {
        img: { generalAlt: [], missingAlt: [], ignored: [], nullAltWithTitle: [], emptyAltInLink: [] },
        inputImage: { generalAlt: [], missingAlt: [] },
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_1_1_G73,G74'), 'G73,G74');
      ...
      if ('a' === e.parentNode.nodeName.toLowerCase()) {
        ...
        if (null === n.anchor.alt && (n.anchor.alt = ''), null !== n.anchor.alt && '' !== n.anchor.alt && HTMLCS.util.trim(n.anchor.alt).toLowerCase() === HTMLCS.util.trim(n.anchor.text).toLowerCase() && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_1_1_H2.EG5'), 'H2.EG5'), '' === n.anchor.text) {
          var i = HTMLCS.util.getPreviousSiblingElement(t, 'a', !0), a = HTMLCS.util.getNextSiblingElement(t, 'a', !0);
          null !== i && (n.previous = {
            href: i.getAttribute('href'),
            text: HTMLCS.util.getElementTextContent(i, !1),
            alt: this._getLinkAltText(i),
          }, null === n.previous.alt && (n.previous.alt = '')), null !== a && (n.next = {
            href: a.getAttribute('href'),
            text: HTMLCS.util.getElementTextContent(a, !1),
            alt: this._getLinkAltText(a),
          }, null === n.next.alt && (n.next.alt = '')), n.next && '' !== n.next.href && null !== n.next.href && n.anchor.href === n.next.href && ('' !== n.next.text && '' === n.anchor.alt ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_1_1_H2.EG4'), 'H2.EG4') : n.next.text.toLowerCase() === n.anchor.alt.toLowerCase() && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_1_1_H2.EG3'), 'H2.EG3')), n.previous && '' !== n.previous.href && null !== n.previous.href && n.anchor.href === n.previous.href && ('' !== n.previous.text && '' === n.anchor.alt ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_1_1_H2.EG4'), 'H2.EG4') : n.previous.text.toLowerCase() === n.anchor.alt.toLowerCase() && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_1_1_H2.EG3')));
        }
      }
    }, addMediaAlternativesResults: function(e) {
      for (var t = this.testMediaTextAlternatives(e), n = 0; n < t.object.missingBody.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.object.missingBody[n], _global.HTMLCS.getTranslation('1_1_1_H53,ARIA6'), 'H53,ARIA6');
      for (n = 0; n < t.object.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.object.generalAlt[n], _global.HTMLCS.getTranslation('1_1_1_G94,G92.Object,ARIA6'), 'G94,G92.Object,ARIA6');
      for (n = 0; n < t.applet.missingBody.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.applet.missingBody[n], _global.HTMLCS.getTranslation('1_1_1_H35.3'), 'H35.3');
      for (n = 0; n < t.applet.missingAlt.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.applet.missingAlt[n], _global.HTMLCS.getTranslation('1_1_1_H35.2'), 'H35.2');
      for (n = 0; n < t.applet.generalAlt.length; n++) HTMLCS.addMessage(HTMLCS.NOTICE, t.applet.generalAlt[n], _global.HTMLCS.getTranslation('1_1_1_G94,G92.Applet'), 'G94,G92.Applet');
    }, testMediaTextAlternatives: function(e) {
      for (var t = {
        object: { missingBody: [], generalAlt: [] },
        applet: { missingBody: [], missingAlt: [], generalAlt: [] },
        ...
        var a = n[i];
        null === a.querySelector('object') && (!0 === HTMLCS.util.isStringEmpty(HTMLCS.util.getElementTextContent(a, !0)) ? !1 === HTMLCS.util.hasValidAriaLabel(a) && t.object.missingBody.push(a) : !1 === HTMLCS.util.hasValidAriaLabel(a) && t.object.generalAlt.push(a));
      }
      for (n = HTMLCS.util.getAllElements(e, 'applet'), i = 0; i < n.length; i++) {
        var o = !1;
        if (null === a.querySelector('object')) {
        ...
        var s = a.getAttribute('alt') || '';
        !0 === HTMLCS.util.isStringEmpty(s) && (t.applet.missingAlt.push(a), o = !0), !0 === HTMLCS.util.hasValidAriaLabel(a) && (o = !1), !1 === o && t.applet.generalAlt.push(a);
      }
      return t;
      ...
      for (var i = null; 0 < t.length;) {
        var a = t.shift();
        if (1 === a.nodeType && 'img' === a.nodeName.toLowerCase() && !0 === a.hasAttribute('alt')) {
    ...
    register: function() {
      ...
      var n = e.nodeName.toLowerCase();
      'video' !== n && HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_1_G158'), 'G158'), 'bgsound' !== n && 'audio' !== n && HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_1_G159,G166'), 'G159,G166');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_2 = {
    register: function() {
      return ['object', 'embed', 'applet', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_2_G87,G93'), 'G87,G93');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_3 = {
    register: function() {
      return ['object', 'embed', 'applet', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_3_G69,G78,G173,G8'), 'G69,G78,G173,G8');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_4 = {
    register: function() {
      return ['object', 'embed', 'applet', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_4_G9,G87,G93'), 'G9,G87,G93');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_5 = {
    register: function() {
      return ['object', 'embed', 'applet', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_5_G78,G173,G8'), 'G78,G173,G8');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_6 = {
    register: function() {
      return ['object', 'embed', 'applet', 'video'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_6_G54,G81'), 'G54,G81');
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_8_G69,G159'), 'G69,G159');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_2_1_2_9 = {
    register: function() {
      return ['object', 'embed', 'applet', 'bgsound', 'audio'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_2_9_G150,G151,G157'), 'G150,G151,G157');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_3_1_3_1_A = {
    _labelNames: null, register: function() {
      return ['_top'];
    }, process: function(e, t) {
    ...
    _labelNames: null, register: function() {
      ...
      var n = e.nodeName.toLowerCase();
      if (e === t) this.testPresentationMarkup(t), this.testEmptyDupeLabelForAttrs(t); else switch (n) {
        case'input':
        case'textarea':
        case'button':
        ...
        case'p':
        case'div':
          this.testNonSemanticHeading(e), this.testListsWithBreaks(e), this.testUnstructuredNavLinks(e);
          break;
        case'table':
      ...
      var t = ['div', 'span', 'b', 'i'];
      if (!1 === HTMLCS.util.isAriaHidden(e) && e.hasAttribute('role') && 'presentation' === e.getAttribute('role') && -1 === t.indexOf(e.nodeName.toLowerCase())) {
        var n = e.querySelectorAll('*:not(' + t.join('):not(') + ')');
        (n = [].filter.call(n, function(e) {
          return !1 === e.hasAttribute('role');
        })).length && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_F92,ARIA4'), 'F92,ARIA4');
      }
    }, testEmptyDupeLabelForAttrs: function(e) {
      this._labelNames = {};
      for (var t = e.getElementsByTagName('label'), n = 0; n < t.length; n++) if (null !== t[n].getAttribute('for') && '' !== t[n].getAttribute('for')) {
        var i = t[n].getAttribute('for');
        if (this._labelNames[i] && null !== this._labelNames[i]) this._labelNames[i] = null; else {
          if (this._labelNames[i] = t[n], e.ownerDocument) var a = e.ownerDocument.getElementById(i); else a = e.getElementById(i);
          if (null === a) {
            var o = HTMLCS.ERROR, r = _global.HTMLCS.getTranslation('1_3_1_H44.NonExistent'), s = 'H44.NonExistent';
            if (!0 === HTMLCS.isFullDoc(e) || 'body' === e.nodeName.toLowerCase()) {
              o = HTMLCS.WARNING, r = _global.HTMLCS.getTranslation('1_3_1_H44.NonExistentFragment');
              s = 'H44.NonExistentFragment';
            }
            HTMLCS.addMessage(o, t[n], r, s);
          } else {
            var l = a.nodeName.toLowerCase();
            -1 === 'input|select|textarea|button|keygen|meter|output|progress'.indexOf(l) && HTMLCS.addMessage(HTMLCS.WARNING, t[n], _global.HTMLCS.getTranslation('1_3_1_H44.NotFormControl'), 'H44.NotFormControl');
          }
        }
      }
    }, testLabelsOnInputs: function(e, t, n) {
      'input' === (i = e.nodeName.toLowerCase()) && (i = !0 === e.hasAttribute('type') ? e.getAttribute('type') : 'text');
      var i, a = !1, o = function(e) {
        a || (a = {}), a[e] = !0;
      }, r = !1;
      'select' === (i = i.toLowerCase()) || 'textarea' === i ? r = !0 : !0 === /^(radio|checkbox|text|file|password)$/.test(i) && (r = !0), null !== e.getAttribute('hidden') && (r = !1), e.ownerDocument.querySelector('label[for="' + e.id + '"]') && o('explicit');
      var s = !1;
      e.parentNode && HTMLCS.util.eachParentNode(e, function(e) {
        'label' === e.nodeName.toLowerCase() && (s = !0);
      }), !0 === s && o('implicit');
      var l = e.getAttribute('title');
      return null !== l && (!0 === /^\s*$/.test(l) && !0 === r ? HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H65'), 'H65') : o('title')), !0 === e.hasAttribute('aria-label') && (!1 === HTMLCS.util.hasValidAriaLabel(e) ? HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_ARIA6'), 'ARIA6') : o('aria-label')), !0 === e.hasAttribute('aria-labelledby') && (!1 === HTMLCS.util.hasValidAriaLabel(e) ? HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_ARIA16,ARIA9').replace(/\{\{id\}\}/g, e.getAttribute('aria-labelledby')), 'ARIA16,ARIA9') : o('aria-labelledby')), !0 !== n && (!1 !== a && !1 === r ? 'hidden' === i ? HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_F68.Hidden'), 'F68.Hidden') : null !== e.getAttribute('hidden') && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_F68.HiddenAttr'), 'F68.HiddenAttr') : !1 === a && !0 === r && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_F68'), 'F68')), a;
    }, testPresentationMarkup: function(e) {
      var t = HTMLCS.util.getElementWindow(e).document, n = HTMLCS.util.getDocumentType(t);
      if (!n || 'html5' !== n && 'xhtml5' !== n) {
        for (i = HTMLCS.util.getAllElements(e, 'b, i, u, s, strike, tt, big, small, center, font'), a = 0; a < i.length; a++) {
          o = 'H49.' + i[a].nodeName.substr(0, 1).toUpperCase() + i[a].nodeName.substr(1).toLowerCase();
          HTMLCS.addMessage(HTMLCS.WARNING, i[a], _global.HTMLCS.getTranslation('1_3_1_H49.Semantic'), o);
        }
        for (i = HTMLCS.util.getAllElements(e, '*[align]'), a = 0; a < i.length; a++) {
          o = 'H49.AlignAttr';
          HTMLCS.addMessage(HTMLCS.WARNING, i[a], _global.HTMLCS.getTranslation('1_3_1_H49.AlignAttr.Semantic'), o);
        }
      } else {
        for (var i = HTMLCS.util.getAllElements(e, 'strike, tt, big, center, font'), a = 0; a < i.length; a++) {
          var o = 'H49.' + i[a].nodeName.substr(0, 1).toUpperCase() + i[a].nodeName.substr(1).toLowerCase();
      ...
      if ('p' === t || 'div' === t) {
        ...
        if (1 === n.length && 1 === n[0].nodeType) {
          ...
          !0 === /^(strong|em|b|i|u)$/.test(i) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H42'), 'H42');
        }
      }
    }, testTableHeaders: function(e) {
      for (var t = HTMLCS.util.testTableHeaders(e), n = this._testTableScopeAttrs(e), i = 0; i < n.invalid.length; i++) HTMLCS.addMessage(HTMLCS.ERROR, n.invalid[i], _global.HTMLCS.getTranslation('1_3_1_H63.3'), 'H63.3');
      for (i = 0; i < n.obsoleteTd.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, n.obsoleteTd[i], _global.HTMLCS.getTranslation('1_3_1_H63.2'), 'H63.2');
      !0 === t.allowScope ? 0 === n.missing.length && t.required : !0 === n.used && (HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H43.ScopeAmbiguous'), 'H43.ScopeAmbiguous'), n = null);
      for (i = 0; i < t.wrongHeaders.length; i++) HTMLCS.addMessage(HTMLCS.ERROR, t.wrongHeaders[i].element, _global.HTMLCS.getTranslation('1_3_1_H43.IncorrectAttr').replace(/\{\{expected\}\}/g, t.wrongHeaders[i].expected).replace(/\{\{actual\}\}/g, t.wrongHeaders[i].actual), 'H43.IncorrectAttr');
      ...
      for (var i in t) for (var a = 0; a < t[i].length; a++) {
        var o = t[i][a], r = '';
        !0 === o.hasAttribute('scope') && (n.used = !0, o.getAttribute('scope') && (r = o.getAttribute('scope'))), 'th' === o.nodeName.toLowerCase() ? !0 === /^\s*$/.test(r) ? (n.correct = !1, n.missing.push(o)) : !1 === /^(row|col|rowgroup|colgroup)$/.test(r) && (n.correct = !1, n.invalid.push(o)) : '' !== r && (n.obsoleteTd.push(o), !1 === /^(row|col|rowgroup|colgroup)$/.test(r) && (n.correct = !1, n.invalid.push(o)));
      }
      return n;
    }, testTableCaptionSummary: function(e) {
      var t = e.getAttribute('summary') || '', n = e.getElementsByTagName('caption'), i = '';
      0 < n.length && (i = n[0].innerHTML.replace(/^\s*(.*?)\s*$/g, '$1'));
      var a = HTMLCS.util.getDocumentType(e.ownerDocument);
      a && -1 === a.indexOf('html5') && ('' !== (t = t.replace(/^\s*(.*?)\s*$/g, '$1')) ? !0 === HTMLCS.util.isLayoutTable(e) ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_H73.3.LayoutTable'), 'H73.3.LayoutTable') : (i === t && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_H39,H73.4'), 'H39,H73.4'), HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_1_H73.3.Check'), 'H73.3.Check')) : !1 === HTMLCS.util.isLayoutTable(e) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H73.3.NoSummary'), 'H73.3.NoSummary')), '' !== i ? !0 === HTMLCS.util.isLayoutTable(e) ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_H39.3.LayoutTable'), 'H39.3.LayoutTable') : HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_1_H39.3.Check'), 'H39.3.Check') : !1 === HTMLCS.util.isLayoutTable(e) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H39.3.NoCaption'), 'H39.3.NoCaption');
    }, testFieldsetLegend: function(e) {
      var t = e.querySelector('legend');
      null !== t && t.parentNode === e || HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_H71.NoLegend'), 'H71.NoLegend');
    }, testOptgroup: function(e) {
      null === e.querySelector('optgroup') && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H85.2'), 'H85.2');
    }, testRequiredFieldsets: function(e) {
      for (var t = e.querySelectorAll('input[type=radio], input[type=checkbox]'), n = {}, i = 0; i < t.length; i++) {
        var a = t[i];
        if (!0 === a.hasAttribute('name')) {
          for (var o = a.getAttribute('name'), r = a.parentNode; "fieldset" !== r.nodeName.toLowerCase() && null !== r && r !== e;) r = r.parentNode;
          'fieldset' !== r.nodeName.toLowerCase() && (r = null);
        }
        if (void 0 === n[o]) n[o] = r; else if (null === r || r !== n[o]) {
          HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H71.SameName'), 'H71.SameName');
          break;
        }
      }
      ...
      if (null !== e.querySelector('br')) {
        ...
        for (var a = []; 0 < n.length;) {
          var o = n.shift();
          if (1 === o.nodeType) if ('br' === o.nodeName.toLowerCase()) t.push(a.join(' ').replace(/^\s*(.*?)\s*$/g, '$1')), a = []; else for (i = o.childNodes.length - 1; 0 <= i; --i) n.unshift(o.childNodes[i]); else 3 === o.nodeType && a.push(o.nodeValue);
        }
        0 < a.length && t.push(a.join(' ').replace(/^\s*(.*?)\s*$/g, '$1'));
        for (i = 0; i < t.length; i++) {
          if (!0 === /^[-*]\s+/.test(t[0])) {
            HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H48.1'), 'H48.1');
            break;
          }
          if (!0 === /^\d+[:/\-.]?\s+/.test(t[0])) {
            HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H48.2'), 'H48.2');
            break;
          }
        }
      }
    }, testHeadingOrder: function(e, t) {
      for (var n = 0, i = HTMLCS.util.getAllElements(e, 'h1, h2, h3, h4, h5, h6'), a = 0; a < i.length; a++) {
        var o = parseInt(i[a].nodeName.substr(1, 1));
        1 < o - n && (0 === n && HTMLCS.addMessage(t, i[a], _global.HTMLCS.getTranslation('1_3_1_G141_a').replace(/\{\{headingNum\}\}/g, o), 'G141'), HTMLCS.addMessage(t, i[a], _global.HTMLCS.getTranslation('1_3_1_G141_b').replace(/\{\{headingNum\}\}/g, o).replace(/\{\{properHeadingNum\}\}/g, n + 1), 'G141')), n = o;
      }
    }, testEmptyHeading: function(e) {
      var t = HTMLCS.util.getElementTextContent(e, !0);
      !0 === /^\s*$/.test(t) && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_1_H42.2'), 'H42.2');
    }, testUnstructuredNavLinks: function(e) {
      for (var t = 0, n = e.childNodes, i = 0; i < n.length && !(1 === n[i].nodeType && "a" === n[i].nodeName.toLowerCase() && 1 < ++t); i++) ;
      if (1 < t) {
        for (var a = e.parentNode; null !== a && "ul" !== a.nodeName.toLowerCase() && "ol" !== a.nodeName.toLowerCase();) a = a.parentNode;
        null === a && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_1_H48'), 'H48');
      }
    }, testGeneralTable: function(e) {
      !0 === HTMLCS.util.isLayoutTable(e) ? HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_1_LayoutTable'), 'LayoutTable') : HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_1_DataTable'), 'DataTable');
    },
    ...
    register: function() {
      ...
      if ('string' == typeof n) {
        ...
        !0 === a && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_3_5_H98.FaultyValue').replace(/\{\{valuesStr\}\}/g, n), 'H98');
      }
    }, checkControlGroups: function(e) {
      for (var t = ['name', 'honorific-prefix', 'given-name', 'additional-name', 'family-name', 'honorific-suffix', 'nickname', 'organization-title', 'username', 'organization', 'address-line1', 'address-line2', 'address-line3', 'address-level4', 'address-level3', 'address-level2', 'address-level1', 'country', 'country-name', 'postal-code', 'cc-name', 'cc-given-name', 'cc-additional-name', 'cc-family-name', 'cc-number', 'cc-csc', 'cc-type', 'transaction-currency', 'language', 'sex', 'tel-country-code', 'tel-national', 'tel-area-code', 'tel-local', 'tel-local-prefix', 'tel-local-suffix', 'tel-extension'], n = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, i = ['street-address'], a = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, o = ['new-password', 'current-password'], r = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'password' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, s = ['url', 'photo', 'impp'], l = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'email' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, d = ['tel'], u = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'tel' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, _ = ['cc-exp-month', 'cc-exp-year', 'transaction-amount', 'bday-day', 'bday-month', 'bday-year'], c = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'number' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, m = ['cc-exp'], g = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'month' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, p = ['bday'], h = 'INPUT' === e.tagName && 'hidden' === e.getAttribute('type') || 'INPUT' === e.tagName && 'text' === e.getAttribute('type') || 'INPUT' === e.tagName && 'search' === e.getAttribute('type') || 'INPUT' === e.tagName && 'date' === e.getAttribute('type') || 'TEXTAREA' === e.tagName || 'SELECT' === e.tagName, b = e.getAttribute('autocomplete').split(' '), f = 0; f < b.length; f++) {
        b[f] = b[f].trim();
        var C = b[f];
        -1 < t.indexOf(C) && !n && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Text').replace(/\{\{x\}\}/g, C), 'H98'), -1 < i.indexOf(C) && !a && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Multiline').replace(/\{\{x\}\}/g, C), 'H98'), -1 < o.indexOf(C) && !r && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Password').replace(/\{\{x\}\}/g, C), 'H98'), -1 < s.indexOf(C) && !l && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Url').replace(/\{\{x\}\}/g, C), 'H98'), -1 < d.indexOf(C) && !u && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Telephone').replace(/\{\{x\}\}/g, C), 'H98'), -1 < _.indexOf(C) && !c && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Numeric').replace(/\{\{x\}\}/g, C), 'H98'), -1 < m.indexOf(C) && !g && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Month').replace(/\{\{x\}\}/g, C), 'H98'), -1 < p.indexOf(C) && !h && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_3_5_H98.InvalidAutoComplete_Date').replace(/\{\{x\}\}/g, C), 'H98');
      }
    }, process: function(e, t) {
      if (e === t) for (var n = HTMLCS.util.getAllElements(e, '*[autocomplete]'), i = 0; i < n.length; i++) {
        var a = n[i];
        this.checkValidAttributes(a), this.checkControlGroups(a);
      } else {
        HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_5_H98.Purpose'), 'H98');
        if (-1 < ['hidden', 'checkbox', 'radio', 'file', 'submit', 'image', 'reset', 'button'].indexOf(e.getAttribute('type'))) return;
        !1 === e.hasAttribute('autocomplete') && HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('1_3_5_H98.MissingAutocomplete'), 'H98');
      }
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_3_6_ARIA11.Check'), 'ARIA11');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_1 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_1_G14,G18'), 'G14,G182');
    },
    ...
    register: function() {
      ...
      if (e === t) {
        HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_10_C32,C31,C33,C38,SCR34,G206.Check'), 'C32,C31,C33,C38,SCR34,G206');
        for (var n = HTMLCS.util.getAllElements(t, '*'), i = 0; i < n.length; i++) {
          var a = n[i];
          'fixed' == window.getComputedStyle(a, null).getPropertyValue('position') && HTMLCS.addMessage(HTMLCS.WARNING, a, _global.HTMLCS.getTranslation('1_4_10_C32,C31,C33,C38,SCR34,G206.Fixed'), 'C32,C31,C33,C38,SCR34,G206');
        }
      } else {
        switch (e.nodeName.toLowerCase()) {
          case'pre':
            HTMLCS.addMessage(HTMLCS.WARNING, t, _global.HTMLCS.getTranslation('1_4_10_C32,C31,C33,C38,SCR34,G206.Scrolling'), 'C32,C31,C33,C38,SCR34,G206');
            break;
          case'meta':
            var o = e.getAttribute('content');
            'viewport' === e.getAttribute('name') && o && (-1 < o.indexOf('maximum-scale') || -1 < o.indexOf('minimum-scale') || -1 < o.indexOf('user-scalable=no') || -1 < o.indexOf('user-scalable=0')) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_10_C32,C31,C33,C38,SCR34,G206.Zoom'), 'C32,C31,C33,C38,SCR34,G206');
        }
      }
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_11_G195,G207,G18,G145,G174,F78.Check'), 'G195,G207,G18,G145,G174,F78');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_12 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_12_C36,C35.Check'), 'C36,C35');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_13 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_13_F95.Check'), 'F95');
    },
    ...
    testContrastRatio: function(e, t, n) {
      var i = [];
      if (e.ownerDocument) a = [e]; else {
        var a = [], o = e.getElementsByTagName('body');
        if (o.length) var a = [o[0]];
      }
      for (; 0 < a.length;) {
        var r = a.shift();
        if (r && 1 === r.nodeType && !1 === HTMLCS.util.isVisuallyHidden(r) && !1 === HTMLCS.util.isDisabled(r)) {
          for (var s = !1, l = 0; l < r.childNodes.length; l++) 1 === r.childNodes[l].nodeType ? a.push(r.childNodes[l]) : 3 === r.childNodes[l].nodeType && '' !== HTMLCS.util.trim(r.childNodes[l].nodeValue) && (s = !0);
          if (!0 === s) {
            var d = HTMLCS.util.style(r);
            if (d) {
              var u = d.backgroundColor, _ = d.color, c = !1, m = !1;
              'none' !== d.backgroundImage && (c = !0), 'absolute' == d.position && (m = !0);
              var g = r.parentNode, p = .75 * parseFloat(d.fontSize, 10), h = 18;
              if ('bold' === d.fontWeight || 600 <= parseInt(d.fontWeight, 10)) h = 14;
              var b = t;
              for (h <= p && (b = n); ("transparent" === u || "rgba(0, 0, 0, 0)" === u) && g && g.ownerDocument;) {
                var f = HTMLCS.util.style(g);
                u = f.backgroundColor;
                'none' !== f.backgroundImage && (c = !0), 'absolute' == f.position && (m = !0);
                var C = HTMLCS.util.style(g, ':before');
                if (C && 'fixed' == C.position && 'transform' == C.willChange && C.width == f.width && parseInt(C.height, 10) <= parseInt(f.height, 10) && 'none' !== C.backgroundImage) {
                  c = !0;
                  break;
                }
                g = g.parentNode;
              }
              var v = HTMLCS.util.colourStrToRGB(u).alpha, H = HTMLCS.util.colourStrToRGB(_).alpha;
              if (u && v < 1 && 0 < v) {
                i.push({ element: r, colour: _, bgColour: u, value: void 0, required: b, hasAlpha: !0 });
                continue;
              }
              if (_ && H < 1 && 0 < H) {
                i.push({ element: r, colour: _, bgColour: _, value: void 0, required: b, hasAlpha: !0 });
                continue;
              }
              if (!0 === c) {
                i.push({ element: r, colour: _, bgColour: void 0, value: void 0, required: b, hasBgImage: !0 });
                continue;
              }
              if (!0 === m) {
                i.push({ element: r, colour: _, bgColour: void 0, value: void 0, required: b, isAbsolute: !0 });
                continue;
              }
              ...
              if (T < b) {
                ...
                i.push({ element: r, colour: d.color, bgColour: u, value: T, required: b, recommendation: y });
              }
            }
          }
        }
      ...
      t = HTMLCS.util.RGBtoColourStr(HTMLCS.util.colourStrToRGB(t)), e = HTMLCS.util.RGBtoColourStr(HTMLCS.util.colourStrToRGB(e));
      var i = HTMLCS.util.contrastRatio(t, e), a = Math.abs(HTMLCS.util.relativeLum(t) - .5),
        o = Math.abs(HTMLCS.util.relativeLum(e) - .5), r = null;
      if (i < n) {
        var s = 1.0025;
        if (a <= o) {
          var l = 'back', d = e;
          if (HTMLCS.util.relativeLum(e) < .5) s = 1 / s;
        } else {
          l = 'fore', d = t;
          if (HTMLCS.util.relativeLum(t) < .5) s = 1 / s;
        }
        for (var u = HTMLCS.util.sRGBtoHSV(d), _ = t, c = e, m = !1, g = 0; i < n;) {
          if ('#fff' === d || '#000' === d) if (!0 === m) if ('fore' === l) for (var p = c, h = 1; c === p;) {
      ...
      var n = HTMLCS.util.sRGBtoHSV(e), i = n.saturation * n.value;
      return 0 === n.value && (n.value = 1 / 255), n.value = n.value * t, 0 === n.value ? n.saturation = 0 : n.saturation = i / n.value, n.value = Math.min(1, n.value), n.saturation = Math.min(1, n.saturation), HTMLCS.util.RGBtoColourStr(HTMLCS.util.HSVtosRGB(n));
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3_F24 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      for (var n = HTMLCS.util.getAllElements(t, '*'), i = 0; i < n.length; i++) this.testColourComboFail(n[i]);
    }, testColourComboFail: function(e) {
      var t = e.hasAttribute('color');
      t = (t = (t = t || e.hasAttribute('link')) || e.hasAttribute('vlink')) || e.hasAttribute('alink');
      var n = e.hasAttribute('bgcolor');
      if (e.style) {
        var i = e.style.color, a = e.style.background;
        '' !== i && 'auto' !== i && (t = !0), '' !== a && 'auto' !== a && (n = !0);
      }
      n !== t && (!0 === n ? HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_3_F24.BGColour'), 'F24.BGColour') : HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_3_F24.FGColour'), 'F24.FGColour'));
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      if (e === t) for (var n = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3_Contrast.testContrastRatio(t, 4.5, 3), i = 0; i < n.length; i++) {
        e = n[i].element;
        for (var a = 2, o = Math.round(n[i].value * Math.pow(10, a)) / Math.pow(10, a), r = n[i].required, s = n[i].recommendation, l = n[i].hasBgImage || !1, d = n[i].isAbsolute || !1, u = n[i].hasAlpha || !1; r === o;) a++, o = Math.round(n[i].value * Math.pow(10, a)) / Math.pow(10, a);
        if (4.5 === r) var _ = 'G18'; else if (3 === r) _ = 'G145';
        var c = [];
        s && (s.fore.from !== s.fore.to && c.push(_global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Fail.Recomendation.Text').replace(/\{\{value\}\}/g, s.fore.to)), s.back.from !== s.back.to && c.push(_global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Fail.Recomendation.Background').replace(/\{\{value\}\}/g, s.back.to))), 0 < c.length && (c = ' ' + _global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Fail.Recomendation') + ' ' + c.join(', ') + '.'), !0 === d ? (_ += '.Abs', HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Abs').replace(/\{\{required\}\}/g, r), _)) : !0 === l ? (_ += '.BgImage', HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_3_G18_or_G145.BgImage').replace(/\{\{required\}\}/g, r), _)) : !0 === u ? (_ += '.Alpha', HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Alpha').replace(/\{\{required\}\}/g, r), _)) : (_ += '.Fail', HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_4_3_G18_or_G145.Fail').replace(/\{\{required\}\}/g, r).replace(/\{\{value\}\}/g, o) + c, _));
      }
    },
    ...
    register: function() {
      ...
      null !== t.querySelector('img') && HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_5_G140,C22,C30.AALevel'), 'G140,C22,C30.AALevel');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_6 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      if (e === t) for (var n = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3_Contrast.testContrastRatio(t, 7, 4.5), i = 0; i < n.length; i++) {
        e = n[i].element;
        for (var a = 2, o = Math.round(n[i].value * Math.pow(10, a)) / Math.pow(10, a), r = n[i].required, s = n[i].recommendation, l = n[i].hasBgImage || !1, d = n[i].isAbsolute || !1; r === o;) a++, o = Math.round(n[i].value * Math.pow(10, a)) / Math.pow(10, a);
        if (4.5 === r) var u = 'G18'; else if (7 === r) u = 'G17';
        var _ = [];
        s && (s.fore.from !== s.fore.to && _.push(_global.HTMLCS.getTranslation('1_4_6_G18_or_G17.Fail.Recomendation.Text').replace(/\{\{value\}\}/g, s.fore.to)), s.back.from !== s.back.to && _.push(_global.HTMLCS.getTranslation('1_4_6_G18_or_G17.Fail.Recomendation.Background').replace(/\{\{value\}\}/g, s.back.to))), 0 < _.length && (_ = ' ' + _global.HTMLCS.getTranslation('1_4_6_G18_or_G17.Fail.Recomendation') + ' ' + _.join(', ') + '.'), !0 === d ? (u += '.Abs', HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_6_G18_or_G17.Abs').replace(/\{\{required\}\}/g, r), u)) : !0 === l ? (u += '.BgImage', HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('1_4_6_G18_or_G17.BgImage').replace(/\{\{required\}\}/g, r), u)) : (u += '.Fail', HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('1_4_6_G18_or_G17.Fail').replace(/\{\{required\}\}/g, r).replace(/\{\{value\}\}/g, o) + _, u));
      }
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_8_G148,G156,G175'), 'G148,G156,G175'), HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_8_H87,C20'), 'H87,C20'), HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_8_C19,G172,G169'), 'C19,G172,G169'), HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_8_G188,C21'), 'G188,C21'), HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_8_H87,G146,C26'), 'H87,G146,C26');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_9 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      null !== t.querySelector('img') && HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('1_4_9_G140,C22,C30.NoException'), 'G140,C22,C30.NoException');
    },
    ...
    register: function() {
      ...
      if (e === t) {
        HTMLCS.util.getAllElements(t, '*[onclick], *[onkeyup], *[onkeydown], *[onkeypress], *[onfocus], *[onblur]').forEach(function(e) {
          !1 === HTMLCS.util.isKeyboardNavigable(e) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('2_1_1_G90'), 'G90');
        });
        for (var n = HTMLCS.util.getAllElements(t, '*[ondblclick]'), i = 0; i < n.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, n[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.DblClick'), 'SCR20.DblClick');
        var a = HTMLCS.util.getAllElements(t, '*[onmouseover]');
        for (i = 0; i < a.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, a[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.MouseOver'), 'SCR20.MouseOver');
        var o = HTMLCS.util.getAllElements(t, '*[onmouseout]');
        for (i = 0; i < o.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, o[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.MouseOut'), 'SCR20.MouseOut');
        var r = HTMLCS.util.getAllElements(t, '*[onmousemove]');
        for (i = 0; i < r.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, r[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.MouseMove'), 'SCR20.MouseMove');
        var s = HTMLCS.util.getAllElements(t, '*[onmousedown]');
        for (i = 0; i < s.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, s[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.MouseDown'), 'SCR20.MouseDown');
        var l = HTMLCS.util.getAllElements(t, '*[onmouseup]');
        for (i = 0; i < l.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, l[i], _global.HTMLCS.getTranslation('2_1_1_SCR20.MouseUp'), 'SCR20.MouseUp');
      }
    },
    ...
    register: function() {
      ...
      !0 === e.hasAttribute('http-equiv') && 'refresh' === String(e.getAttribute('http-equiv')).toLowerCase() && !0 === /^[1-9]\d*/.test(e.getAttribute('content').toLowerCase()) && (!0 === /url=/.test(e.getAttribute('content').toLowerCase()) ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_2_1_F40.2'), 'F40.2') : HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_2_1_F41.2'), 'F41.2'));
    },
    ...
    register: function() {
      ...
      if (e === t) {
        HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_2_2_SCR33,SCR22,G187,G152,G186,G191'), 'SCR33,SCR22,G187,G152,G186,G191');
        for (var n = HTMLCS.util.getAllElements(t, '*'), i = 0; i < n.length; i++) {
          var a = HTMLCS.util.style(n[i]);
          a && !0 === /blink/.test(a['text-decoration']) && HTMLCS.addMessage(HTMLCS.WARNING, n[i], _global.HTMLCS.getTranslation('2_2_2_F4'), 'F4');
        }
      } else 'blink' === e.nodeName.toLowerCase() && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_2_2_F47'), 'F47');
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_2_5_G105,G181'), 'G105,G181');
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('2_3_1_G19,G176'), 'G19,G176');
    },
    ...
    register: function() {
      ...
      if (e === t) this.testGenericBypassMsg(t); else switch (e.nodeName.toLowerCase()) {
        case'iframe':
      ...
      if ('iframe' === e.nodeName.toLowerCase()) {
        var t = !1;
        !0 === e.hasAttribute('title') && e.getAttribute('title') && !1 === /^\s+$/.test(e.getAttribute('title')) && (t = !0), !1 === t ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_1_H64.1'), 'H64.1') : HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_1_H64.2'), 'H64.2');
      }
    }, testGenericBypassMsg: function(e) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_1_G1,G123,G124,H69'), 'G1,G123,G124,H69');
      ...
      if (!0 === e.hasAttribute('href') && !0 === HTMLCS.util.isFocusable(e)) {
        ...
        if (1 < (n = HTMLCS.util.trim(n)).length && '#' === n.charAt(0)) {
          ...
          try {
            ...
            var o = a.getElementById(i);
            if (null === o) {
              var r = HTMLCS.util.getElementWindow(t).document, s = HTMLCS.util.getDocumentType(r), l = 'a';
              s && -1 === s.indexOf('html5') && (l = '*'), o = a.querySelector(l + '[name="' + i + '"]');
            }
            null !== o && !1 !== HTMLCS.util.contains(t, o) || (!0 === HTMLCS.isFullDoc(t) || 'body' === t.nodeName.toLowerCase() ? HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_1_G1,G123,G124.NoSuchID').replace(/\{\{id\}\}/g, i), 'G1,G123,G124.NoSuchID') : HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('2_4_1_G1,G123,G124.NoSuchIDFragment').replace(/\{\{id\}\}/g, i), 'G1,G123,G124.NoSuchIDFragment'));
          } catch (e) {
          }
        }
      }
    ...
    register: function() {
      ...
      for (var n = e.childNodes, i = null, a = 0; a < n.length; a++) if ('head' === n[a].nodeName.toLowerCase()) {
        i = n[a];
        break;
      }
      if (null === i) HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_2_H25.1.NoHeadEl'), 'H25.1.NoHeadEl'); else {
        n = i.childNodes;
        var o = null;
        for (a = 0; a < n.length; a++) if ('title' === n[a].nodeName.toLowerCase()) {
          o = n[a];
          break;
        }
        null === o ? HTMLCS.addMessage(HTMLCS.ERROR, i, _global.HTMLCS.getTranslation('2_4_2_H25.1.NoTitleEl'), 'H25.1.NoTitleEl') : !0 === /^\s*$/.test(o.innerHTML) ? HTMLCS.addMessage(HTMLCS.ERROR, o, _global.HTMLCS.getTranslation('2_4_2_H25.1.EmptyTitle'), 'H25.1.EmptyTitle') : HTMLCS.addMessage(HTMLCS.NOTICE, o, _global.HTMLCS.getTranslation('2_4_2_H25.2'), 'H25.2');
      }
    },
    ...
    register: function() {
      ...
      e === t && (t.querySelector('*[tabindex]') && HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_3_H4.2'), 'H4.2'));
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_4 = {
    register: function() {
      return ['a'];
    }, process: function(e, t) {
      !0 === e.hasAttribute('title') ? HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_4_H77,H78,H79,H80,H81,H33'), 'H77,H78,H79,H80,H81,H33') : HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_4_H77,H78,H79,H80,H81'), 'H77,H78,H79,H80,H81');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_5 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_5_G125,G64,G63,G161,G126,G185'), 'G125,G64,G63,G161,G126,G185');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_6 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('2_4_6_G130,G131'), 'G130,G131');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_7 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      null !== t.querySelector('input, textarea, button, select, a') && HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('2_4_7_G149,G165,G195,C15,SCR31'), 'G149,G165,G195,C15,SCR31');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle2_Guideline2_4_2_4_8 = {
    register: function() {
      return ['link'];
    }, process: function(e, t) {
      'head' !== e.parentNode.nodeName.toLowerCase() && HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_8_H59.1'), 'H59.1'), !1 !== e.hasAttribute('rel') && e.getAttribute('rel') && !0 !== /^\s*$/.test(e.getAttribute('rel')) || HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_8_H59.2a'), 'H59.2a'), !1 !== e.hasAttribute('href') && e.getAttribute('href') && !0 !== /^\s*$/.test(e.getAttribute('href')) || HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('2_4_8_H59.2b'), 'H59.2b');
    },
    ...
    register: function() {
      ...
      if (HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('2_5_2.SinglePointer_Check'), ''), e == t) {
        for (var n = HTMLCS.util.getAllElements(t, '*[onmousedown]'), i = 0; i < n.length; i++) {
          var a = n[i];
          HTMLCS.addMessage(HTMLCS.NOTICE, a, _global.HTMLCS.getTranslation('2_5_2.Mousedown_Check'), '');
        }
        var o = HTMLCS.util.getAllElements(t, '*[ontouchstart]');
        for (i = 0; i < o.length; i++) {
          a = o[i];
          HTMLCS.addMessage(HTMLCS.NOTICE, a, _global.HTMLCS.getTranslation('2_5_2.Touchstart_Check'), '');
        }
      }
    },
    ...
    register: function() {
      ...
      if (e == t) HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('2_5_3_F96.Check'), 'F96'); else {
        var n = '', i = '';
        switch (e.nodeName.toLowerCase()) {
          case'a':
          case'button':
          ...
          case'label':
            ...
            if (a) {
              if (t.ownerDocument) var o = t.ownerDocument.getElementById(a); else o = t.getElementById(a);
              o && (i = HTMLCS.util.getAccessibleName(o, t));
            }
            break;
          case'input':
            'submit' === e.getAttribute('type') && (n = e.getAttribute('value')), i = HTMLCS.util.getAccessibleName(e, t);
        }
        if (n && i) {
          var r = n.replace(/[^A-Za-z]/g, '').toLowerCase(), s = i.replace(/[^A-Za-z]/g, '').toLowerCase();
          r && s && -1 === s.indexOf(r) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('2_5_3_F96.AccessibleName'), 'F96');
        }
      }
    },
    ...
    register: function() {
      ...
      if (HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('2_5_4.Check'), ''), e == t) for (var n = HTMLCS.util.getAllElements(e, '*[ondevicemotion]'), i = 0; i < n.length; i++) {
        var a = n[i];
        HTMLCS.addMessage(HTMLCS.WARNING, a, _global.HTMLCS.getTranslation('2_5_4.Devicemotion'), '');
      }
    },
    ...
    register: function() {
      ...
      if (!1 === e.hasAttribute('lang') && !1 === e.hasAttribute('xml:lang')) HTMLCS.addMessage(HTMLCS.ERROR, e, _global.HTMLCS.getTranslation('3_1_1_H57.2'), 'H57.2'); else {
        if (!0 === e.hasAttribute('lang')) {
          var n = e.getAttribute('lang');
          !1 === this.isValidLanguageTag(n) && HTMLCS.addMessage(HTMLCS.ERROR, t, _global.HTMLCS.getTranslation('3_1_1_H57.3.Lang'), 'H57.3.Lang');
        }
        if (!0 === e.hasAttribute('xml:lang')) {
          n = e.getAttribute('xml:lang');
          !1 === this.isValidLanguageTag(n) && HTMLCS.addMessage(HTMLCS.ERROR, t, _global.HTMLCS.getTranslation('3_1_1_H57.3.XmlLang'), 'H57.3.XmlLang');
        }
      }
    }, isValidLanguageTag: function(e) {
      var t = !0;
      return !1 === new RegExp('^([ix](-[a-z0-9]{1,8})+)$|^[a-z]{2,8}(-[a-z]{3}){0,3}(-[a-z]{4})?(-[a-z]{2}|-[0-9]{3})?(-[0-9][a-z0-9]{3}|-[a-z0-9]{5,8})*(-[a-wy-z0-9](-[a-z0-9]{2,8})+)*(-x(-[a-z0-9]{1,8})+)?$', 'i').test(e) && (t = !1), t;
    },
    ...
    register: function() {
      ...
      for (var n = HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_1, i = HTMLCS.util.getAllElements(t, '*[lang]'), a = 0; a <= i.length; a++) {
        if (a === i.length) var o = t; else o = i[a];
        if (!o.documentElement && 'html' !== o.nodeName.toLowerCase()) {
          if (!0 === o.hasAttribute('lang')) {
            var r = o.getAttribute('lang');
            !1 === n.isValidLanguageTag(r) && HTMLCS.addMessage(HTMLCS.ERROR, o, _global.HTMLCS.getTranslation('3_1_2_H58.1.Lang'), 'H58.1.Lang');
          }
          if (!0 === o.hasAttribute('xml:lang')) {
            r = o.getAttribute('xml:lang');
            !1 === n.isValidLanguageTag(r) && HTMLCS.addMessage(HTMLCS.ERROR, o, _global.HTMLCS.getTranslation('3_1_2_H58.1.XmlLang'), 'H58.1.XmlLang');
          }
        }
      }
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('3_1_3_H40,H54,H60,G62,G70'), 'H40,H54,H60,G62,G70');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_4 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('3_1_4_G102,G55,G62,H28,G97'), 'G102,G55,G62,H28,G97');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_5 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('3_1_5_G86,G103,G79,G153,G160'), 'G86,G103,G79,G153,G160');
    },
    ...
    register: function() {
      ...
      var n = !1;
      if (0 < t.querySelectorAll('input[type=submit], input[type=image]').length) n = !0; else {
        var e = t.querySelectorAll('button'), i = t.querySelectorAll('button[type=reset], button[type=button]');
        e.length > i.length && (n = !0);
      }
      if (!1 === n && t.id) {
        var a = document.querySelectorAll('button[form], input[form][type=submit], input[form][type=image]');
      ...
      !1 === n && HTMLCS.addMessage(HTMLCS.ERROR, t, _global.HTMLCS.getTranslation('3_2_2_H32.2'), 'H32.2');
    },
    ...
    register: function() {
      ...
      !0 === e.hasAttribute('target') && ('_blank' === (e.getAttribute('target') || '') && !1 === /new window/i.test(e.innerHTML) && HTMLCS.addMessage(HTMLCS.WARNING, e, _global.HTMLCS.getTranslation('3_2_5_H83.3'), 'H83.3'));
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_3_3_3_1 = {
    register: function() {
      return ['form'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('3_3_1_G83,G84,G85'), 'G83,G84,G85');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_3_3_3_2 = {
    register: function() {
      return ['form'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('3_3_2_G131,G89,G184,H90'), 'G131,G89,G184,H90');
    },
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('3_3_4_G98,G99,G155,G164,G168.LegalForms'), 'G98,G99,G155,G164,G168.LegalForms');
    },
  }, _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_3_3_3_5 = {
    register: function() {
      return ['form'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('3_3_5_G71,G184,G193'), 'G71,G184,G193');
    },
  },_global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_3_3_3_6 = {
    register: function() {
      return ['form'];
    }, process: function(e, t) {
      HTMLCS.addMessage(HTMLCS.NOTICE, e, _global.HTMLCS.getTranslation('3_3_6_G98,G99,G155,G164,G168.AllForms'), 'G98,G99,G155,G164,G168.AllForms');
    },
  },_global.HTMLCS_WCAG2AAA_Sniffs_Principle4_Guideline4_1_4_1_1 = {
    register: function() {
      return ['_top'];
    }, process: function(e, t) {
      if (e === t) for (var n = HTMLCS.util.getAllElements(t, '*[id]'), i = {}, a = 0; a < n.length; a++) {
        var o = n[a].getAttribute('id');
        !0 !== /^\s*$/.test(o) && (void 0 !== i[o] ? HTMLCS.addMessage(HTMLCS.ERROR, n[a], _global.HTMLCS.getTranslation('4_1_1_F77').replace(/\{\{id\}\}/g, o), 'F77') : i[o] = !0);
      }
    },
    ...
    register: function() {
      ...
      if (e === t) {
        for (var n = this.processFormControls(t), i = 0; i < n.errors.length; i++) HTMLCS.addMessage(HTMLCS.ERROR, n.errors[i].element, n.errors[i].msg, 'H91.' + n.errors[i].subcode);
        for (i = 0; i < n.warnings.length; i++) HTMLCS.addMessage(HTMLCS.WARNING, n.warnings[i].element, n.warnings[i].msg, 'H91.' + n.warnings[i].subcode);
        this.addProcessLinksMessages(t);
      }
    }, addProcessLinksMessages: function(e) {
      for (var t = this.processLinks(e), n = 0; n < t.empty.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.empty[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.Empty'), 'H91.A.Empty');
      for (n = 0; n < t.emptyWithName.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.emptyWithName[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.EmptyWithName'), 'H91.A.EmptyWithName');
      for (n = 0; n < t.emptyNoId.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.emptyNoId[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.EmptyNoId'), 'H91.A.EmptyNoId');
      for (n = 0; n < t.noHref.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.noHref[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.NoHref'), 'H91.A.NoHref');
      for (n = 0; n < t.placeholder.length; n++) HTMLCS.addMessage(HTMLCS.WARNING, t.placeholder[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.Placeholder'), 'H91.A.Placeholder');
      for (n = 0; n < t.noContent.length; n++) HTMLCS.addMessage(HTMLCS.ERROR, t.noContent[n], _global.HTMLCS.getTranslation('4_1_2_H91.A.NoContent'), 'H91.A.NoContent');
    }, processLinks: function(e) {
      for (var t = {
        empty: [],
        emptyWithName: [],
        ...
        placeholder: [],
        noContent: [],
      }, n = HTMLCS.util.getAllElements(e, 'a:not([role="button"])'), i = 0; i < n.length; i++) {
        var a = n[i], o = !1, r = !1, s = HTMLCS.util.getElementTextContent(a);
        !0 === a.hasAttribute('title') && !1 === /^\s*$/.test(a.getAttribute('title')) ? o = !0 : !1 === /^\s*$/.test(s) && (o = !0), !0 === a.hasAttribute('href') && !1 === /^\s*$/.test(a.getAttribute('href')) && (r = !0), !1 === r ? !0 === /^\s*$/.test(s) ? !0 === a.hasAttribute('id') ? t.empty.push(a) : !0 === a.hasAttribute('name') ? t.emptyWithName.push(a) : t.emptyNoId.push(a) : !0 === a.hasAttribute('id') || !0 === a.hasAttribute('name') ? t.noHref.push(a) : t.placeholder.push(a) : !1 === o && 0 === a.querySelectorAll('img').length && !1 === HTMLCS.util.hasValidAriaLabel(a) && t.noContent.push(a);
      }
      return t;
    }, processFormControls: function(e) {
      for (var t = HTMLCS.util.getAllElements(e, 'button, fieldset, input, select, textarea, [role="button"]'), n = [], i = [], a = {
      ...
      }, o = ['email', 'search', 'date', 'datetime-local', 'month', 'number', 'tel', 'time', 'url', 'week', 'range', 'color'], r = 0, s = o.length; r < s; r++) a['input_' + o[r]] = ['label', '@title', '@aria-label', '@aria-labelledby'];
      for (var l = { select: 'option_selected' }, d = 0, u = t.length; d < u; d++) {
        var _ = t[d], c = _.nodeName.toLowerCase(),
          m = _.nodeName.substr(0, 1).toUpperCase() + _.nodeName.substr(1).toLowerCase();
        if ('input' === c) {
          !1 === _.hasAttribute('type') ? c += '_text' : c += '_' + _.getAttribute('type').toLowerCase(), 'input_submit' !== c && 'input_reset' !== c || (c = 'input_button');
          m = 'Input' + c.substr(6, 1).toUpperCase() + c.substr(7).toLowerCase();
        }
        var g = a[c], p = l[c];
        if (g || 'input_hidden' === c || (g = ['_content', '@aria-label', '@aria-labelledby']), g) {
          for (r = 0; r < g.length; r++) {
            ...
            if ('_content' === h) {
              ...
              if (!1 !== HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_3_1_3_1.testLabelsOnInputs(_, e, !0)) break;
            } else if ('@' === h.charAt(0)) {
              if (('aria-label' === (h = h.substr(1, h.length)) || 'aria-labelledby' === h) && HTMLCS.util.hasValidAriaLabel(_)) break;
          ...
          if (r === g.length) {
            ...
            'input_' === c.substr(0, 6) && (C = c.substr(6) + _global.HTMLCS.getTranslation('4_1_2_input_element'));
            for (var v = g.slice(0, g.length), H = 0; H < v.length; H++) '_content' === v[H] ? v[H] = _global.HTMLCS.getTranslation('4_1_2_element_content') : '@' === v[H].charAt(0) ? v[H] = v[H].substr(1) + ' ' + _global.HTMLCS.getTranslation('4_1_2_attribute') : v[H] = v[H] + ' ' + _global.HTMLCS.getTranslation('4_1_2_element');
            var T = _global.HTMLCS.getTranslation('4_1_2_msg_pattern').replace(/\{\{msgNodeType\}\}/g, C).replace(/\{\{builtAttrs\}\}/g, v.join(', '));
            _.hasAttribute('role') && 'button' === _.getAttribute('role') && (T = _global.HTMLCS.getTranslation('4_1_2_msg_pattern_role_of_button').replace(/\{\{builtAttrs\}\}/g, v.join(', '))), n.push({
              element: _,
              msg: T,
              subcode: m + '.Name',
            });
        ...
        var y = !1;
        if (void 0 === p) y = !0; else if ('_content' === p) {
          b = HTMLCS.util.getElementTextContent(_);
          !1 === /^\s*$/.test(b) && (y = !0);
        } else if ('option_selected' === p) {
          if (!1 === _.hasAttribute('multiple')) null !== _.querySelector('option[selected]') && (y = !0); else y = !0;
        } else '@' === p.charAt(0) && (p = p.substr(1, p.length), !0 === _.hasAttribute(p) && (y = !0));
        if (!1 === y && (valuFound = HTMLCS.util.hasValidAriaLabel(_)), !1 === y) {
          C = c + ' ' + _global.HTMLCS.getTranslation('4_1_2_element');
          'input_' === c.substr(0, 6) && (C = c.substr(6) + _global.HTMLCS.getTranslation('4_1_2_input_element'));
          T = _global.HTMLCS.getTranslation('4_1_2_msg_pattern2').replace(/\{\{msgNodeType\}\}/g, C);
          var k = '', w = !1;
          '_content' === p ? k = ' ' + _global.HTMLCS.getTranslation('4_1_2_msg_add_one') : 'option_selected' === p ? (w = !0, T = _global.HTMLCS.getTranslation('4_1_2_msg_pattern2').replace(/\{\{msgNodeType\}\}/g, C)) : k = '@' === p.charAt(0) ? ' ' + _global.HTMLCS.getTranslation('4_1_2_value_exposed_using_attribute').replace(/\{\{requiredValue\}\}/g, p) : ' ' + _global.HTMLCS.getTranslation('4_1_2_value_exposed_using_element').replace(/\{\{requiredValue\}\}/g, p), T += k, !1 === w ? n.push({
            element: _,
            msg: T,
            subcode: m + '.Value',
    ...
    register: function() {
      ...
      HTMLCS.addMessage(HTMLCS.NOTICE, t, _global.HTMLCS.getTranslation('4_1_3_ARIA22,G199,ARIA19,G83,G84,G85,G139,G177,G194,ARIA23.Check'), '');
    },
  },_global.HTMLCS = new function() {
    var _ = {}, r = [], l = {}, s = null, d = null, u = [], o = {};
    this.ERROR = 1, this.WARNING = 2, this.NOTICE = 3, this.lang = 'en', this.process = function(e, t, n, i, a) {
      if (_ = {}, r = [], l = {}, s = null, !t) return !1;
      var o = Object.keys(_global.translation);
      a && -1 !== o.indexOf(a) && (this.lang = a), _[v(e)] ? HTMLCS.run(n, t) : this.loadStandard(e, function() {
        HTMLCS.run(n, t);
      }, i);
      ...
      try {
        ...
        throw new Error('Translation for "' + t + '" does not exist in current language ' + this.lang);
      }
      ...
      if ('string' == typeof i) {
        ...
        t.style.display = 'none', (t = document.body.insertBefore(t, null)).contentDocument ? a = t.contentDocument : a.contentWindow && (a = t.contentWindow.document), t.load = function() {
          if (this.onreadystatechange = null, this.onload = null, !1 === HTMLCS.isFullDoc(i)) {
        ...
        }, t.onload = t.load, !1 === HTMLCS.isFullDoc(i) && -1 === i.indexOf('<body') ? a.write('<div id="__HTMLCS-source-wrap">' + i + '</div>') : a.write(i), a.close();
      } else a = i;
      if (a) {
        n = n || function() {
        }, u = [];
      ...
      var t = !1;
      return 'string' == typeof e ? -1 !== e.toLowerCase().indexOf('<html') ? t = !0 : -1 !== e.toLowerCase().indexOf('<head') && -1 !== e.toLowerCase().indexOf('<body') && (t = !0) : ('html' === e.nodeName.toLowerCase() || e.documentElement) && (t = !0), t;
    ...
    var c = function(e, t, n) {
      for (var i = []; 0 < e.length;) {
        var a = e.shift();
        if (a === t) var o = '_top'; else o = a.tagName.toLowerCase();
        for (var r = 0; r < i.length;) a === i[r].element ? (u.push(i[r]), i.splice(r, 1)) : r++;
        l[o] && 0 < l[o].length && (m(a, l[o].concat([]), t), '_top' === o && (i = u, u = []));
      }
      u = u.concat(i);
      var s = t.querySelectorAll('[role="presentation"]');
      d = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_3_1_3_1, [].forEach.call(s, function(e) {
        d.testSemanticPresentationRole(e);
      }), n instanceof Function == !0 && n.call(this);
    }, m = function(e, t, n, i) {
      for (; 0 < t.length;) {
        var a = t.shift();
        !0 === (d = a).useCallback ? a.process(e, n, function() {
          m(e, t, n), t = [];
        }) : a.process(e, n);
      }
      ...
      var a = e.split('/');
      _global['HTMLCS_' + a[a.length - 2]] ? p(e, t, n, i) : y(e, function() {
        p(e, t, n, i);
      }, n);
    }, p = function(e, t, n, i) {
      var a = e.split('/'), o = _global['HTMLCS_' + a[a.length - 2]], r = {};
      for (var s in o) !0 === o.hasOwnProperty(s) && (r[s] = o[s]);
      if (!r) return !1;
      if (_[e] = r, i) if (i.include && 0 < i.include.length) r.sniffs = i.include; else if (i.exclude) for (var l = 0; l < i.exclude.length; l++) {
      ...
      if ('string' == typeof t) {
        ...
        H(e, t) ? a() : y(C(e, t), a, i);
      } else g(t.standard, function() {
        if (t.messages) for (var e in t.messages) o[e] = t.messages[e];
        n.call(this);
      }, i, { exclude: t.exclude, include: t.include });
    }, f = function(e, t) {
      var n = H(e, t);
      if (!n) return !1;
      if (n.register) for (var i = n.register(), a = 0; a < i.length; a++) l[i[a]] || (l[i[a]] = []), l[i[a]].push(n);
      r.push(n);
    }, C = function(e, t) {
      var n = e.split('/');
      return n.pop(), n.join('/') + '/Sniffs/' + t.replace(/\./g, '/') + '.js';
    }, v = function(e) {
      for (var t = document.getElementsByTagName('script'), n = null, i = 0; i < t.length; i++) if (t[i].src && t[i].src.match(/HTMLCS\.js/)) {
      ...
      var n = 'HTMLCS_';
      return n += _[e].name + '_Sniffs_', n += t.split('.').join('_'), _global[n] ? (_global[n]._name = t, _global[n]) : null;
    }, T = function(e) {
      ...
      i.onload = function() {
        ...
        !0 === /^(complete|loaded)$/.test(this.readyState) && (i.onreadystatechange = null, i.onload());
      }, i.src = e, document.head ? document.head.appendChild(i) : document.getElementsByTagName('head')[0].appendChild(i);
    };
    ...
    var v = {
      trim: function(e) {
        ...
        var t = !0;
        return -1 !== e.indexOf(String.fromCharCode(160)) ? t = !1 : !1 === /^\s*$/.test(e) && (t = !1), t;
      }, getDocumentType: function(e) {
        var t = null, n = e.doctype;
        if (n) {
          var i = n.name, a = n.publicId, o = n.systemId;
          if (null === i && (i = ''), null === o && (o = ''), null === a && (a = ''), 'html' === i.toLowerCase()) if ('' === a && '' === o ? t = 'html5' : -1 !== a.indexOf('//DTD HTML 4.01') || -1 !== o.indexOf('w3.org/TR/html4/strict.dtd') ? t = 'html401' : -1 !== a.indexOf('//DTD HTML 4.0') || -1 !== o.indexOf('w3.org/TR/REC-html40/strict.dtd') ? t = 'html40' : -1 !== a.indexOf('//DTD XHTML 1.0 Strict') && -1 !== o.indexOf('w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd') ? t = 'xhtml10' : -1 !== a.indexOf('//DTD XHTML 1.1') && -1 !== o.indexOf('w3.org/TR/xhtml11/DTD/xhtml11.dtd') && (t = 'xhtml11'), -1 !== o.indexOf('about:legacy-compat')) if ('application/xhtml+xml' === e.contentType) 'http://www.w3.org/1999/xhtml' === e.querySelector('html').getAttribute('xmlns') && (t = 'xhtml5');
        } else {
          if ('application/xhtml+xml' === e.contentType) 'http://www.w3.org/1999/xhtml' === e.querySelector('html').getAttribute('xmlns') && (t = 'xhtml5');
        }
        return t;
      }, getElementWindow: function(e) {
        if (e.ownerDocument) var t = e.ownerDocument; else t = e;
        return t.defaultView ? t.defaultView : t.parentWindow;
      }, hasValidAriaLabel: function(e) {
        var i = !1;
        if (!0 === e.hasAttribute('aria-labelledby')) e.getAttribute('aria-labelledby').split(/\s+/).forEach(function(e) {
        ...
        var n = null, i = v.getElementWindow(e);
        t = t || null;
        return e.currentStyle ? n = e.currentStyle : i.getComputedStyle && (n = i.getComputedStyle(e, t)), n;
      }, isVisuallyHidden: function(e) {
        var t = !1;
        if ('title' === e.nodeName.toLowerCase() && null !== v.findParentNode(e, 'svg')) return !0;
        var n = v.style(e);
        return null !== n && ('hidden' !== n.visibility && 'none' !== n.display || (t = !0), parseInt(n.left, 10) + parseInt(n.width, 10) < 0 && (t = !0), parseInt(n.top, 10) + parseInt(n.height, 10) < 0 && (t = !0)), t;
        ...
        var t = e.nodeName.toLowerCase();
        return !0 !== v.isDisabled(e) && (!0 !== v.isVisuallyHidden(e) && (!!/^(input|select|textarea|button|object)$/.test(t) || !('a' !== t || !e.hasAttribute('href') || !1 !== /^\s*$/.test(e.getAttribute('href')))));
      }, isKeyboardTabbable: function(e) {
        return !0 !== e.hasAttribute('tabindex') ? v.isFocusable(e) : '-1' !== e.getAttribute('tabindex');
      }, isKeyboardNavigable: function(e) {
        return !(!e.hasAttribute('accesskey') || !1 !== /^\s*$/.test(e.getAttribute('accesskey'))) || v.isKeyboardTabbable(e);
        ...
        var n = !1;
        return e !== t && (e.ownerDocument ? e.contains && !0 === e.contains(t) ? n = !0 : e.compareDocumentPosition && 0 < (16 & e.compareDocumentPosition(t)) && (n = !0) : t.ownerDocument && t.ownerDocument === e && (n = !0)), n;
      }, isLayoutTable: function(e) {
        return null === e.querySelector('th');
      }, contrastRatio: function(e, t) {
        var n = (.05 + v.relativeLum(e)) / (.05 + v.relativeLum(t));
        return n < 1 && (n = 1 / n), n;
      }, relativeLum: function(e) {
        if (e.charAt) e = v.colourStrToRGB(e);
        var t = {};
        for (var n in e) e[n] <= .03928 ? t[n] = e[n] / 12.92 : t[n] = Math.pow((e[n] + .055) / 1.055, 2.4);
        return .2126 * t.red + .7152 * t.green + .0722 * t.blue;
        ...
        if ('rgb' === (e = e.toLowerCase()).substring(0, 3)) {
          ...
          '#' === e.charAt(0) && (e = e.substr(1)), 3 === e.length && (e = e.replace(/^(.)(.)(.)$/, '$1$1$2$2$3$3')), 4 === e.length && (e = e.replace(/^(.)(.)(.)(.)$/, '$1$1$2$2$3$3$4$4'));
          var n = 1;
          8 === e.length && (n = parseInt(e.substr(6, 2), 16) / 255), e = {
        ...
        return colourStr = '#', e.red = Math.round(255 * e.red), e.green = Math.round(255 * e.green), e.blue = Math.round(255 * e.blue), e.red % 17 == 0 && e.green % 17 == 0 && e.blue % 17 == 0 ? (colourStr += (e.red / 17).toString(16), colourStr += (e.green / 17).toString(16), colourStr += (e.blue / 17).toString(16)) : (e.red < 16 && (colourStr += '0'), colourStr += e.red.toString(16), e.green < 16 && (colourStr += '0'), colourStr += e.green.toString(16), e.blue < 16 && (colourStr += '0'), colourStr += e.blue.toString(16)), colourStr;
      }, sRGBtoHSV: function(e) {
        e.charAt && (e = v.colourStrToRGB(e));
        var t = { hue: 0, saturation: 0, value: 0 }, n = Math.max(e.red, e.green, e.blue),
          i = n - Math.min(e.red, e.green, e.blue);
        return 0 === i ? t.value = e.red : ((t.value = n) === e.red ? t.hue = (e.green - e.blue) / i : n === e.green ? t.hue = 2 + (e.blue - e.red) / i : t.hue = 4 + (e.red - e.green) / i, t.hue = 60 * t.hue, 360 <= t.hue && (t.hue -= 360), t.saturation = i / t.value), t;
      }, HSVtosRGB: function(e) {
        var t = { red: 0, green: 0, blue: 0 };
        if (0 === e.saturation) t.red = e.value, t.green = e.value, t.blue = e.value; else {
          var n = e.value * e.saturation, i = e.value - n, a = e.hue / 60, o = a - 2 * Math.floor(a / 2),
            r = n * (1 - Math.abs(o - 1));
          switch (Math.floor(a)) {
            case 0:
              t.red = n, t.green = r;
        ...
        for (var a = [e.textContent]; 0 < n.length;) {
          var o = n.shift();
          if (1 === o.nodeType) if ('img' === o.nodeName.toLowerCase()) !0 === t && !0 === o.hasAttribute('alt') && a.push(o.getAttribute('alt')); else for (i = 0; i < o.childNodes.length; i++) n.push(o.childNodes[i]); else 3 === o.nodeType && a.push(o.nodeValue);
        }
        ...
        return -1 !== ['abbr', 'audio', 'b', 'bdo', 'br', 'button', 'canvas', 'cite', 'code', 'command', 'data', 'datalist', 'dfn', 'em', 'embed', 'i', 'iframe', 'img', 'input', 'kbd', 'keygen', 'label', 'mark', 'math', 'meter', 'noscript', 'object', 'output', 'progress', 'q', 'ruby', 'samp', 'script', 'select', 'small', 'span', 'strong', 'sub', 'sup', 'svg', 'textarea', 'time', 'var', 'video', 'wbr'].indexOf(e.toLowerCase());
      }, getChildrenForTable: function(e, t) {
        if ('table' !== e.nodeName.toLowerCase()) return null;
        for (var n = [], i = e.getElementsByTagName(t), a = 0, o = i.length; a < o; a++) v.findParentNode(i[a], 'table') === e && n.push(i[a]);
        return n;
      }, testTableHeaders: function(e) {
        for (var t = {
          required: !0,
          ...
          missingTd: [],
          wrongHeaders: [],
        }, n = v.getChildrenForTable(e, 'tr'), i = [], a = { rows: [], cols: [] }, o = {
          rows: 0,
          cols: 0,
        }, r = 0; r < n.length; r++) for (var s = n[r], l = 0, d = 0; d < s.childNodes.length; d++) {
          if (1 === (h = s.childNodes[d]).nodeType) {
            if (i[r]) for (; i[r][0] === l;) i[r].shift(), l++;
            var u = h.nodeName.toLowerCase(), _ = Number(h.getAttribute('rowspan')) || 1,
              c = Number(h.getAttribute('colspan')) || 1;
            if (1 < _) for (var m = r + 1; m < r + _; m++) {
              i[m] || (i[m] = []);
              for (var g = l; g < l + c; g++) i[m].push(g);
            }
            if ('th' === u) '' === (h.getAttribute('id') || '') && (t.correct = !1, t.missingThId.push(h)), 1 < _ && 1 < c ? t.allowScope = !1 : !0 === t.allowScope && (void 0 === a.cols[l] && (a.cols[l] = 0), void 0 === a.rows[r] && (a.rows[r] = 0), a.rows[r] += c, a.cols[l] += _); else 'td' === u && !0 === h.hasAttribute('headers') && !1 === /^\s*$/.test(h.getAttribute('headers')) && (t.used = !0);
            l += c;
          }
        }
        for (m = 0; m < a.rows.length; m++) 1 < a.rows[m] && o.rows++;
        for (m = 0; m < a.cols.length; m++) 1 < a.cols[m] && o.cols++;
        1 < o.rows || 1 < o.cols ? t.allowScope = !1 : !0 !== t.allowScope || 0 !== o.rows && 0 !== o.cols || (t.required = !1);
        var p = HTMLCS.util.getCellHeaders(e);
        for (m = 0; m < p.length; m++) {
          var h = p[m].cell, b = p[m].headers;
          if (!1 === h.hasAttribute('headers')) t.correct = !1, t.missingTd.push(h); else {
            var f = (h.getAttribute('headers') || '').split(/\s+/);
            if (0 === f.length) t.correct = !1, t.missingTd.push(h); else if (b !== (f = (f = ' ' + f.sort().join(' ') + ' ').replace(/\s+/g, ' ').replace(/(\w+\s)\1+/g, '$1').replace(/^\s*(.*?)\s*$/g, '$1'))) {
              t.correct = !1;
        ...
        if ('table' !== e.nodeName.toLowerCase()) return null;
        for (var t = v.getChildrenForTable(e, 'tr'), n = [], i = {
          rows: {},
          cols: {},
        }, a = [], o = ['th', 'td'], r = 0; r < o.length; r++) for (var s = o[r], l = 0; l < t.length; l++) for (var d = t[l], u = 0, _ = 0; _ < d.childNodes.length; _++) {
          var c = d.childNodes[_];
          if (1 === c.nodeType) {
            if (n[l]) for (; n[l][u];) u++;
            var m = c.nodeName.toLowerCase(), g = Number(c.getAttribute('rowspan')) || 1,
              p = Number(c.getAttribute('colspan')) || 1;
            if (1 < g) for (var h = l + 1; h < l + g; h++) {
              n[h] || (n[h] = []);
              for (var b = u; b < u + p; b++) n[h][b] = !0;
            }
            if (m === s) if ('th' === m) {
              var f = c.getAttribute('id') || '';
              for (h = l; h < l + g; h++) i.rows[h] = i.rows[h] || { first: u, ids: [] }, i.rows[h].ids.push(f);
              for (h = u; h < u + p; h++) i.cols[h] = i.cols[h] || { first: l, ids: [] }, i.cols[h].ids.push(f);
            } else if ('td' === m) {
              var C = [];
              for (h = l; h < l + g; h++) for (b = u; b < u + p; b++) i.rows[h] && b >= i.rows[h].first && (C = C.concat(i.rows[h].ids)), i.cols[b] && h >= i.cols[b].first && (C = C.concat(i.cols[b].ids));
              if (0 < C.length) C = (C = ' ' + C.sort().filter(function(e, t, n) {
                return n.indexOf(e) === t;
              }).join(' ') + ' ').replace(/\s+/g, ' ').replace(/(\w+\s)\1+/g, '$1').replace(/^\s*(.*?)\s*$/g, '$1'), a.push({
                cell: c,
                headers: C,
              });
            }
        ...
        if (e.getAttribute('aria-labelledby')) {
          for (var n = [], i = e.getAttribute('aria-labelledby').split(' '), a = 0; a < i.length; a++) {
            var o = i[a], r = t.getElementById(o);
            r && n.push(r.textContent);
          }
          return n.join(' ');
        }
        return e.getAttribute('aria-label') ? e.getAttribute('aria-label') : e.getAttribute('title') && 'presentation' !== e.getAttribute('role') && 'none' !== e.getAttribute('role') ? e.getAttribute('aria-label') : '';
      },
    };
    return v;
  }();
  var HTMLCS_RUNNER = _global.HTMLCS_RUNNER = new function() {
    this.run = function(e, t) {
      var a = this;
      HTMLCS.process(e, document, function() {
        var e = HTMLCS.getMessages(), t = e.length, n = {};
  ...
  _global.HTMLCSAuditor = new function() {
    var M = 'HTMLCS-', c = '', L = '', H = [], A = {}, z = null, N = null, T = [], b = 1, r = null, x = this;
    ...
    var I = function(e, t, n, i) {
      ...
      return a.appendChild(r), i instanceof Function == !0 && (a.onclick = function() {
        !1 === /disabled/.test(a.className) && i(a);
      }), a;
    }, y = function(e, t, n, i, a) {
      void 0 === n && (n = !1);
      var o = z.createElement('label'), r = '';
      o.className = M + 'checkbox', r += '<span class="' + M + 'checkbox-switch">', r += '<span class="' + M + 'checkbox-slider"></span>', r += '<input id="' + e + '" type="checkbox"', !0 === n && (r += ' checked="checked"', o.className += ' active'), !0 === i && (r += ' disabled="disabled"', o.className += ' disabled'), r += ' title="' + t + '" /></span>', o.innerHTML = r;
      var s = o.getElementsByTagName('input')[0];
      return o.onclick = function(e) {
        return !1 === i && (s.checked = !s.checked, !0 === s.checked ? o.className += ' active' : o.className = o.className.replace('active', ''), a instanceof Function == !0 && a(s)), !1;
      }, o;
    }, f = function(e, i) {
      var t = z.createElement('div');
      t.className = M + 'header', t.innerHTML = 'HTML_CodeSniffer by Squiz', t.setAttribute('title', _global.HTMLCS.getTranslation('auditor_using_standard') + e);
      var a = !1, o = 0, r = 0;
      t.onmousedown = function(e) {
        return e = e || window.event, a = !0, o = e.clientX, r = e.clientY, !1;
      }, z.onmousemove = function(e) {
        if (e = e || window.event, !0 === a) {
          var t = i.offsetTop, n = i.offsetLeft;
          r < e.clientY ? (t += e.clientY - r, i.style.top = t + 'px') : r > e.clientY && (t -= r - e.clientY, i.style.top = t + 'px'), o < e.clientX ? (n += e.clientX - o, i.style.left = n + 'px') : o > e.clientX && (n -= o - e.clientX, i.style.left = n + 'px'), o = e.clientX, r = e.clientY;
        }
      ...
      return n.className = M + 'close', n.setAttribute('title', _global.HTMLCS.getTranslation('auditor_close')), n.onmousedown = function() {
        x.close.call(x);
      }, t.appendChild(n), t;
    }, C = function(a, o) {
      ...
      l.innerHTML = _global.HTMLCS.getTranslation('auditor_home'), s.appendChild(l), s.onmousedown = function() {
        x.run(L, H, A);
      };
      var d = z.createElement('li');
      d.className = M + 'lineage-item';
      var u = z.createElement('a');
      u.className = M + 'lineage-link', u.href = 'javascript:', u.innerHTML = _global.HTMLCS.getTranslation('auditor_report'), u.setAttribute('title', _global.HTMLCS.getTranslation('auditor_back_to_report')), u.onmousedown = function() {
        var e = z.querySelectorAll('.HTMLCS-inner-wrapper')[0];
        e.style.marginLeft = '0px', e.style.maxHeight = null, r.style.display = 'none', z.querySelectorAll('.HTMLCS-summary')[0].style.display = 'block';
      };
      var _ = z.createElement('li');
      _.className = M + 'lineage-item', _.innerHTML = _global.HTMLCS.getTranslation('auditor_issue') + ' ' + a + ' ' + _global.HTMLCS.getTranslation('auditor_of') + ' ' + o, i.appendChild(s), d.appendChild(u), n.appendChild(i), n.appendChild(d), n.appendChild(_), e.appendChild(n);
      var c = z.createElement('div');
      c.className = M + 'button-group';
      var m = I(M + 'button-previous-issue', 'previous', _global.HTMLCS.getTranslation('auditor_previous_issue'), function(e) {
        var t = Number(a) - 1;
        if (1 <= t) {
          ...
          i.firstChild.style.marginLeft = parseInt(i.firstChild.style.marginLeft, 10) + 300 + 'px', h(t - 1);
        }
      }), g = I(M + 'button-next-issue', 'next', _global.HTMLCS.getTranslation('auditor_next_issue'), function(e) {
        var t = Number(a) + 1;
        if (t <= T.length) {
          p(t - 1), wrapper = r.parentNode;
          var n = C(t, o);
      ...
      return 1 === a && (m.className += ' disabled'), a === o && (g.className += ' disabled'), c.appendChild(m), c.appendChild(g), t.appendChild(c), r.appendChild(e), r.appendChild(t), r;
    }, v = function(e, t) {
      var n = '', i = '';
      switch (t.type) {
        case HTMLCS.ERROR:
      ...
      var a = i.toLowerCase(), o = t.msg;
      115 < o.length && (o = o.substr(0, 115) + '...'), (n = z.createElement('li')).id = M + 'msg-' + e;
      var r = z.createElement('span');
      r.className = M + 'issue-type ' + M + a, r.setAttribute('title', i), n.appendChild(r);
      var s = z.createElement('span');
      return s.className = M + 'issue-title', s.innerHTML = o, n.appendChild(s), n.onclick = function() {
        var e = this.id.replace(new RegExp(M + 'msg-'), '');
        p(e);
        var t = z.querySelectorAll('.HTMLCS-issue-detail-list')[0];
        t.className += ' ' + M + 'transition-disabled', t.firstChild.style.marginLeft = -300 * e + 'px', h(e), setTimeout(function() {
          t.className = t.className.replace(new RegExp(' ' + M + 'transition-disabled'), '');
        }, 500);
        var n = z.querySelectorAll('.HTMLCS-inner-wrapper')[0];
        n.style.marginLeft = '-300px', n.style.maxHeight = '15em', summary = z.querySelectorAll('.HTMLCS-summary-detail')[0];
        var i = C(parseInt(e) + 1, T.length);
        summary.parentNode.replaceChild(i, summary), i.style.display = 'block', z.querySelectorAll('.HTMLCS-summary')[0].style.display = 'none';
      }, n;
    }, p = function(e) {
      for (var t = z.querySelectorAll('.HTMLCS-issue-detail-list')[0].getElementsByTagName('li'), n = 0; n < t.length; n++) t[n].className = t[n].className.replace(new RegExp(' ' + M + 'current'), '');
      z.getElementById('HTMLCS-msg-detail-' + e).className += ' ' + M + 'current', A.showIssueCallback && A.showIssueCallback.call(this, e);
    }, k = function(e, t, n) {
      void 0 === n && (n = L);
      var i = '';
      switch (t.type) {
      ...
      var a = M + i.toLowerCase(), o = HTMLCS.util.getElementWindow(z)['HTMLCS_' + n], r = [];
      ...
      for (var c = '', m = 0; m < r.length; m++) c += '<em>' + r[m][0] + ':</em> ' + r[m][1] + '<br/>';
      if (_.innerHTML = c, l.appendChild(d), l.appendChild(u), l.appendChild(_), s.appendChild(l), !1 === E.isPointable(t.element)) {
        (h = z.createElement('div')).className = M + 'issue-source', s.appendChild(h), (G = z.createElement('div')).className = M + 'issue-source-inner-u2p';
        var g = _global.HTMLCS.getTranslation('auditor_unable_to_point');
        if ('#document' === t.element.nodeName) g = _global.HTMLCS.getTranslation('auditor_applies_entire_document'); else if (null === t.element.ownerDocument) g = _global.HTMLCS.getTranslation('auditor_unable_to_point_removed'); else {
          var p = t.element.ownerDocument.getElementsByTagName('body')[0];
          !1 === HTMLCS.util.isInDocument(t.element) ? g += _global.HTMLCS.getTranslation('auditor_unable_to_point_entire') : !1 === HTMLCS.util.contains(p, t.element) ? g = _global.HTMLCS.getTranslation('auditor_unable_to_point_outside') : g += ' ' + _global.HTMLCS.getTranslation('auditor_unable_to_point_outside');
        }
        void 0 !== G.textContent ? G.textContent = g : G.innerText = g, h.appendChild(G);
      }
      if (A.customIssueSource) {
        (h = z.createElement('div')).className = M + 'issue-source', s.appendChild(h), A.customIssueSource.call(this, e, t, n, h, l);
      } else {
        var h;
        ...
        var C = I(M + 'button-point-to-element-' + e, 'pointer', _global.HTMLCS.getTranslation('auditor_point_to_element'), function() {
          x.pointToElement(t.element);
        });
        if (b.appendChild(f), b.appendChild(C), h.appendChild(b), t.element.outerHTML) {
          var v = '', H = '';
          if (31 < t.element.innerHTML.length) var T = t.element.outerHTML.replace(t.element.innerHTML, t.element.innerHTML.substr(0, 31) + '...'); else T = t.element.outerHTML;
          for (var y = t.element.previousSibling; v.length <= 31 && null !== y;) 1 === y.nodeType ? v = y.outerHTML : 3 === y.nodeType && (v = void 0 !== y.textContent ? y.textContent + v : y.nodeValue + v), 31 < v.length && (v = '...' + v.substr(v.length - 31)), y = y.previousSibling;
          for (var k = t.element.nextSibling; H.length <= 31 && null !== k;) 1 === k.nodeType ? H += k.outerHTML : 3 === k.nodeType && (void 0 !== k.textContent ? H += k.textContent : H += k.nodeValue), 31 < H.length && (H = H.substr(0, 31) + '...'), k = k.nextSibling;
          (G = z.createElement('div')).className = M + 'issue-source-inner';
          var w = z.createElement('strong');
          void 0 !== w.textContent ? w.textContent = T : w.innerText = T, G.appendChild(z.createTextNode(v)), G.appendChild(w), G.appendChild(z.createTextNode(H)), h.appendChild(G);
        } else if ('#document' === t.element.nodeName) ; else {
          var G;
      ...
      if (t.element) {
        ...
        if (E.container = x.pointerContainer || z.getElementById('HTMLCS-wrapper'), !1 === E.isPointable(t.element)) {
          var i = E.getPointer(t.element);
          E.pointer && (i.className += ' HTMLCS-pointer-hidden'), n && (n.className += ' disabled');
    ...
    this.setOption = function(e, t) {
      ...
      for (var t = { error: 0, warning: 0, notice: 0 }, n = 0; n < e.length; n++) switch (e[n].type) {
        case HTMLCS.ERROR:
          t.error++;
          break;
        case HTMLCS.WARNING:
      ...
      T = t;
      for (s = 0; s < t.length; s++) s % 5 == 0 && ('<ol class="HTMLCS-issue-list"', 0 === s && 'style="margin-left: 0em"', '>'), v(s, t[s]), s % 5 != 4 && s !== t.length - 1 || '</ol>', k(s, t[s], e);
      if ((i = z.createElement('div')).id = M + 'wrapper', i.className = 'showing-issue-list', !0 !== A.noHeader) {
        var d = f(e, i);
        i.appendChild(d);
      }
      var u = function(e, t, n) {
        ...
        if (0 < e) {
          ...
          1 === e && (s = _global.HTMLCS.getTranslation('auditor_error')), r.push('<strong>' + e + '</strong> ' + s);
        }
        0 < t && (s = _global.HTMLCS.getTranslation('auditor_warnings'), 1 === t && (s = _global.HTMLCS.getTranslation('auditor_warning')), r.push('<strong>' + t + '</strong> ' + s));
        0 < n && (s = _global.HTMLCS.getTranslation('auditor_notices'), 1 === n && (s = _global.HTMLCS.getTranslation('auditor_notice')), r.push('<strong>' + n + '</strong> ' + s));
        ...
        _.innerHTML = 'Home', u.appendChild(_), u.onmousedown = function() {
          x.run(L, H, A);
        };
        var c = z.createElement('li');
        return c.className = M + 'lineage-item', c.innerHTML = r.join(', &#160;<span class="HTMLCS-divider"></span>'), d.appendChild(u), l.appendChild(d), l.appendChild(c), a.appendChild(l), o.appendChild(z.createTextNode(String.fromCharCode(160))), i;
      }(a, o, r), _ = C(1, t.length);
      (g = z.createElement('div')).id = M + 'issues-wrapper', g.className = M + 'inner-wrapper';
      var c = function(e) {
        var t = 300 * Math.ceil(e.length / 5), n = z.createElement('div');
        n.id = M + 'issues', n.className = M + 'details', n.setAttribute('style', 'width: ' + t + 'px'), (a = z.createElement('ol')).className = M + 'issue-list', a.setAttribute('style', 'margin-left: 0');
        for (var i = 0; i < e.length; i++) {
          var a;
          0 < i && i % 5 == 0 && (n.appendChild(a), (a = z.createElement('ol')).className = M + 'issue-list');
          var o = v(i, e[i]);
          a.appendChild(o);
        }
      ...
      var m = function(e, t) {
        ...
        i.className = M + 'nav-button ' + M + 'previous', i.innerHTML = String.fromCharCode(160), 1 === e && (i.className += ' ' + M + 'disabled'), n.appendChild(i);
        var a = z.createElement('span');
        a.className = M + 'page-number', a.innerHTML = _global.HTMLCS.getTranslation('auditor_page') + ' ' + e + ' ' + _global.HTMLCS.getTranslation('auditor_of') + ' ' + t, n.appendChild(a);
        var o = z.createElement('span');
        return o.className = M + 'nav-button ' + M + 'next', o.innerHTML = String.fromCharCode(160), e === t && (o.className += ' ' + M + 'disabled'), n.appendChild(o), i.onclick = function() {
          1 < b && 1 == --b && (i.className += ' ' + M + 'disabled'), 1 < t && (o.className = o.className.replace(new RegExp(' ' + M + 'disabled'), '')), a.innerHTML = '', a.appendChild(document.createTextNode(_global.HTMLCS.getTranslation('auditor_page') + ' ' + b + ' ' + _global.HTMLCS.getTranslation('auditor_of') + ' ' + t)), z.querySelectorAll('.HTMLCS-issue-list')[0].style.marginLeft = -300 * (b - 1) + 'px';
        }, o.onclick = function() {
          b < t && ++b === t && (o.className += ' ' + M + 'disabled'), 1 < t && (i.className = i.className.replace(new RegExp(' ' + M + 'disabled'), '')), a.innerHTML = '', a.appendChild(document.createTextNode(_global.HTMLCS.getTranslation('auditor_page') + ' ' + b + ' ' + _global.HTMLCS.getTranslation('auditor_of') + ' ' + t)), z.querySelectorAll('.HTMLCS-issue-list')[0].style.marginLeft = -300 * (b - 1) + 'px';
        }, n;
      }(1, Math.ceil(t.length / 5));
      g.appendChild(m);
      var g, p = z.createElement('div');
      p.className = M + 'outer-wrapper', p.appendChild(g), (g = z.createElement('div')).id = M + 'issues-detail-wrapper', g.className = M + 'inner-wrapper';
      var h = function(e) {
        var t = 300 * e.length, n = z.createElement('div');
        n.id = M + 'issues-detail', n.className = M + 'details', n.setAttribute('style', 'width: ' + t + 'px');
      ...
      return g.appendChild(h), p.appendChild(g), i.appendChild(u), i.appendChild(_), i.appendChild(p), i;
      ...
      var n = function() {
        ...
        n.innerHTML = _global.HTMLCS.getTranslation('auditor_standards') + ':', n.setAttribute('for', M + 'settings-use-standard-select');
        ...
        for (var a = HTMLCSAuditor.getStandardList(), o = 0; o < a.length; o++) {
          var r = a[o], s = z.createElement('option');
          s.value = r, s.innerHTML = _global['HTMLCS_' + r].name, r === L && (s.selected = !0), i.appendChild(s), i.onchange = function() {
        ...
        d.id = M + 'settings-issue-count-help', d.innerHTML = _global.HTMLCS.getTranslation('auditor_select_types');
        var u = z.createElement('div');
        u.id = M + 'settings-view-report', u.innerHTML = _global.HTMLCS.getTranslation('auditor_view_report'), u.onclick = function() {
          if (!1 === /disabled/.test(this.className)) {
            ...
            var e = z.getElementById(M + 'wrapper'), t = x.build(L, T, A);
            A.parentElement ? A.parentElement.replaceChild(t, e) : (t.style.left = e.style.left, t.style.top = e.style.top, z.body.replaceChild(t, e)), A.listUpdateCallback && A.listUpdateCallback.call(this, T);
          }
        };
        z.getElementById(M + 'wrapper');
        var _ = x.countIssues(T);
        for (var c in void 0 === A.show && 0 < T.length && (A.show = {
          error: !0,
          warning: !0,
          notice: !1,
        }, 0 === _.error && 0 === _.warning && (A.show.notice = !0)), _) {
          var m = _[c], g = z.createElement('div');
          g.className = M + 'issue-tile ' + M + c.toLowerCase();
          var p = null, h = z.createElement('div');
          h.className = 'HTMLCS-tile-text', 'error' == c && (p = _global.HTMLCS.getTranslation('auditor_error'), 1 !== m && (p = _global.HTMLCS.getTranslation('auditor_errors'))), 'warning' == c && (p = _global.HTMLCS.getTranslation('auditor_warning'), 1 !== m && (p = _global.HTMLCS.getTranslation('auditor_warnings'))), 'notice' == c && (p = _global.HTMLCS.getTranslation('auditor_notice'), 1 !== m && (p = _global.HTMLCS.getTranslation('auditor_notices')));
          var b = '<strong>' + m + '</strong> ' + p;
          if (h.innerHTML = b, void 0 === A.show) var f = !1,
            C = !0; else f = A.show[c], C = !1, 0 === m && (C = !(f = !1));
          var v = y(M + 'include-' + c, 'Toggle display of ' + c + ' messages', f, C, function(e) {
            var t = !1;
            !1 === z.getElementById(M + 'include-error').disabled && (A.show.error = z.getElementById(M + 'include-error').checked, t = t || A.show.error), !1 === z.getElementById(M + 'include-warning').disabled && (A.show.warning = z.getElementById(M + 'include-warning').checked, t = t || A.show.warning), !1 === z.getElementById(M + 'include-notice').disabled && (A.show.notice = z.getElementById(M + 'include-notice').checked, t = t || A.show.notice), !0 === t ? u.className = u.className.replace(/ disabled/g, '') : u.className += ' disabled';
          });
          g.appendChild(h), g.appendChild(v), l.appendChild(g);
        }
        void 0 !== A.show ? !1 === (A.show.error || A.show.warning || A.show.notice) && (u.className += ' disabled') : u.className += ' disabled';
        return t.appendChild(n), t.appendChild(i), e.appendChild(t), e.appendChild(l), e.appendChild(d), e.appendChild(u), e;
      }();
      return e.appendChild(n), e;
    }, this.changeScreen = function(e) {
      var t = z.getElementById(M + 'wrapper');
      t.className = t.className.replace(new RegExp('showing-' + c), ''), t.className += ' showing-' + e, t.className = t.className.replace(/\s+/, ' '), c = e;
    }, this.includeCss = function(e, t) {
      if (!1 !== A.includeCss) {
        void 0 === t && (t = z);
        for (var n = t.querySelector('head'), i = n.getElementsByTagName('link'), a = !1, o = 0; o < i.length; o++) if (!0 === new RegExp(e + '.css').test(i[o].getAttribute('href'))) {
          a = !0;
          break;
        }
        if (!1 === a) {
          var r = t.createElement('link');
          r.rel = 'stylesheet', r.type = 'text/css', r.href = A.path + e + '.css', n.appendChild(r);
        }
      }
    }, this.getStandardList = function() {
      var e = /^HTMLCS_[^_]+$/, t = [];
      for (i in window) if (!0 === e.test(i)) {
        var n = window[i];
      ...
      var e = null;
      if (A.parentElement) e = A.parentElement; else if (0 < N.frames.length) {
        for (var t = -1, n = null, i = 0; i < N.frames.length; i++) try {
          if ('frame' === window.frames[i].frameElement.nodeName.toLowerCase() && window.frames[i].document) {
      ...
      N = window;
      for (var n = this.getStandardList(), i = [], o = 0; o < n.length; o++) _global['HTMLCS_' + n[o]] || i.push(n[o]);
      if (0 < i.length) m(i, function() {
        x.run(e, t, a);
      }); else {
        if (null == t) {
          if (t = [], 0 === document.querySelectorAll('frameset').length && t.push(document), 0 < N.frames.length) for (o = 0; o < N.frames.length; o++) try {
            t.push(N.frames[o].document);
          } catch (e) {
          }
        } else if (t.nodeName) {
          if ('input' === t.nodeName.toLowerCase()) if (!1 === t.hasAttribute('type')) t = t.value; else 'text' === t.getAttribute('type').toLowerCase() && (t = t.value); else 'textarea' === t.nodeName.toLowerCase() && (t = t.value);
        }
        t instanceof Array == !1 && (t = [t]), void 0 === a && (a = {}), L = e, H = t, A = a, b = 1, c = '', T = [];
        var r = this.getParentElement();
        z = this.getOwnerDocument(), A.path || (A.path = './'), a.lang || (A.lang = this.getDocumentLanguage()), void 0 === A.includeCss && (A.includeCss = !0), void 0 === A.ignoreMsgCodes && (A.ignoreMsgCodes = []), this.includeCss('HTMLCS');
        var s = z.getElementById(M + 'wrapper'), l = !1, d = x.buildSummaryPage();
        d.className += ' HTMLCS-processing', s ? (d.style.left = s.style.left, d.style.top = s.style.top, r.replaceChild(d, s)) : (A.openCallback && A.openCallback.call(this), l = !0, r.appendChild(d));
        var u = function() {
          for (var e = 0; e < T.length; e++) {
            var t = !1;
            d && (d === T[e].element ? t = !0 : T[e].element.documentElement ? t = !1 : d.contains && !0 === d.contains(T[e].element) ? t = !0 : d.compareDocumentPosition && 0 < (16 & d.compareDocumentPosition(T[e].element)) && (t = !0));
            for (var n = 0; n < a.ignoreMsgCodes.length; n++) if (!0 === new RegExp(a.ignoreMsgCodes[n]).test(T[e].code)) {
              t = !0;
              break;
            }
            !0 === t && (T.splice(e, 1), e--);
          ...
          if (A.runCallback) {
            var i = A.runCallback.call(this, T, l);
            i instanceof Array == !0 && (T = i);
          }
          setTimeout(function() {
            var e = z.getElementById(M + 'wrapper'), t = x.buildSummaryPage();
            t.style.left = e.style.left, t.style.top = e.style.top, r.replaceChild(t, e);
          }, 400);
        }, _ = function(e, t) {
          for (var n = t.shift(); !n;) {
          ...
          HTMLCS.process(e, n, function() {
            T = T.concat(HTMLCS.getMessages()), 0 === t.length ? u() : _(e, t);
          }, function() {
          }, a.lang);
        };
        _(e, H.concat([]));
      ...
      if (e && null !== e.currentVersion && e.newVersion > e.currentVersion) {
        var t = z.createElement('div');
        t.id = M + 'settings-updated-notification', z.documentElement.querySelector('.HTMLCS-settings').appendChild(t);
        var n = 'HTML_CodeSniffer has been updated to version ' + e.newVersion + '.';
        n += ' <a href="http://squizlabs.github.io/HTML_CodeSniffer/patches/' + e.newVersion + '">View the changelog</a>', t.innerHTML = n;
      }
    }, this.close = function() {
      if (z) {
        ...
        if (e) {
          ...
          t && t.parentNode && t.parentNode.removeChild(t), e.parentNode.removeChild(e), A.closeCallback && (T = A.closeCallback.call(this));
        }
      }
    ...
    var E = {
      pointerDim: {}, container: null, getBoundingRectangle: function(e) {
        if (!e) return null;
        var t = this.getElementCoords(e), n = this.getElementDimensions(e);
        return { x1: t.x, y1: t.y, x2: t.x + n.width, y2: t.y + n.height };
      }, getElementDimensions: function(e) {
        return { width: e.offsetWidth, height: e.offsetHeight };
      }, getElementCoords: function(e, t) {
        var n = 0, i = 0, a = HTMLCS.util.getElementWindow(e);
        if (!0 === t) var o = a.top; else o = a;
        for (; ;) {
        ...
        var t = HTMLCS.util.getElementWindow(e), n = e.ownerDocument, i = 0, a = 0;
        if (t.innerWidth) {
          i = t.innerWidth, a = t.innerHeight;
          var o = this.getScrollbarWidth(e);
          n.documentElement.scrollHeight > a && 'number' == typeof o && (i -= o), n.body.scrollWidth > i && 'number' == typeof o && (a -= o);
        } else n.documentElement && (n.documentElement.clientWidth || n.documentElement.clientHeight) ? (i = n.documentElement.clientWidth, a = n.documentElement.clientHeight) : n.body && (n.body.clientWidth || n.body.clientHeight) && (i = n.body.clientWidth, a = n.body.clientHeight);
        return { width: i, height: a };
      }, getScrollbarWidth: function(e) {
        if (null !== r) return r;
        doc = e.ownerDocument;
        var t, n, i = null, a = null;
        (i = doc.createElement('div')).style.position = 'absolute', i.style.top = '-1000px', i.style.left = '-1000px', i.style.width = '100px', i.style.height = '50px', i.style.overflow = 'hidden', (a = doc.createElement('div')).style.width = '100%', a.style.height = '200px', i.appendChild(a), z.body.appendChild(i), t = a.offsetWidth, i.style.overflow = 'auto', n = a.offsetWidth, doc.body.removeChild(doc.body.lastChild);
        var o = t - n;
        return r = o;
        ...
        doc = e.ownerDocument;
        var n = 0, i = 0;
        return i = t.pageYOffset ? (n = t.pageXOffset, t.pageYOffset) : doc.body && (doc.body.scrollLeft || doc.body.scrollTop) ? (n = doc.body.scrollLeft, doc.body.scrollTop) : (n = doc.documentElement.scrollLeft, doc.documentElement.scrollTop), {
          x: n,
          y: i,
        };
        ...
        for (var t = e.parentNode; t && t.ownerDocument;) t = t.parentNode;
        return null !== t && (!0 !== HTMLCS.util.isVisuallyHidden(e) && null !== this.getPointerDirection(e));
      }, getPointerDirection: function(e) {
        var t = null, n = this.getBoundingRectangle(e), i = this.getPointer(e), a = e.ownerDocument;
        i.className = i.className.replace('HTMLCS-pointer-hidden', ''), i.className += ' HTMLCS-pointer-hidden-block', this.pointerDim.height = 62, this.pointerDim.width = 62;
        var o = this.getWindowDimensions(e),
          r = (HTMLCS.util.getElementWindow(e), Math.max(0, Math.min(n.y1 - 100, a.documentElement.offsetHeight - o.height)));
        return n.y1 - this.pointerDim.height - 20 > r ? t = 'down' : n.y2 + this.pointerDim.height < o.height - r ? t = 'up' : n.x2 + this.pointerDim.width < o.width ? t = 'left' : 0 < n.x1 - this.pointerDim.width && (t = 'right'), i.className = i.className.replace('HTMLCS-pointer-hidden-block', ''), i.className += ' HTMLCS-pointer-hidden', t;
      }, pointTo: function(e) {
        if (e.ownerDocument) var t = e.ownerDocument; else t = e;
        ...
        if (n && n.parentNode.removeChild(n), !1 !== this.isPointable(e)) {
          var i = HTMLCS.util.getElementWindow(e).top,
            ...
            o = this.getPointer(e);
          if (o.className = o.className.replace('HTMLCS-pointer-hidden-block', ''), null === a) o.className += ' HTMLCS-pointer-hidden'; else {
            var r = !1;
            ...
            if (!0 === r) o.style.position = 'fixed'; else {
              o.style.position = 'absolute';
              for (var l = this.getElementCoords(e, !0), d = HTMLCS.util.getElementWindow(e), u = Math.max(l.y - 100, 0); 0 <= u;) {
                if (d.scrollTo(0, u), u -= this.getScrollCoords(d.document.documentElement).y, u = Math.max(u, 0), d === i) break;
                d = d.parent;
              }
            }
        ...
        try {
          ...
          var n = 'HTMLCS', i = t.getElementById(n + '-pointer');
          i || ((i = t.createElement('div')).id = n + '-pointer', i.className = n + '-pointer ' + n + '-pointer-hidden', t.body.appendChild(i));
        } catch (e) {
        }
        return i;
      }, showPointer: function(e, t) {
        var n = this.getPointer(e);
        this._removeDirectionClasses(n), n.className += ' HTMLCS-pointer-' + t, n.className = n.className.replace('HTMLCS-pointer-hidden', '');
        var i = this.getBoundingRectangle(e), a = 0, o = 0, r = 20;
        switch (t) {
          case'up':
            r = -r, a = i.y2, o = i.x2 - i.x1 < 250 ? this.getRectMidPnt(i) - this.pointerDim.width / 2 : i.x1;
            break;
          case'down':
          default:
            a = i.y1 - this.pointerDim.height, o = i.x2 - i.x1 < 250 ? this.getRectMidPnt(i) - this.pointerDim.width / 2 : i.x1;
            break;
          case'left':
            o = i.x2, a = this.getRectMidPnt(i, !0) - this.pointerDim.height / 2;
            break;
          case'right':
            r = -r, o = i.x1 - this.pointerDim.width, a = this.getRectMidPnt(i, !0) - this.pointerDim.height / 2;
        }
        var s = this.getScrollCoords(e);
        n.style.top = a + 'px', n.style.left = o + 'px';
        var l = this.getBoundingRectangle(this.container),
          d = (i = this.getBoundingRectangle(n)).x1 + (i.x2 - i.x1) / 2, u = i.y1 + (i.y2 - i.y1) / 2;
        if ('fixed' !== HTMLCS.util.style(n).position && (u -= s.y), l.x1 <= d && l.x2 >= d && l.y1 <= u && l.y2 >= u) {
          var _ = this;
        ...
        var s = i = Number(e.style[o].replace('px', '')) + r, l = i - 30, d = 0, u = setInterval(function() {
          if (a === n) {
            if (s--, e.style[o] = s + 'px', s < l && (a = n + '-op', 5 === d && 0 !== r)) return clearInterval(u), void t.call(this);
          } else if (s++, e.style[o] = s + 'px', i <= s && (a = n, 5 === ++d && 0 === r)) return clearInterval(u), void t.call(this);
        }, 10);
      }, getRectMidPnt: function(e, t) {
        return !0 === t ? e.y1 + (e.y2 - e.y1) / 2 : e.x1 + (e.x2 - e.x1) / 2;
      }, _removeDirectionClasses: function(e) {
        for (var t = ['down', 'up', 'left', 'right'], n = t.length, i = 0; i < n; i++) e.className = e.className.replace('HTMLCS-pointer-' + t[i], '');
      },
    };
  };    // Expose globals.
  return _global;
