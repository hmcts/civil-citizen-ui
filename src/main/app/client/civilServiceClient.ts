...
export class CivilServiceClient {
  ...
  async submitGeneralApplication(claimId: string, updatedClaim: ClaimUpdate, req: AppRequest):  Promise<Claim> {
    return this.submitEvent(CaseEvent.INITIATE_GENERAL_APPLICATION, claimId, updatedClaim, req);
  }
