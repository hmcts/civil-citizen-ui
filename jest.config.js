module.exports = {
  ...
  testPathIgnorePatterns: ['src/test/unit/routes/features/claim', 'src/test/unit/routes/features/claimantResponse', 'src/test/unit/routes/features/dashboard/dashboardController.test.ts'],
  transform: {
    '^.+\\.ts?$': 'ts-jest',
  },
  globals: {
