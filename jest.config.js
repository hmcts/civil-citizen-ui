module.exports = {
  ...
  testPathIgnorePatterns:['src/test/unit/routes/features/claim/totalAmountController.test.ts','src/test/unit/routes/features/claimantResponse', 'src/test/unit/routes/features/directionsQuestionnaire'],
  transform: {
    '^.+\\.ts?$': 'ts-jest',
  },
  globals: {
